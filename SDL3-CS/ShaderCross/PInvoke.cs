...
public partial class ShaderCross
{
    ...
    /// from <see cref="CompileSPIRVFromHLSL"/>. This must be freed with <see cref="SDL.Free"/> when you are done with the metadata.
    /// </summary>
    ...
    [LibraryImport(ShaderCrossLibrary, EntryPoint = "SDL_ShaderCross_ReflectGraphicsSPIRV"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint ReflectGraphicsSPIRV(nint bytecode, nuint bytecodeSize, PropertiesID props);
    ...
    /// <param name="bytecodeSize"> the length of the SPIRV bytecode. </param>
    /// <param name="props"> a properties object filled in with extra shader metadata, provided by the user. </param>
    /// <returns> a pointer to the compute pipeline metadata on success, or <see cref="IntPtr.Zero"/> otherwise. Free it with <see cref="SDL.Free"/> when done. </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    [LibraryImport(ShaderCrossLibrary, EntryPoint = "SDL_ShaderCross_ReflectComputeSPIRV"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint ReflectComputeSPIRV(nint bytecode, nuint bytecodeSize, PropertiesID props);
