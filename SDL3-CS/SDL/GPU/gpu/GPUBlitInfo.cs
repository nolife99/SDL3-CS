...
{
    /// <summary> A structure containing parameters for a blit command. </summary>
    ...
    public struct GPUBlitInfo
    {
        ...
        /// <summary> The color to clear the destination region to before the blit. Ignored if load_op is not public GPU_LOADOP_CLEAR. </summary>
