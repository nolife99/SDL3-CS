...
public static partial class SDL
{
    ...
    ///     <para>
    ///         Usage flags can be bitwise OR'd together for combinations of usages. Note that certain usage combinations are
    ///         invalid, for example <see cref="GPUTextureUsageFlags.Sampler"/> and GRAPHICS_STORAGE.
    ///     </para>
    /// </summary>
    ...
    public struct GPUTextureCreateInfo
    {
        ...
        /// <summary>
        ///     The layer count or depth of the texture. This value is treated as a layer count on 2D array textures, and as a
        ...
        /// <summary> The number of samples per texel. Only applies if the texture is used as a render target. </summary>
