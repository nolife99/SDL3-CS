...
public partial class SDL
{
 ...
 /// <param name="name"> the preferred GPU driver, or <c> null </c> to let SDL pick the optimal driver. </param>
 /// <returns> <c> true </c> if supported, <c> false </c> otherwise. </returns>
 /// <since> This function is available since SDL 3.2.0 </since>
 /// <seealso cref="CreateGPUDevice"/>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_GPUSupportsShaderFormats"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GPUSupportsShaderFormats(GPUShaderFormat formatFlags,
 ...
 /// <summary>
 ///     Creates a GPU context. <para> The GPU driver name can be one of the following: </para>
 ///     <list type="bullet">
 ...
 /// <param name="name"> the preferred GPU driver, or <c> null </c> to let SDL pick the optimal driver. </param>
 /// <returns> a GPU context on success or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
 /// <since> This function is available since SDL 3.2.0 </since>
 /// <seealso cref="CreateGPUDeviceWithProperties"/>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUDevice"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUDevice(GPUShaderFormat formatFlags,
 ...
 /// <summary>
 ///     <para> Creates a GPU context. </para> <para> These are the supported properties: </para>
 ///     <list type="bullet">
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateDebugModeBoolean"/>: enable debug mode properties and validations, defaults
 ///             to true.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreatePreferLowPowerBoolean"/>: enable to prefer energy efficiency over maximum GPU
 ///             performance, defaults to false.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateVerboseBoolean"/>: enable to automatically log useful debug information on
 ///             device creation, defaults to true.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateNameString"/>: the name of the GPU driver to use, if a specific one is
 ///             desired.
 ///         </item>
 ///     </list>
 ...
 ///     <list type="bullet">
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateShadersPrivateBoolean"/>: The app is able to provide shaders for an NDA
 ///             platform.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateShadersSPIRVBoolean"/>: The app is able to provide SPIR-V shaders if
 ///             applicable.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateShadersDXBCBoolean"/>: The app is able to provide DXBC shaders if applicable
 ///             <see cref="Props.GPUDeviceCreateShadersDXILBoolean"/>: The app is able to provide DXIL shaders if applicable.
 ///         </item>
 ///         <item> <see cref="Props.GPUDeviceCreateShadersMSLBoolean"/>: The app is able to provide MSL shaders if applicable. </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateShadersMetalLibBoolean"/>: The app is able to provide Metal shader libraries
 ///             if applicable.
 ///         </item>
 ///     </list>
 ...
 ///     <list type="bullet">
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateD3D12SemanticNameString"/>: the prefix to use for all vertex semantics,
 ///             default is "TEXCOORD".
 ///         </item>
 ///     </list>
 ...
 ///     <list type="bullet">
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateVulkanShaderClipDistanceBoolean"/>: Enable device feature shaderClipDistance.
 ///             If disabled, clip distances are not supported in shader code: gl_ClipDistance[] built-ins of GLSL,
 ///             SV_ClipDistance0/1 semantics of HLSL and [[clip_distance]] attribute of Metal. Defaults to true.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateVulkanDepthClampBoolean"/>: Enable device feature depthClamp. If disabled,
 ///             there is no depth clamp support and enable_depth_clip in <see cref="GPURasterizerState"/> must always be set to
 ///             true. Defaults to true.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateVulkanDrawInDirectFirstBoolean"/>: Enable device feature
 ///             drawIndirectFirstInstance. If disabled, the argument first_instance of <see cref="GPUIndirectDrawCommand"/> must
 ///             be set to zero. Defaults to true.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.GPUDeviceCreateVulkanSamplerAnisotropyBoolean"/>: Enable device feature samplerAnisotropy.
 ///             If disabled, enable_anisotropy of <see cref="GPUSamplerCreateInfo"/> must be set to false. Defaults to true.
 ///         </item>
 ///     </list>
 /// </summary>
 /// <param name="props"> the properties to use. </param>
 ...
 /// <since> This function is available since SDL 3.2.0 </since>
 /// <seealso cref="CreateGPUDevice"/>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyGPUDevice"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumGPUDrivers"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    private static partial nint SDL_GetGPUDriver(int index);
    ...
    ///     <para>
    ///         The names of drivers are all simple, low-ASCII identifiers, like "vulkan", "metal" or "direct3d12". These never
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGPUDeviceDriver"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGPUDeviceDriver(nint device);
    ...
    /// <param name="device"> a GPU context to query. </param>
    /// <returns> a bitflag indicating which shader formats the driver is able to consume. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGPUShaderFormats"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GPUShaderFormat GetGPUShaderFormats(nint device);
    ...
    ///     <para>
    ///         <see cref="Props.GPUDeviceNameString"/>: Contains the name of the underlying device as reported by the system
    ///         driver. This string has no standardized format, is highly inconsistent between hardware devices and drivers, and is
    ///         able to change at any time. Do not attempt to parse this string as it is bound to fail at some point in the future
    ///         when system drivers are updated, new hardware devices are introduced, or when SDL adds new GPU backends or modifies
    ///         existing ones.
    ///     </para>
    ///     <para> Strings that have been found in the wild include: </para>
    ///     <list type="bullet">
    ///         <item> GTX 970 </item> <item> GeForce GTX 970 </item> <item> NVIDIA GeForce GTX 970 </item>
    ///         <item> Microsoft Direct3D12 (NVIDIA GeForce GTX 970) </item> <item> NVIDIA Graphics Device </item>
    ///         <item> GeForce GPU </item> <item> P106-100 </item> <item> AMD 15D8:C9 </item> <item> AMD Custom GPU 0405 </item>
    ///         <item> AMD Radeon (TM) Graphics </item> <item> ASUS Radeon RX 470 Series </item>
    ///         <item> Intel(R) Arc(tm) A380 Graphics (DG2) </item> <item> Virtio-GPU Venus (NVIDIA TITAN V) </item>
    ///         <item> SwiftShader Device (LLVM 16.0.0) </item> <item> llvmpipe (LLVM 15.0.4, 256 bits) </item>
    ///         <item> Microsoft Basic Render Driver </item> <item> unknown device </item>
    ///     </list>
    ///     <para>
    ///         The above list shows that the same device can have different formats, the vendor name may or may not appear in
    ///         the string, the included vendor name may not be the vendor of the chipset on the device, some manufacturers include
    ///         pseudo-legal marks while others don't, some devices may not use a marketing name in the string, the device string
    ///         may be wrapped by the name of a translation interface, the device may be emulated in software, or the string may
    ///         contain generic text that does not identify the device at all.
    ///     </para>
    ///     <para> <see cref="Props.GPUDeviceDriverNameString"/>: Contains the self-reported name of the underlying system driver. </para>
    ///     <para> Strings that have been found in the wild include: </para>
    ///     <list type="bullet">
    ///         <item> Intel Corporation </item> <item> Intel open-source Mesa driver </item>
    ///         <item> Qualcomm Technologies Inc. Adreno Vulkan Driver </item> <item> MoltenVK </item> <item> Mali-G715 </item>
    ///         <item> venus </item>
    ///     </list>
    ///     <para>
    ///         <see cref="Props.GPUDeviceDriverVersionString"/>: Contains the self-reported version of the underlying system
    ///         driver. This is a relatively short version string in an unspecified format. If
    ///         <see cref="Props.GPUDeviceDriverInfoString"/> is available then that property should be preferred over this one as
    ///         it may contain additional information that is useful for identifying the exact driver version used.
    ///     </para>
    ///     <para> Strings that have been found in the wild include: </para>
    ///     <list type="bullet">
    ///         <item> 53.0.0 </item> <item> 0.405.2463 </item> <item> 32.0.15.6614 </item>
    ///     </list>
    ///     <para>
    ///         <see cref="Props.GPUDeviceDriverInfoString"/>: Contains the detailed version information of the underlying system
    ///         driver as reported by the driver. This is an arbitrary string with no standardized format and it may contain
    ///         newlines. This property should be preferred over <see cref="Props.GPUDeviceDriverVersionString"/> if it is available
    ///         as it usually contains the same information but in a format that is easier to read.
    ///     </para>
    ///     <para> Strings that have been found in the wild include: </para>
    ///     <list type="bullet">
    ///         <item> 101.6559 </item> <item> 1.2.11 </item> <item> Mesa 21.2.2 (LLVM 12.0.1) </item>
    ...
    ///     <para> Shader resource bindings must be authored to follow a particular order depending on the shader format. </para>
    ///     <para> For SPIR-V shaders, use the following resource sets: </para>
    ///     <list type="bullet">
    ///         <item> 0: Sampled textures, followed by read-only storage textures, followed by read-only storage buffers </item>
    ...
    ///             buffers
    ///         </item>
    ///         <item> (u[n], space1): Read-write storage textures, followed by read-write storage buffers </item>
    ///         <item> (b[n], space2): Uniform buffers </item>
    ///     </list>
    ///     <para> For MSL/metallib, use the following order: </para>
    ///     <list type="bullet">
    ///         <item> [[buffer]]: Uniform buffers, followed by read-only storage buffers, followed by read-write storage buffers </item>
    ///         <item>
    ...
    /// <returns>
    ///     a compute pipeline object on success, or <c> null </c> on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="BindGPUComputePipeline"/>
    /// <seealso cref="ReleaseGPUComputePipeline"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUComputePipeline"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUComputePipeline(nint device, in GPUComputePipelineCreateInfo createinfo);
    ...
    /// <returns>
    ///     a graphics pipeline object on success, or <c> null </c> on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUGraphicsPipeline"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUGraphicsPipeline(nint device, in GPUGraphicsPipelineCreateInfo createinfo);
    ...
    /// <returns> a sampler object on success, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUSampler"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUSampler(nint device, in GPUSamplerCreateInfo createinfo);
    ...
    ///     <para> Shader resource bindings must be authored to follow a particular order depending on the shader format. </para>
    ///     <para> For SPIR-V shaders, use the following resource sets: </para> <para> For vertex shaders: </para>
    ///     <list type="bullet">
    ///         <item> 0: Sampled textures, followed by storage textures, followed by storage buffers </item>
    ///         <item> 1: Uniform buffers </item>
    ///     </list>
    ///     <para> For fragment shaders: </para>
    ///     <list type="bullet">
    ///         <item> 2: Sampled textures, followed by storage textures, followed by storage buffers </item>
    ///         <item> 3: Uniform buffers </item>
    ///     </list>
    ///     <para> For DXBC and DXIL shaders, use the following register order: </para> <para> For vertex shaders: </para>
    ///     <list type="bullet">
    ///         <item> (t[n], space0): Sampled textures, followed by storage textures, followed by storage buffers </item>
    ///         <item> (s[n], space0): Samplers with indices corresponding to the sampled textures </item>
    ///         <item> (b[n], space1): Uniform buffers </item>
    ///     </list>
    ///     <para> For pixel shaders: </para>
    ///     <list type="bullet">
    ///         <item> (t[n], space2): Sampled textures, followed by storage textures, followed by storage buffers </item>
    ///         <item> (s[n], space2): Samplers with indices corresponding to the sampled textures </item>
    ...
    ///         <item>
    ///             [[buffer]]: Uniform buffers, followed by storage buffers. Vertex buffer 0 is bound at [[buffer(14)]], vertex
    ///             buffer 1 at [[buffer(15)]], and so on. Rather than manually authoring vertex buffer indices, use the
    ///             [[stage_in]] attribute which will automatically use the vertex input information from the
    ///             SDL_GPUGraphicsPipeline.
    ///         </item>
    ///     </list>
    ///     <para>
    ///         Shader semantics other than system-value semantics do not matter in D3D12 and for ease of use the SDL
    ///         implementation assumes that non system-value semantics will all be TEXCOORD. If you are using HLSL as the shader
    ///         source language, your vertex semantics should start at TEXCOORD0 and increment like so: TEXCOORD1, TEXCOORD2, etc.
    ///         If you wish to change the semantic prefix to something other than TEXCOORD you can use
    ///         <see cref="Props.GPUDeviceCreateD3D12SemanticNameString"/> with <see cref="CreateGPUDeviceWithProperties"/>.
    ///     </para>
    ///     <para> There are optional properties that can be provided through <c> props </c>. These are the supported properties: </para>
    ///     <list type="bullet">
    ...
    /// <returns> a shader object on success, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUGraphicsPipeline"/>
    /// <seealso cref="ReleaseGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUShader"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUShader(nint device, in GPUShaderCreateInfo createinfo);
    ...
    ///     <para>
    ///         The contents of this texture are undefined until data is written to the texture, either via
    ///         <see cref="UploadToGPUTexture"/> or by performing a render or compute pass with this texture as a target.
    ///     </para>
    ///     <para>
    ///         Note that certain combinations of usage flags are invalid. For example, a texture cannot have both the
    ///         <see cref="GPUTextureUsageFlags.Sampler"/> and <see cref="GPUTextureUsageFlags.GraphicsStorageRead"/> flags.
    ///     </para>
    ///     <para>
    ///         If you request a sample count higher than the hardware supports, the implementation will automatically fall back
    ///         to the highest available sample count.
    ///     </para>
    ///     <para>
    ///         There are optional properties that can be provided through <see cref="GPUTextureCreateInfo"/>'s <c> props </c>.
    ///         These are the supported properties:
    ///     </para>
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearRFloat"/>: (Direct3D 12 only) if the texture usage is
    ///             <see cref="GPUTextureUsageFlags.ColorTarget"/>, clear the texture to a color with this red intensity. Defaults
    ///             to zero.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearGFloat"/>: (Direct3D 12 only) if the texture usage is
    ///             <see cref="GPUTextureUsageFlags.ColorTarget"/>, clear the texture to a color with this green intensity. Defaults
    ///             to zero.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearBFloat"/>: (Direct3D 12 only) if the texture usage is
    ///             <see cref="GPUTextureUsageFlags.ColorTarget"/>, clear the texture to a color with this blue intensity. Defaults
    ///             to zero.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearAFloat"/>: (Direct3D 12 only) if the texture usage is
    ///             <see cref="GPUTextureUsageFlags.ColorTarget"/>, clear the texture to a color with this alpha intensity. Defaults
    ///             to zero.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearDepthFloat"/>: (Direct3D 12 only) if the texture usage is
    ///             <see cref="GPUTextureUsageFlags.DepthStencilTarget"/>, clear the texture to a depth of this value. Defaults to
    ///             zero.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearStencilUint8"/>: (Direct3D 12 only) if the texture usage is
    ///             <see cref="GPUTextureUsageFlags.DepthStencilTarget"/>, clear the texture to a stencil of this value. Defaults to
    ///             zero.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.GPUTextureCreateD3D12ClearStencilNumber"/>: (Direct3D 12 only) if the texture usage
    ///             <see cref="GPUTextureUsageFlags.DepthStencilTarget"/>, clear the texture to a stencil of this Uint8 value.
    ///             Defaults to zero.
    ///         </item>
    ...
    /// <returns> a texture object on success, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUTexture(nint device, in GPUTextureCreateInfo createinfo);
    ...
    ///         <see cref="GPUBufferUsageFlags.Vertex"/> and <see cref="GPUBufferUsageFlags.Index"/> flags.
    ///     </para>
    ///     <para>
    ...
    ///     </para>
    ///     <para>
    ///         For better understanding of underlying concepts and memory management with SDL GPU API, you may refer [this blog
    ...
    /// <returns> a buffer object on success, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUBuffer(nint device, in GPUBufferCreateInfo createinfo);
    ...
    ///     <para>
    ///         Download buffers can be particularly expensive to create, so it is good practice to reuse them if data will be
    ///         downloaded regularly.
    ///     </para>
    /// </summary>
    /// <param name="device"> a GPU Context. </param>
    /// <param name="createinfo"> a struct describing the state of the transfer buffer to create. </param>
    /// <returns> a transfer buffer on success, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="UploadToGPUBuffer"/>
    /// <seealso cref="DownloadFromGPUBuffer"/>
    /// <seealso cref="UploadToGPUTexture"/>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPUTransferBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUTransferBuffer(nint device, in GPUTransferBufferCreateInfo createinfo);
    ...
    ///     <para>
    ///         You should use <see cref="Props.GPUBufferCreateNameString"/> with <see cref="CreateGPUBuffer"/> instead of this
    ...
    /// <threadsafety>
    ///     This function is not thread safe, you must make sure the buffer is not simultaneously used by any other
    ///     thread.
    /// </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUBuffer"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUBufferName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void SetGPUBufferName(nint device,
        nint buffer,
    ...
    ///     <para>
    ///         You should use <see cref="Props.GPUTextureCreateNameString"/> with <see cref="CreateGPUTexture"/> instead of this
    ///         function to avoid thread safety issues.
    ///     </para>
    /// </summary>
    /// <param name="device"> a GPU Context. </param>
    ...
    /// <threadsafety>
    ///     This function is not thread safe, you must make sure the texture is not simultaneously used by any other
    ///     thread.
    /// </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUTexture"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUTextureName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void SetGPUTextureName(nint device,
        nint texture,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_InsertGPUDebugLabel"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void
        InsertGPUDebugLabel(nint commandBuffer, [MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    ...
    ///     <para> Each call to <see cref="PushGPUDebugGroup"/> must have a corresponding call to <see cref="PopGPUDebugGroup"/>. </para>
    ///     <para>
    ///         On some backends (e.g. Metal), pushing a debug group during a render/blit/compute pass will create a group that
    ///         is scoped to the native pass rather than the command buffer. For best results, if you push a debug group during a
    ///         pass, always pop it in the same pass.
    ///     </para>
    /// </summary>
    /// <param name="commandBuffer"> a command buffer. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUDebugGroup"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUDebugGroup(nint commandBuffer, [MarshalAs(UnmanagedType.LPUTF8Str)] string text);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PopGPUDebugGroup"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PopGPUDebugGroup(nint commandBuffer);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUSampler"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUTransferBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void ReleaseGPUTransferBuffer(nint device, nint transferBuffer);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUComputePipeline"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void ReleaseGPUComputePipeline(nint device, nint computePipeline);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUShader"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUGraphicsPipeline"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void ReleaseGPUGraphicsPipeline(nint device, nint graphicsPipeline);
    ...
    ///     <para>
    ///         This command buffer is managed by the implementation and should not be freed by the user. The command buffer may
    ///         only be used on the thread it was acquired on. The command buffer should be submitted on the thread it was acquired
    ///         on.
    ///     </para>
    ///     <para>
    ///         It is valid to acquire multiple command buffers on the same thread at once. In fact a common design pattern is to
    ///         acquire two command buffers per frame where one is dedicated to render and compute passes and the other is dedicated
    ///         to copy passes and other preparatory work such as generating mipmaps. Interleaving commands between the two command
    ///         buffers reduces the total amount of passes overall which improves rendering performance.
    ///     </para>
    /// </summary>
    /// <param name="device"> a GPU context. </param>
    /// <returns> a command buffer, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SubmitGPUCommandBuffer"/>
    /// <seealso cref="SubmitGPUCommandBufferAndAcquireFence"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_AcquireGPUCommandBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         The data being pushed must respect std140 layout conventions. In practical terms this means you must ensure that
    ///         vec3 and vec4 fields are 16-byte aligned.
    ///     </para>
    ///     <para>
    ///         For detailed information about accessing uniform data from a shader, please refer to
    ///         <see cref="CreateGPUShader"/>.
    ///     </para>
    /// </summary>
    /// <param name="commandBuffer"> a command buffer. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUVertexUniformData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUVertexUniformData(nint commandBuffer, uint slotIndex, nint data, uint length);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUVertexUniformData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUVertexUniformData(nint commandBuffer,
        uint slotIndex,
    ...
    /// <param name="length"> the length of the data to write. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUFragmentUniformData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUFragmentUniformData(nint commandBuffer, uint slotIndex, nint data, uint length);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUFragmentUniformData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUFragmentUniformData(nint commandBuffer,
        uint slotIndex,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] data,
        uint length);
    ...
    /// <param name="length"> the length of the data to write. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUComputeUniformData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUComputeUniformData(nint commandBuffer, uint slotIndex, nint data, uint length);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PushGPUComputeUniformData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void PushGPUComputeUniformData(nint commandBuffer,
        uint slotIndex,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] data,
        uint length);
    ...
    ///     <para>
    ///         A render pass consists of a set of texture subresources (or depth slices in the 3D texture case) which will be
    ///         rendered to during the render pass, along with corresponding clear values and load/store operations. All operations
    ///         related to graphics pipelines must take place inside of a render pass. A default viewport and scissor state are
    ///         automatically set when this is called. You cannot begin another render pass, or begin a compute pass or copy pass
    ///         until you have ended the render pass.
    ///     </para>
    /// </summary>
    /// <param name="commandBuffer"> a command buffer. </param>
    /// <param name="colorTargetInfos"> an array of texture subresources with corresponding clear values and load/store ops. </param>
    /// <param name="numColorTargets"> the number of color targets in the <c> colorTargetInfos </c> array. </param>
    /// <param name="depthStencilTargetInfo">
    ///     a texture subresource with corresponding clear value and load/store ops, may be
    ///     <c> null </c>.
    /// </param>
    /// <returns> a render pass handle. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="EndGPURenderPass"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BeginGPURenderPass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint BeginGPURenderPass(nint commandBuffer,
        nint colorTargetInfos,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="EndGPURenderPass"/>
    [DllImport(SDLLibrary, EntryPoint = "SDL_BeginGPURenderPass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static extern nint BeginGPURenderPass(nint commandBuffer,
        [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.Struct, SizeParamIndex = 2)]
        in GPUColorTargetInfo[] colorTargetInfos,
        uint numColorTargets,
        nint depthStencilTargetInfo);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUGraphicsPipeline"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUGraphicsPipeline(nint renderPass, nint graphicsPipeline);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUViewport"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void SetGPUViewport(nint renderPass, in GPUViewport viewport);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUScissor"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void SetGPUScissor(nint renderPass, in Rect scissor);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUBlendConstants"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void SetGPUBlendConstants(nint renderPass, in FColor blendConstants);
    ...
    /// <param name="indexElementSize"> whether the index values in the buffer are 16- or 32-bit. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUIndexBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUIndexBuffer(nint renderPass,
        in GPUBufferBinding binding,
    ...
    ///     <para> These textures must have been created with <see cref="GPUTextureUsageFlags.GraphicsStorageRead"/>. </para>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUVertexStorageTextures"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUVertexStorageTextures(nint renderPass,
        uint firstSlot,
        nint[] storageTextures,
        uint numBindings);
    ...
    ///     <para> These buffers must have been created with <see cref="GPUBufferUsageFlags.GraphicsStorageRead"/>. </para>
    ///     <para> Be sure your shader is set up according to the requirements documented in <see cref="CreateGPUShader"/>. </para>
    /// </summary>
    /// <param name="renderPass"> a render pass handle. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUVertexStorageBuffers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUVertexStorageBuffers(nint renderPass,
        uint firstSlot,
        nint[] storageBuffers,
        uint numBindings);
    ...
    ///     <para>
    ///         Note that the <c> firstIndex </c> and <c> firstInstance </c> parameters are NOT compatible with built-in
    ///         vertex/instance ID variables in shaders (for example, SV_VertexID); GPU APIs and shader languages do not define
    ///         these built-in variables consistently, so if your shader depends on them, the only way to keep behavior consistent
    ///         and portable is to always pass 0 for the correlating parameter in the draw calls.
    ///     </para>
    /// </summary>
    /// <param name="renderPass"> a render pass handle. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DrawGPUIndexedPrimitives"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DrawGPUIndexedPrimitives(nint renderPass,
        uint numIndices,
        uint numInstances,
        uint firstIndex,
        short vertexOffset,
    ...
    ///     <para> You must not call this function before binding a graphics pipeline. </para>
    ///     <para>
    ///         Note that the <c> firstVertex </c> and <c> firstInstance </c> parameters are NOT compatible with built-in
    ///         vertex/instance ID variables in shaders (for example, SV_VertexID); GPU APIs and shader languages do not define
    ///         these built-in variables consistently, so if your shader depends on them, the only way to keep behavior consistent
    ///         and portable is to always pass 0 for the correlating parameter in the draw calls.
    ///     </para>
    ...
    /// <param name="firstInstance"> the ID of the first instance to draw. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DrawGPUPrimitives"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DrawGPUPrimitives(nint renderPass,
        uint numVertices,
        uint numInstances,
        uint firstVertex,
        uint firstInstance);
    ...
    ///         <see cref="GPUIndirectDrawCommand"/>. You must not call this function before binding a graphics pipeline.
    ///     </para>
    /// </summary>
    /// <param name="renderPass"> a render pass handle. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DrawGPUPrimitivesIndirect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DrawGPUPrimitivesIndirect(nint renderPass, nint buffer, uint offset, uint drawCount);
    ...
    ///     <para>
    ///         The buffer must consist of tightly-packed draw parameter sets that each match the layout of
    ///         <see cref="GPUIndexedIndirectDrawCommand"/>. You must not call this function before binding a graphics pipeline.
    ///     </para>
    /// </summary>
    /// <param name="renderPass"> a render pass handle. </param>
    /// <param name="buffer"> a buffer containing draw parameters. </param>
    ...
    /// <param name="drawCount"> the number of draw parameter sets that should be read from the draw buffer. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DrawGPUIndexedPrimitivesIndirect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DrawGPUIndexedPrimitivesIndirect(nint renderPass,
        nint buffer,
        uint offset,
        uint drawCount);
    ...
    /// <param name="renderPass"> a render pass handle. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_EndGPURenderPass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void EndGPURenderPass(nint renderPass);
    ...
    ///         pipelines. These textures and buffers must have been created with the
    ///         <see cref="GPUTextureUsageFlags.ComputeStorageWrite"/> bit or the
    ///         <see cref="GPUTextureUsageFlags.ComputeStorageSimultaneousReadWrite"/> bit. If you do not create a texture with
    ///         <see cref="GPUTextureUsageFlags.ComputeStorageSimultaneousReadWrite"/>, you must not read from the texture in the
    ///         compute pass. All operations related to compute pipelines must take place inside of a compute pass. You must not
    ///         begin another compute pass, or a render pass or copy pass before ending the compute pass.
    ///     </para>
    ///     <para>
    ///         A VERY IMPORTANT NOTE - Reads and writes in compute passes are NOT implicitly synchronized. This means you may
    ///         cause data races by both reading and writing a resource region in a compute pass, or by writing multiple times to a
    ///         resource region. If your compute work depends on reading the completed output from a previous dispatch, you MUST end
    ///         the current compute pass and begin a new one before you can safely access the data. Otherwise you will receive
    ///         unexpected results. Reading and writing a texture in the same compute pass is only supported by specific texture
    ///         formats. Make sure you check the format support!
    ///     </para>
    /// </summary>
    /// <param name="commandBuffer"> a command buffer. </param>
    /// <param name="storageTextureBindings"> an array of writeable storage texture binding structs. </param>
    /// <param name="numStorageTextureBindings"> the number of storage textures to bind from the array. </param>
    /// <param name="storageBufferBindings"> an array of writeable storage buffer binding structs. </param>
    /// <param name="numStorageBufferBindings"> the number of storage buffers to bind from the array. </param>
    /// <returns> a compute pass handle. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="EndGPUComputePass"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BeginGPUComputePass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint BeginGPUComputePass(nint commandBuffer,
        GPUStorageTextureReadWriteBinding[] storageTextureBindings,
        uint numStorageTextureBindings,
        GPUStorageBufferReadWriteBinding[] storageBufferBindings,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUComputePipeline"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUComputePipeline(nint computePass, nint computePipeline);
    ...
    ///     <para>
    ///         A VERY IMPORTANT NOTE If you dispatch multiple times in a compute pass, and the dispatches write to the same
    ///         resource region as each other, there is no guarantee of which order the writes will occur. If the write order
    ///         matters, you MUST end the compute pass and begin another one.
    ///     </para>
    /// </summary>
    /// <param name="computePass"> a compute pass handle. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DispatchGPUCompute"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DispatchGPUCompute(nint computePass,
        uint groupcountX,
        uint groupcountY,
        uint groupcountZ);
    ...
    ///     <para>
    ///         The buffer layout should match the layout of <see cref="GPUIndirectDispatchCommand"/>. You must not call this
    ///         function before binding a compute pipeline.
    ///     </para>
    ///     <para>
    ///         A VERY IMPORTANT NOTE If you dispatch multiple times in a compute pass, and the dispatches write to the same
    ///         resource region as each other, there is no guarantee of which order the writes will occur. If the write order
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DispatchGPUComputeIndirect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DispatchGPUComputeIndirect(nint computePass, nint buffer, uint offset);
    ...
    /// <param name="computePass"> a compute pass handle. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_EndGPUComputePass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void EndGPUComputePass(nint computePass);
    ...
    ///     <para>
    ///         You must unmap the transfer buffer before encoding upload commands. The memory is owned by the graphics driver -
    ///         do NOT call <see cref="Free"/> on the returned pointer.
    ///     </para>
    /// </summary>
    /// <param name="device"> a GPU context. </param>
    ...
    /// <returns>
    ///     the address of the mapped transfer buffer memory, or <c> null </c> on failure; call <see cref="GetError"/> for
    ///     more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_MapGPUTransferBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint MapGPUTransferBuffer(nint device,
        nint transferBuffer,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UnmapGPUTransferBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void UnmapGPUTransferBuffer(nint device, nint transferBuffer);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BeginGPUCopyPass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint BeginGPUCopyPass(nint commandBuffer);
    ...
    /// <param name="cycle"> if <c> true </c>, cycles the texture if the texture is bound, otherwise overwrites the data. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UploadToGPUTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void UploadToGPUTexture(nint copyPass,
        in GPUTextureTransferInfo source,
        in GPUTextureRegion destination,
        [MarshalAs(UnmanagedType.I1)] bool cycle);
    ...
    /// <param name="cycle"> if <c> true </c>, cycles the buffer if it is already bound, otherwise overwrites the data. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UploadToGPUBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void UploadToGPUBuffer(nint copyPass,
        in GPUTransferBufferLocation source,
        in GPUBufferRegion destination,
        [MarshalAs(UnmanagedType.I1)] bool cycle);
    ...
    /// <param name="cycle">
    ///     if <c> true </c>, cycles the destination texture if the destination texture is bound, otherwise
    ///     overwrites the data.
    /// </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CopyGPUTextureToTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void CopyGPUTextureToTexture(nint copyPass,
        in GPUTextureLocation source,
        in GPUTextureLocation destination,
        uint w,
        uint h,
        uint d,
        [MarshalAs(UnmanagedType.I1)] bool cycle);
    ...
    /// <param name="cycle"> if <c> true </c>, cycles the destination buffer if it is already bound, otherwise overwrites the data. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CopyGPUBufferToBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void CopyGPUBufferToBuffer(nint copyPass,
        in GPUBufferLocation source,
        in GPUBufferLocation destination,
        uint size,
        [MarshalAs(UnmanagedType.I1)] bool cycle);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DownloadFromGPUTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DownloadFromGPUTexture(nint copyPass,
        in GPUTextureRegion source,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DownloadFromGPUBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void DownloadFromGPUBuffer(nint copyPass,
        in GPUTextureRegion source,
    ...
    /// <param name="copyPass"> a copy pass handle. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_EndGPUCopyPass"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void EndGPUCopyPass(nint copyPass);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GenerateMipmapsForGPUTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void GenerateMipmapsForGPUTexture(nint commandBuffer, nint texture);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BlitGPUTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BlitGPUTexture(nint commandBuffer, in GPUBlitInfo info);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_WindowSupportsGPUSwapchainComposition"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool WindowSupportsGPUSwapchainComposition(nint device,
        nint window,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="ClaimWindowForGPUDevice"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_WindowSupportsGPUPresentMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool WindowSupportsGPUPresentMode(nint device, nint window, GPUPresentMode presentMode);
    ...
    ///     <para>
    ///         This must be called before <see cref="AcquireGPUSwapchainTexture"/> is called using the window. You should only
    ///         call this function from the thread that created the window.
    ///     </para>
    ///     <para>
    ///         The swapchain will be created with <see cref="GPUSwapchainComposition.SDR"/> and
    ///         <see cref="GPUPresentMode.VSync"/>. If you want to have different swapchain parameters, you must call
    ///         <see cref="SetGPUSwapchainParameters"/> after claiming the window.
    ///     </para>
    /// </summary>
    /// <param name="device"> a GPU context. </param>
    /// <param name="window"> an SDL_Window. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ClaimWindowForGPUDevice"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool ClaimWindowForGPUDevice(nint device, nint window);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="ClaimWindowForGPUDevice"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseWindowFromGPUDevice"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///         Check if the parameters are supported via <see cref="WindowSupportsGPUPresentMode"/> /
    ///         <see cref="WindowSupportsGPUSwapchainComposition"/> prior to calling this function.
    ///     </para>
    ///     <para> <see cref="GPUPresentMode.VSync"/> with <see cref="GPUSwapchainComposition.SDR"/> is always supported. </para>
    /// </summary>
    /// <param name="device"> a GPU context. </param>
    /// <param name="window"> an SDL_Window that has been claimed. </param>
    ...
    /// <returns> <c> true </c> if successful, <c> false </c> on error; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="WindowSupportsGPUPresentMode"/>
    /// <seealso cref="WindowSupportsGPUSwapchainComposition"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUSwapchainParameters"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetGPUSwapchainParameters(nint device,
        nint window,
        GPUSwapchainComposition swapchainComposition,
    ...
    ///         presentation, if the GPU has not finished working on the first frame, <see cref="AcquireGPUSwapchainTexture"/> will
    ///         fill the swapchain texture pointer with <c> null </c>, and <see cref="WaitAndAcquireGPUSwapchainTexture"/> will
    ///         block.
    ///     </para>
    ///     <para>
    ///         Higher values increase throughput at the expense of visual latency. Lower values decrease visual latency at the
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPUAllowedFramesInFlight"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetGPUAllowedFramesInFlight(nint device, uint allowedFramesInFlight);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGPUSwapchainTextureFormat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GPUTextureFormat GetGPUSwapchainTextureFormat(nint device, nint window);
    ...
    ///     <para>
    ///         When a swapchain texture is acquired on a command buffer, it will automatically be submitted for presentation
    ///         when the command buffer is submitted. The swapchain texture should only be referenced by the command buffer used to
    ///         acquire it.
    ///     </para>
    ///     <para>
    ///         This function will fill the swapchain texture handle with NULL if too many frames are in flight. This is not an
    ///         error. This NULL pointer should not be passed back into SDL. Instead, it should be considered as an indication to
    ///         wait until the swapchain is available.
    ///     </para>
    ///     <para>
    ///         If you use this function, it is possible to create a situation where many command buffers are allocated while the
    ///         rendering context waits for the GPU to catch up, which will cause memory usage to grow. You should use
    ///         <see cref="WaitAndAcquireGPUSwapchainTexture"/> unless you know what you are doing with timing.
    ///     </para>
    ///     <para>
    ///         The swapchain texture is managed by the implementation and must not be freed by the user. You MUST NOT call this
    ...
    /// <param name="swapchainTexture"> a pointer filled in with a swapchain texture handle. </param>
    /// <param name="swapchainTextureWidth"> a pointer filled in with the swapchain texture width, may be <c> null </c>. </param>
    /// <param name="swapchainTextureHeight"> a pointer filled in with the swapchain texture height, may be <c> null </c>. </param>
    /// <returns> <c> true </c> on success, <c> false </c> on error; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called from the thread that created the window. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="ClaimWindowForGPUDevice"/>
    /// <seealso cref="SubmitGPUCommandBuffer"/>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_AcquireGPUSwapchainTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool AcquireGPUSwapchainTexture(nint commandBuffer,
        nint window,
    ...
    /// <param name="device"> a GPU context. </param>
    /// <param name="window"> a window that has been claimed. </param>
    /// <returns> <c> true </c> on success, <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called from the thread that created the window. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="AcquireGPUSwapchainTexture"/>
    /// <seealso cref="WaitAndAcquireGPUSwapchainTexture"/>
    /// <seealso cref="SetGPUAllowedFramesInFlight"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_WaitForGPUSwapchain"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool WaitForGPUSwapchain(nint device, nint window);
    ...
    ///         When a swapchain texture is acquired on a command buffer, it will automatically be submitted for presentation
    ///         when the command buffer is submitted. The swapchain texture should only be referenced by the command buffer used to
    ///         acquire it. It is an error to call <see cref="CancelGPUCommandBuffer"/> after a swapchain texture is acquired.
    ///     </para>
    ///     <para>
    ///         This function can fill the swapchain texture handle with <c> null </c> in certain cases, for example if the
    ///         window is minimized. This is not an error. You should always make sure to check whether the pointer is <c> null </c>
    ...
    /// <seealso cref="SubmitGPUCommandBufferAndAcquireFence"/>
    /// <seealso cref="AcquireGPUSwapchainTexture"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_WaitAndAcquireGPUSwapchainTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool WaitAndAcquireGPUSwapchainTexture(nint commandBuffer,
        nint window,
        out nint swapchainTexture,
        out uint swapchainTextureWidth,
        out uint swapchainTextureHeight);
    ...
    ///     <para>
    ///         All commands in the submission are guaranteed to begin executing before any command in a subsequent submission
    ///         begins executing.
    ///     </para>
    /// </summary>
    /// <param name="commandBuffer"> a command buffer. </param>
    ...
    /// <seealso cref="AcquireGPUSwapchainTexture"/>
    /// <seealso cref="SubmitGPUCommandBufferAndAcquireFence"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SubmitGPUCommandBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SubmitGPUCommandBuffer(nint commandBuffer);
    ...
    /// <summary>
    ///     <para>
    ///         Submits a command buffer so its commands can be processed on the GPU, and acquires a fence associated with the
    ///         command buffer.
    ///     </para>
    ///     <para>
    ///         You must release this fence when it is no longer needed or it will cause a leak. It is invalid to use the command
    ...
    /// <param name="commandBuffer"> a command buffer. </param>
    /// <returns>
    ///     a fence associated with the command buffer, or <c> null </c> on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="AcquireGPUCommandBuffer"/>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SubmitGPUCommandBufferAndAcquireFence"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint SubmitGPUCommandBufferAndAcquireFence(nint commandBuffer);

    /// <code>extern SDL_DECLSPEC bool SDLCALL SDL_CancelGPUCommandBuffer(SDL_GPUCommandBuffer *command_buffer);</code>
    /// <summary>
    ///     <para> Cancels a command buffer. </para> <para> None of the enqueued commands are executed. </para>
    ...
    /// <seealso cref="AcquireGPUCommandBuffer"/>
    /// <seealso cref="AcquireGPUSwapchainTexture"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CancelGPUCommandBuffer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool CancelGPUCommandBuffer(nint commandBuffer);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_WaitForGPUIdle"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool WaitForGPUIdle(nint device);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SubmitGPUCommandBufferAndAcquireFence"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_QueryGPUFence"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool QueryGPUFence(nint device, nint fence);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SubmitGPUCommandBufferAndAcquireFence"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReleaseGPUFence"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GPUTextureFormatTexelBlockSize"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GPUTextureSupportsFormat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GPUTextureSupportsFormat(nint device,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GPUTextureSupportsSampleCount"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GPUTextureSupportsSampleCount(nint device,
        GPUTextureFormat format,
        GPUSampleCount sampleСount);
    ...
    /// <since> This function is available since SDL 3.1.6. </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CalculateGPUTextureFormatSize"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial uint CalculateGPUTextureFormatSize(GPUTextureFormat format,
        uint width,
        uint height,
    ...
    /// <summary>
    ///     <para> Call this to suspend GPU operation on Xbox when you receive the <see cref="EventType.DidEnterBackground"/> event. </para>
    ///     <para>
    ///         Do NOT call any SDL_GPU functions after calling this function! This must also be called before calling
    ///         <see cref="GDKSuspendComplete"/>.
    ///     </para>
    /// </summary>
    /// <param name="device"> device a GPU context. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="AddEventWatch"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GDKSuspendGPU"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void GDKSuspendGPU(nint device);

    /// <code>extern SDL_DECLSPEC void SDLCALL SDL_GDKResumeGPU(SDL_GPUDevice *device);</code>
    /// <summary>
    ///     <para> Call this to resume GPU operation on Xbox when you receive the <see cref="EventType.WillEnterForeground"/> event. </para>
    ///     <para> When resuming, this function MUST be called before calling any other SDL_GPU functions. </para>
    /// </summary>
    /// <param name="device"> device a GPU context. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="AddEventWatch"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GDKResumeGPU"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void GDKResumeGPU(nint device);
    ...
    /// <param name="bindings"> an array of <see cref="GPUBufferBinding"/> structs containing vertex buffers and offset values. </param>
    /// <param name="numBindings"> the number of bindings in the bindings array. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUVertexBuffers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUVertexBuffers(nint renderPass,
        uint firstSlot,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] GPUBufferBinding[] bindings,
        uint numBindings);
    ...
    /// <param name="firstSlot"> the vertex buffer slot to begin binding from. </param>
    /// <param name="bindings">
    ///     a pointer to an array of <see cref="GPUBufferBinding"/> structs containing vertex buffers and offset
    ///     values.
    /// </param>
    /// <param name="numBindings"> the number of bindings in the bindings array. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUVertexBuffers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUVertexBuffers(nint renderPass, uint firstSlot, nint bindings, uint numBindings);
    ...
    /// <param name="textureSamplerBindings"> an array of texture-sampler binding structs. </param>
    /// <param name="numBindings"> the number of texture-sampler pairs to bind from the array. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUVertexSamplers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUVertexSamplers(nint renderPass,
        uint firstSlot,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] GPUTextureSamplerBinding[] textureSamplerBindings,
        uint numBindings);
    ...
    /// <param name="renderPass"> a render pass handle. </param>
    /// <param name="firstSlot"> the vertex sampler slot to begin binding from. </param>
    /// <param name="textureSamplerBindings"> a pointer an array of texture-sampler binding structs. </param>
    /// <param name="numBindings"> the number of texture-sampler pairs to bind from the array. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUVertexSamplers"),
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUFragmentSamplers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUFragmentSamplers(nint renderPass,
        uint firstSlot,
        GPUTextureSamplerBinding[] textureSamplerBindings,
        uint numBindings);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUFragmentStorageTextures"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUFragmentStorageTextures(nint renderPass,
        uint firstSlot,
        nint[] storageTextures,
        uint numBindings);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUFragmentStorageBuffers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUFragmentStorageBuffers(nint renderPass,
        uint firstSlot,
        nint[] storageBuffers,
        uint numBindings);
    ...
    /// <param name="textureSamplerBindings"> an array of texture-sampler binding structs. </param>
    /// <param name="numBindings"> the number of texture-sampler bindings to bind from the array. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUComputeSamplers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUComputeSamplers(nint computePass,
        uint firstSlot,
        GPUTextureSamplerBinding[] textureSamplerBindings,
        uint numBindings);
    ...
    ///     <para> These textures must have been created with <see cref="GPUTextureUsageFlags.ComputeStorageRead"/>. </para>
    ///     <para> Be sure your shader is set up according to the requirements documented in <see cref="CreateGPUShader"/>. </para>
    /// </summary>
    /// <param name="computePass"> a compute pass handle. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUComputeStorageTextures"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUComputeStorageTextures(nint computePass,
        uint firstSlot,
        nint[] storageTextures,
        uint numBindings);
    ...
    ///     <para> These buffers must have been created with <see cref="GPUBufferUsageFlags.ComputeStorageRead"/>. </para>
    ///     <para> Be sure your shader is set up according to the requirements documented in <seealso cref="CreateGPUShader"/>. </para>
    /// </summary>
    /// <param name="computePass"> a compute pass handle. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateGPUShader"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_BindGPUComputeStorageBuffers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void BindGPUComputeStorageBuffers(nint computePass,
        uint firstSlot,
        nint[] storageBuffers,
        uint numBindings);
    ...
    /// <param name="device"> a GPU context. </param>
    /// <param name="waitAll"> if 0, wait for any fence to be signaled, if 1, wait for all fences to be signaled. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_WaitForGPUFences"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool WaitForGPUFences(nint device,
