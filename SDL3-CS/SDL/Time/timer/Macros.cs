...
public static partial class SDL
{
    ...
    /// <summary>
    ///     <para> Convert seconds to nanoseconds. </para> <para> This only converts whole numbers, not fractional seconds. </para>
    /// </summary>
    ...
    ///     <para>
    ///         This performs a division, so the results can be dramatically different if <c> ns </c> is an integer or floating
    ///         point value.
    ///     </para>
    /// </summary>
