...
public static partial class SDL
{
	...
	///     <para>
	///         This might be a "slow" call that has to query the operating system. It's best to ask for this once and save the
	///         results. However, the preferred formats can change, usually because the user has changed a system preference outside
	///         of your program.
	///     </para>
	/// </summary>
	/// <param name="dateFormat"> a pointer to the <see cref="DateFormat"/> to hold the returned date format, may be <c> null </c>. </param>
	/// <param name="timeFormat"> a pointer to the <see cref="TimeFormat"/> to hold the returned time format, may be <c> null </c>. </param>
	/// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_GetDateTimeLocalePreferences"),
	...
	/// <summary>
	///     <para>
	///         Gets the current value of the system realtime clock in nanoseconds since Jan 1, 1970 in Universal Coordinated
	///         Time (UTC).
	///     </para>
	/// </summary>
	...
	/// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_GetCurrentTime"),
	 UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: MarshalAs(UnmanagedType.I1)]
	...
	/// <summary> Converts an SDL_Time in nanoseconds since the epoch to a calendar time in the <see cref="DateTime"/> format. </summary>
	...
	///     the resulting <see cref="DateTime"/> will be expressed in local time if true, otherwise it will be
	///     in Universal Coordinated Time (UTC).
	/// </param>
	/// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_TimeToDateTime"),
	 UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool
        TimeToDateTime(long ticks, out DateTime dt, [MarshalAs(UnmanagedType.I1)] bool localTime);
	...
	///     <para> This function ignores the day_of_week member of the <see cref="DateTime"/> struct, so it may remain unset. </para>
	/// </summary>
	/// <param name="dt"> the source <see cref="DateTime"/>. </param>
	/// <param name="ticks"> the resulting SDL_Time. </param>
	/// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_DateTimeToTime"),
	 UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: MarshalAs(UnmanagedType.I1)]
	...
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_TimeToWindows"),
	 UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_TimeFromWindows"),
	 UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// <returns> the number of days in the requested month or -1 on failure; call <see cref="GetError"/> for more information. </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
	[LibraryImport(SDLLibrary, EntryPoint = "SDL_GetDaysInMonth"),
	 UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// <returns> the day of year [0-365] if the date is valid or -1 on failure; call <see cref="GetError"/> for more information. </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
	...
	/// <param name="day"> the day component of the date. </param>
	/// <returns>
	///     a value between 0 and 6 (0 being Sunday) if the date is valid or -1 on failure; call <see cref="GetError"/> for
	///     more information.
	/// </returns>
	/// <since> This function is available since SDL 3.2.0 </since>
