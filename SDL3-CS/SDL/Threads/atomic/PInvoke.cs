...
public static partial class SDL
{
 ...
 ///     <para>
 ///         <b>
 ///             Please note that spinlocks are dangerous if you don't know what you're doing. Please be careful using any sort
 ///             of spinlock!
 ///         </b>
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_TryLockSpinlock"),
 ...
 /// <summary>
 ///     <para> Unlock a spin lock by setting it to 0. </para> <para> Always returns immediately. </para>
 ///     <para>
 ///         <b>
 ///             Please note that spinlocks are dangerous if you don't know what you're doing. Please be careful using any sort
 ///             of spinlock!
 ...
 /// <seealso cref="LockSpinlock"/>
 /// <seealso cref="TryLockSpinlock"/>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_UnlockSpinlock"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 ///     <para>
 ///         Please refer to SDL_MemoryBarrierRelease for details. This is a function version, which might be useful if you
 ///         need to use this functionality from a scripting language, etc. Also, some of the macro versions call this function
 ///         behind the scenes, where more heavy lifting can happen inside of SDL. Generally, though, an app written in C/C++/etc
 ///         should use the macro version, as it will be more efficient.
 ///     </para>
 /// </summary>
 /// <threadsafety>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_MemoryBarrierReleaseFunction"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_MemoryBarrierAcquireFunction"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 ///     <para>
 ///         <b> Note: If you don't know what this function is for, you shouldn't use it! </b>
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_CompareAndSwapAtomicInt"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
 ...
 /// <summary>
 ///     <para> Add to an atomic variable. </para> <para> This function also acts as a full memory barrier. </para>
 ///     <para>
 ///         <b> Note: If you don't know what this function is for, you shouldn't use it! </b>
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_CompareAndSwapAtomicU32"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
 ...
 /// <summary>
 ///     <para> Set an atomic variable to a value. </para> <para> This function also acts as a full memory barrier. </para>
 ///     <para>
 ///         <b> Note: If you don't know what this function is for, you shouldn't use it! </b>
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_CompareAndSwapAtomicPointer"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool CompareAndSwapAtomicPointer(ref nint a, nint oldval, nint newval);
 ...
 /// <seealso cref="GetAtomicPointer"/>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetAtomicPointer"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint SetAtomicPointer(ref nint a, nint v);
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "GetAtomicPointer"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetAtomicPointer(ref nint a);
}