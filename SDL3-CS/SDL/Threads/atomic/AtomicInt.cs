...
public static partial class SDL
{
    ...
    ///         app sets a value with <see cref="SetAtomicInt"/> all other threads, regardless of the CPU it is running on, will see
    ///         that value when retrieved with <see cref="GetAtomicInt"/>, regardless of CPU caches, etc.
    ///     </para>
    ///     <para>
