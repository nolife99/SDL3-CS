...
{
    /// <summary>
    ///     <para> This file contains functions to set and get configuration hints, as well as listing each of them alphabetically. </para>
    ///     <para>
    ///         The convention for naming hints is X, where "SDL_X" is the environment variable that can be used to override the
    ///         default.
    ///     </para>
    ///     <para>
    ///         In general these hints are just that - they may or may not be supported or applicable on any given platform, but
    ///         they provide a way for an application or user to give the library a hint as to how they would like the library to
    ///         work.
    ///     </para>
    /// </summary>
    public static class Hints
    {
        ...
        ///     <para>
        ///         By default, SDL emulates Alt+Tab functionality while the keyboard is grabbed and your window is full-screen. This
        ///         prevents the user from getting stuck in your application if you've enabled keyboard grab.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: SDL will not handle Alt+Tab. Your application is responsible for handling Alt+Tab while the
        ///             keyboard is grabbed.
        ///         </item>
        ...
        ///     <para>
        ///         If this hint is true, the activity can be recreated on demand by the OS, and Java static data and C++ static data
        ///         remain with their current values. If this hint is false, then SDL will call exit() when you return from your main
        ///         function and the application will be terminated and then started fresh each time.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Non blocking. </item> <item> <c> "1" </c>: Blocking. (default) </item>
        ///     </list>
        /// </summary>
        ...
        ///     <para>
        ///         This is necessary for the right mouse button to work on some Android devices, or to be able to trap the back
        ///         button for use in your code reliably. If this hint is true, the back button will show up as an
        ///         <see cref="EventType.KeyDown"/> / <see cref="EventType.KeyUp"/> pair with a keycode of <see cref="Scancode.ACBack"/>
        ///         .
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <item>
        ///             "1": Back button will be trapped, allowing you to handle the key press manually. (This will also let right
        ///             mouse click work on systems where the right mouse button functions as back.)
        ///         </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        ...
        ///     </para>
        ///     <para> This will override <see cref="Props.AppMetadataIdentifierString"/>, if set by the application. </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         This hint lets you specify the application name sent to the OS when required. For example, this will often appear
        ///         in volume control applets for audio streams, and in lists of applications which are inhibiting the screensaver. You
        ///         should use a string that describes your program (<c> "My Game 2: The Revenge" </c>)
        ///     </para>
        ///     <para> This will override <see cref="Props.AppMetadataNameString"/>, if set by the application. </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         When UI events are generated by controller input, the app will be backgrounded when the Apple TV remote's menu
        ///         button is pressed, and when the pause or B buttons on gamepads are pressed.
        ///     </para>
        ///     <para>
        ///         More information about properly making use of controllers for the Apple TV can be found here:
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the Apple TV remote's joystick axes will automatically match the rotation of the
        ///         remote.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <see cref="AudioALSADefaultPlaybackDevice"/> is set, or when opening the default recording device if
        ///         <see cref="AudioALSADefaultRecordingDevice"/> is set.
        ///     </para>
        /// </summary>
        ...
        ///     <para> If this hint isn't set, SDL will check <see cref="AudioALSADefaultDevice"/> before choosing a reasonable default. </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "ambient" </c>: Use the AVAudioSessionCategoryAmbient audio category, will be muted by the phone mute
        ///             switch (default)
        ///         </item>
        ...
        ///     <para>
        ///         If the application doesn't specify the audio channel count when opening the device, this hint can be used to
        ///         specify a default channel count that will be used. This defaults to <c> "1" </c> for recording and <c> "2" </c> for
        ///         playback devices.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        ...
        ///     <para>
        ///         Some audio backends (such as Pulseaudio and Pipewire) allow you to set an XDG icon name for your application.
        ///         Among other things, this icon might show up in a system control panel that lets the user adjust the volume on
        ///         specific audio streams instead of using one giant master volume slider. Note that this is unrelated to the icon used
        ///         by the windowing system, which may be set with <see cref="SetWindowIcon"/> (or via desktop file on Wayland).
        ///     </para>
        ///     <para>
        ///         Setting this to <c> "" </c> or leaving it unset will have SDL use a reasonable default,
        ///         <c> "applications-games" </c>, which is likely to be installed. See
        ///         https://specifications.freedesktop.org/icon-theme-spec/icon-theme-spec-latest.html and
        ///         https://specifications.freedesktop.org/icon-naming-spec/icon-naming-spec-latest.html for the relevant XDG icon
        ///         specs.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        ...
        ///     <para>
        ///         This hint is an integer > 0, that represents the size of the device's buffer in sample frames (stereo audio data
        ///         in 16-bit format is 4 bytes per sample frame, for example).
        ///     </para>
        ///     <para>
        ///         SDL3 generally decides this value on behalf of the app, but if for some reason the app needs to dictate this
        ///         (because they want either lower latency or higher throughput AND ARE WILLING TO DEAL WITH what that might require of
        ///         the app), they can specify it.
        ///     </para>
        ///     <para>
        ///         SDL will try to accommodate this value, but there is no promise you'll get the buffer size requested. Many
        ///         platforms won't honor this request at all, or might adjust it.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         Some audio backends (such as PulseAudio) allow you to describe your audio stream. Among other things, this
        ///         description might show up in a system control panel that lets the user adjust the volume on specific audio streams
        ///         instead of using one giant master volume slider.
        ///     </para>
        ///     <para>
        ///         This hints lets you transmit that information to the OS. The contents of this hint are used while opening an
        ///         audio device. You should use a string that describes your what your program is playing (<c> "audio stream" </c> is
        ///         probably sufficient in many cases, but this could be useful for something like "team chat" if you have a headset
        ///         playing VoIP audio separately).
        ///     </para>
        ///     <para>
        ///         Setting this to <c> "" </c> or leaving it unset will have SDL use a reasonable default: <c> "audio stream" </c>
        ///         or something similar.
        ///     </para>
        ///     <para>
        ///         Note that while this talks about audio streams, this is an OS-level concept, so it applies to a physical audio
        ///         device in this case, and not an SDL_AudioStream, nor an SDL logical audio device.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         Some audio backends (such as Pipewire) allow you to describe the role of your audio stream. Among other things,
        ///         this description might show up in a system control panel or software for displaying and manipulating media
        ///         playback/recording graphs.
        ///     </para>
        ///     <para>
        ///         This hints lets you transmit that information to the OS. The contents of this hint are used while opening an
        ///         audio device. You should use a string that describes your what your program is playing (Game, Music, Movie, etc...).
        ///     </para>
        ///     <para>
        ///         Setting this to <c> "" </c> or leaving it unset will have SDL use a reasonable default: <c> "Game" </c> or
        ///         something similar.
        ///     </para>
        ///     <para>
        ///         Note that while this talks about audio streams, this is an OS-level concept, so it applies to a physical audio
        ...
        ///     <para>
        ///         The disk audio driver normally simulates real-time for the audio rate that was specified, but you can use this
        ///         variable to adjust this rate higher or lower down to 0. The default value is <c> "1.0" </c>.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         By default, SDL will try all available audio backends in a reasonable order until it finds one that can work, but
        ///         this hint allows the app or user to force a specific driver, such as <c> "pipewire" </c> if, say, you are on
        ...
        ///     <para>
        ///         The dummy audio driver normally simulates real-time for the audio rate that was specified, but you can use this
        ///         variable to adjust this rate higher or lower down to 0. The default value is <c> "1.0" </c>.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        ...
        ///     <para>
        ///         If the application doesn't specify the audio format when opening the device, this hint can be used to specify a
        ///         default format that will be used.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "U8" </c>: Unsigned 8-bit audio </item> <item> <c> "S8" </c>: Signed 8-bit audio </item>
        ...
        ///     <para>
        ///         If the application doesn't specify the audio frequency when opening the device, this hint can be used to specify
        ///         a default frequency that will be used. This defaults to <c> "44100" </c>.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an audio device is opened. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         By default, SDL ignores audio devices that aren't associated with physical hardware. Changing this hint to
        ///         <c> "1" </c> will expose anything SDL sees that appears to be an audio source or sink. This will add
        ///         <c> "devices" </c> to the list that the user probably doesn't want or need, but it can be useful in scenarios where
        ///         you want to hook up SDL to some sort of virtual device, etc.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: Surfaces with a colorkey or an alpha channel are saved to a 32-bit BMP file with an alpha mask.
        ///             SDL will use the bitmap header version 4 and set the alpha mask accordingly. (default)
        ///         </item>
        ///         <item>
        ///             <c> "1" </c>: Surfaces with a colorkey or an alpha channel are saved to a 32-bit BMP file without an alpha
        ...
        ///     <para>
        ///         By default, SDL will try all available camera backends in a reasonable order until it finds one that can work,
        ///         but this hint allows the app or user to force a specific target, such as <c> "directshow" </c> if, say, you are on
        ///         Windows Media Foundations but want to try DirectShow instead.
        ///     </para>
        ///     <para>
        ///         The default value is unset, in which case SDL will try to figure out the best camera backend on your behalf. This
        ///         hint needs to be set before <see cref="SDL.Init(SDL.InitFlags)"/> is called to be useful.
        ///     </para>
        /// </summary>
        /// <remarks> </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         By default, SDL marks all features the current CPU supports as available. This hint allows to limit these to a
        ///         subset.
        ///     </para>
        ...
        ///     <para>
        ///         By default, SDL will try all available dialog backends in a reasonable order until it finds one that can work,
        ///         but this hint allows the app or user to force a specific target.
        ///     </para>
        ///     <para> If the specified target does not exist or is not available, the dialog-related function calls will fail. </para>
        ///     <para>
        ///         This hint currently only applies to platforms using the generic <c> "Unix" </c>; dialog implementation, but may
        ///         be extended to more platforms in the future. Note that some Unix and Unix-like platforms have their own
        ///         implementation, such as macOS and Haiku.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         If set, this hint will override the expected results for <see cref="GetDisplayUsableBounds"/> for display index
        ///         0. Generally you don't want to do this, but this allows an embedded system to request that some of the screen be
        ///         reserved for other uses when paired with a well-behaved application.
        ///     </para>
        ///     <para>
        ///         The contents of this hint must be 4 comma-separated integers, the first is the bounds x, then y, width and
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: Disable emscripten_sleep calls (if you give back browser control manually or use asyncify for
        ///             other purposes).
        ///         </item>
        ...
        ///     <para> This hint only applies to the emscripten platform. </para> <para> The variable can be one of: </para>
        ///     <list type="bullet">
        ...
        ///         <item> any other string without a leading <c> # </c> sign applies to the element on the page with that ID. </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a window. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "auto" </c>: The on-screen keyboard will be shown if there is no physical keyboard attached. (default) </item>
        ...
        ///     <para> The list of devices is in the form: </para> <para> deviceclass:path[,deviceclass:path[,...]] </para>
        ///     <para>
        ///         where device class is an integer representing the SDL_UDEV_deviceclass and path is the full path to the event
        ///         device.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        ...
        ///             <see cref="Log"/>, which means by default they appear on stdout on most platforms or
        ///             <c> maybeOutputDebugString() </c> on Windows, and can be funneled by the app with
        ///             <see cref="SetLogOutputFunction"/>, etc.
        ///         </para>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        ...
        ///     </list>
        ///     <para>
        ///         At present, this is only an issue under MS Windows, which makes it nearly impossible to programmatically move a
        ///         window to the foreground, for <c> "security" </c> reasons. See http://stackoverflow.com/a/34414846 for a discussion.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///         <item>
        ///             <c> "X" </c>: Enable 3D acceleration, using X where X is one of the valid rendering drivers. (e.g.
        ///             <c> "direct3d" </c>, <c> "opengl" </c>, etc.)
        ///         </item>
        ///     </list>
        /// </summary>
        ...
        ///     <para>
        ///         You can update mappings after SDL is initialized with <see cref="GetGamepadMappingForGUID"/> and
        ///         <see cref="AddGamepadMapping"/>
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     </para>
        ///     <para>
        ///         The variable can also take the form of <c> "@file" </c>, in which case the named file will be loaded and
        ///         interpreted as the value of the variable.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         If set, all devices will be skipped when scanning for game controllers except for the ones listed in this
        ///         variable.
        ///     </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ...
        /// <summary>
        ///     <para>
        ///         A variable that controls whether the device's built-in accelerometer and gyro should be used as sensors for
        ///         gamepads.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         The value must be a stringified integer, for example <c> "10" </c> to allow for up to 10 characters of text
        ///         input.
        ///     </para>
        ///     <para> This hint is available only if SDL_GDK_TEXTINPUT defined. </para>
        /// </summary>
        ...
        ///         The value must be a stringified integer, for example <c> "0" </c> for XGameUiTextEntryInputScope::Default.
        ///     </para>
        ///     <para> This hint is available only if SDL_GDK_TEXTINPUT defined. </para>
        /// </summary>
        /// <remarks> This hint should be set before calling <see cref="StartTextInput"/> </remarks>
        ...
        ///     <para>
        ///         By default libusb will only be used for a few devices that require direct USB access, and this can be controlled
        ///         with HIDAPI_LIBUSB_WHITELIST.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         By default, SDL will try all available GPU backends in a reasonable order until it finds one that can work, but
        ///         this hint allows the app or user to force a specific target, such as <c> direct3d12 </c> if, say, your hardware
        ...
        /// <summary>
        ///     <para> A variable to control whether SDL_hid_enumerate() enumerates all HID devices or only controllers. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     </list>
        ///     <para>
        ///         By default SDL will only enumerate controllers, to reduce risk of hanging or crashing on devices with bad drivers
        ///         and avoiding macOS keyboard capture permission prompts.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     </para>
        ///     <para>
        ///         For example, to ignore the Shanwan DS3 controller and any Valve controller, you might use the string
        ///         <c> 0x2563/0x0523,0x28de/0x0000 </c>;
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         By default IME UI is handled using native components by the OS where possible, however this can interfere with or
        ///         not be visible when exclusive fullscreen mode is used.
        ///     </para>
        ///     <para> The variable can be set to a comma separated list containing the following items: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "none" </c> or "0": The application can't render any IME elements, and native UI should be used.
        ///             (default)
        ///         </item>
        ///         <item>
        ///             <c> "composition" </c>: The application handles <see cref="EventType.TextEditing"/> events and can render the
        ///             composition text.
        ///         </item>
        ///         <item>
        ///             <c> "candidates" </c>: The application handles <see cref="EventType.TextEditingCandidates"/> and can render
        ///             the candidate list.
        ///         </item>
        ///     </list>
        /// </summary>
        ...
        ///         <item>
        ///             <c> "1" </c>: The indicator bar is hidden and is shown when the screen is touched (useful for movie playback
        ///             applications).
        ///         </item>
        ///         <item>
        ///             <c> "2" </c>: The indicator bar is dim and the first swipe makes it visible and the second swipe performs the
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> "0": Disable joystick &amp; gamecontroller input events when the application is in the background. (default) </item>
        ...
        ///     <para> This will override <see cref="JoystickArcadestickDevices"/> and the built in device list. </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ///         <c> 0xAAAA/0xBBBB,0xCCCC/0xDDDD </c>
        ///     </para>
        ...
        ///     <para> This will override <see cref="JoystickBlacklistDevices"/> and the built in device list. </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ///         <c> 0xAAAA/0xBBBB,0xCCCC/0xDDDD </c>
        ///     </para>
        ...
        ///     <para>
        ///         Enhanced reports allow rumble and effects on Bluetooth PlayStation controllers and gyro on Nintendo Switch
        ///         controllers, but break Windows DirectInput for other applications that don't use SDL.
        ///     </para>
        ///     <para>
        ///         Once enhanced reports are enabled, they can't be disabled on PlayStation controllers without power cycling the
        ///         controller.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <item>
        ///             <c> "auto" </c>: enhanced features are advertised to the application, but SDL doesn't change the controller
        ///             report mode unless the application uses them.
        ///         </item>
        ///     </list>
        /// </summary>
        ...
        ///     <para> This will override <see cref="JoystickFlightstickDevices"/> and the built in device list. </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ///         <c> 0xAAAA/0xBBBB,0xCCCC/0xDDDD </c>
        ///     </para>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: GameInput is not used. </item> <item> <c> "1" </c>: GameInput is used. </item>
        ///     </list>
        ...
        ///     <para> This will override <see cref="JoystickGameCubeDevices"/> and the built in device list. </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ///         <c> 0xAAAA/0xBBBB,0xCCCC/0xDDDD </c>
        ///     </para>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> "0": HIDAPI drivers are not used. </item> <item> "1": HIDAPI drivers are used. (default) </item>
        ///     </list>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: HIDAPI driver is not used. </item> <item> <c> "1" </c>: HIDAPI driver is used. </item>
        ///     </list>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether rumble is used to implement the GameCube controller's 3 rumble modes, Stop(0),
        ///         Rumble(1), and StopHard(2).
        ///     </para>
        ///     <para>
        ///         This is useful for applications that need full compatibility for things like ADSR envelopes. - Stop is
        ///         implemented by setting low_frequency_rumble to 0 and high_frequency_rumble >0 - Rumble is both at any arbitrary
        ///         value - StopHard is implemented by setting both low_frequency_rumble and high_frequency_rumble to 0
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the Home button LED should be turned on when a Nintendo Switch Joy-Con controller
        ///         is opened.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: home button LED is turned off </item> <item> <c> "1" </c>: home button LED is turned on </item>
        ///     </list>
        ///     <para>
        ///         By default the Home button LED state is not changed. This hint can also be set to a floating point value between
        ///         0.0 and 1.0 which controls the brightness of the Home button LED.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the HIDAPI driver for Amazon Luna controllers connected via Bluetooth should be
        ///         used.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> 0: HIDAPI driver is not used. </item> <item> 1: HIDAPI driver is used. </item>
        ///     </list>
        ///     <para> The default is the value of <see cref="JoystickHIDAPI"/>. </para>
        /// </summary>
        /// <remarks> This hint should be set before initializing joysticks and gamepads. </remarks>
        ...
        ///         <item> <c> "0" </c>: HIDAPI driver is not used. </item> <item> <c> "1" </c>: HIDAPI driver is used. </item>
        ///     </list>
        ///     <para> The default is the value of <see cref="JoystickHIDAPI"/> on macOS, and <c> "0" </c> on other platforms. </para>
        ///     <para>
        ///         For official Sony driver (sixaxis.sys) use <see cref="JoystickHIDAPIPS3SixAxisDriver"/>. See
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the Sony driver (sixaxis.sys) for PS3 controllers (Sixaxis/DualShock 3) should be
        ///         used.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         This defaults to 4 ms, to match the behavior over USB, and to be more friendly to other Bluetooth devices and
        ///         older Bluetooth hardware on the computer. It can be set to <c> "1" </c> (1000Hz), <c> "2" </c> (500Hz) and
        ///         <c> "4" </c> (250Hz)
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime, but only takes effect when extended input reports are enabled. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the player LEDs should be lit to indicate which player is associated with a PS5
        ///         controller.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <item>
        ///             <c> "1" </c>: HIDAPI driver is used for Steam Controllers, which requires Bluetooth access and may prompt the
        ///             user for permission on iOS and Android.
        ///         </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before initializing joysticks and gamepads. </remarks>
        ...
        ///     </list>
        ///     <para>
        ///         By default the Steam button LED state is not changed. This hint can also be set to a floating point value between
        ///         0.0 and 1.0 which controls the brightness of the Steam button LED.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.1.8. </since>
        ...
        ///     <para>
        ///         This variable can be set to the following values: <c> "0" </c> - HIDAPI driver is not used <c> "1" </c> - HIDAPI
        ///         driver is used
        ///     </para>
        ///     <para> The default is the value of <see cref="JoystickHIDAPI"/> </para>
        /// </summary>
        ...
        /// <summary>
        ///     <para> A variable controlling whether the HIDAPI driver for Flydigi controller should be used. </para>
        ///     <para> This variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <b> "0" </b> - HIDAPI driver is not used. </item> <item> <b> "1" </b> - HIDAPI driver is used. </item>
        ///     </list>
        /// </summary>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the Home button LED should be turned on when a Nintendo Switch Pro controller is
        ///         opened.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether Nintendo Switch Joy-Con controllers will be in vertical mode when using the HIDAPI
        ///         driver.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the player LEDs should be lit to indicate which player is associated with a Wii
        ///         controller.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <item> <c> "0" </c>: HIDAPI driver is not used. </item> <item> <c> "1" </c>: HIDAPI driver is used. </item>
        ///     </list>
        ///     <para> The default is <c> "0" </c> on Windows, otherwise the value of <see cref="JoystickHIDAPI"/> </para>
        /// </summary>
        /// <remarks> This hint should be set before initializing joysticks and gamepads. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the player LEDs should be lit to indicate which player is associated with an Xbox
        ///         360 controller.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         By default the Home button LED state is not changed. This hint can also be set to a floating point value between
        ///         0.0 and 1.0 which controls the brightness of the Home button LED. The default brightness is 0.4.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the new HIDAPI driver for wired Xbox One (GIP) controllers should reset the
        ///         controller if it can't get the metadata from the controller.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: IOKit is not used. </item> <item> <c> "1" </c>: IOKit is used. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Use /dev/input/event* (default) </item> <item> <c> "1" </c>: Use /dev/input/js* </item>
        ///     </list>
        ///     <para> </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether joysticks on Linux adhere to their HID-defined deadzones or return unfiltered
        ///         values.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether joysticks on Linux will always treat <c> 'hat' </c> axis inputs (ABS_HAT0X -
        ///         ABS_HAT3Y) as 8-way digital hats without checking whether they may be analog.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: Only map hat axis inputs to digital hat outputs if the input axesappear to actually be digital.
        ///             (default)
        ///         </item>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether digital hats on Linux will apply deadzones to their underlying input axes or use
        ///         unfiltered values.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: GCController is not used. </item> <item> <c> "1" </c>: GCController is used. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether the RAWINPUT joystick drivers should be used for better handling XInput-capable
        ///         devices.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <item>
        ///             <c> "1" </c>: RAWINPUT driver will also pull data from XInput and Windows.Gaming.Input, providing better
        ///             trigger axes, guide button presses, and rumble support for Xbox controllers. (default)
        ///         </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before a gamepad is opened. </remarks>
        ...
        ///     <para> This will override <see cref="JoystickThrottleDevices"/> and the built in device list. </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ///         <c> `0xAAAA/0xBBBB,0xCCCC/0xDDDD` </c>
        ///     </para>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: WGI is not used. </item> <item> <c> "1" </c>: WGI is used. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> This will override <see cref="JoystickWheelDevices"/> and the built in device list. </para>
        ///     <para> The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form, e.g. </para>
        ///     <para>
        ///         <c> `0xAAAA/0xBBBB,0xCCCC/0xDDDD` </c>
        ///     </para>
        ...
        ///     <para>
        ///         The format of the string is a comma separated list of USB VID/PID pairs in hexadecimal form plus the number of
        ///         desired axes, e.g.
        ///     </para>
        ///     <para>
        ///         <c> 0xAAAA/0xBBBB/1,0xCCCC/0xDDDD/3 </c>
        ///     </para>
        ///     <para>
        ///         This hint supports a "wildcard" device that will set the number of haptic axes on all initialized haptic devices
        ///         which were not defined explicitly in this hint.
        ///     </para>
        ///     <para>
        ///         <c> 0xFFFF/0xFFFF/1 </c>
        ///     </para>
        ///     <para>
        ///         This hint should be set before a controller is opened. The number of haptic axes won't exceed the number of real
        ///         axes found on the device.
        ///     </para>
        /// </summary>
        ...
        ///         <item>
        ///             <c> "hide_numpad" </c>: The numpad keysyms will be translated into their non-numpad versions based on the
        ///             current NumLock state. For example, <see cref="Keycode.Kp4"/> would become <see cref="Keycode.Alpha4"/> if
        ///             <see cref="Keymod.Num"/> is set in the event modifiers, and <see cref="Keycode.Left"/> if it is unset.
        ///         </item>
        ///         <item>
        ///             <c> "french_numbers" </c>: The number row on French keyboards is inverted, so pressing the 1 key would yield
        ///             the keycode <see cref="Keycode.Alpha1"/>, or <c> '1' </c>, instead of <see cref="Keycode.Ampersand"/>, or
        ///             <c> '&amp;' </c>
        ///         </item>
        ///         <item>
        ///             <c> "latin_letters" </c>: For keyboards using non-Latin letters, such as Russian or Thai, the letter keys
        ///             generate keycodes as though it had an en_US layout. e.g. pressing the key associated with
        ///             <see cref="Scancode.A"/> on a Russian keyboard would yield <c> 'a' </c> instead of a Cyrillic letter.
        ///         </item>
        ///     </list>
        ...
        ///     <para>
        ///         These options do not affect the return value of <see cref="GetKeyFromScancode"/> or
        ///         <see cref="GetScancodeFromKey"/>, they just apply to the keycode included in key events.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         SDL might open something like <c> "/dev/dri/cardNN" </c> to access KMSDRM functionality, where <c> "NN" </c> is a
        ///         device index number. SDL makes a guess at the best index to use (usually zero), but the app or user can set this
        ///         hint to a number between 0 and 99 to force selection.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         The DRM subsystem has a concept of a <c> "DRM master" </c> which is a DRM client that has the ability to set
        ///         planes, set cursor, etc. When SDL is DRM master, it can draw to the screen using the SDL rendering APIs. Without DRM
        ///         master, SDL is still able to process input and query attributes of attached displays, but it cannot change display
        ///         state or draw to the screen directly.
        ///     </para>
        ///     <para>
        ///         In some cases, it can be useful to have the KMSDRM backend even if it cannot be used for rendering. An app may
        ///         want to use SDL for input processing while using another rendering API (such as an MMAL overlay on Raspberry Pi) or
        ...
        ///     <para>
        ///         This variable is a comma separated set of category=level tokens that define the default logging levels for SDL
        ///         applications.
        ///     </para>
        ///     <para>
        ///         The category can be a numeric category, one of <c> "app" </c>, <c> "error" </c>, <c> "assert" </c>,
        ///         <c> "system" </c>, <c> "audio" </c>, <c> "video" </c>, <c> "render" </c>, <c> "input" </c>, <c> "test" </c>, or
        ///         <c> `*` </c> for any unspecified category.
        ///     </para>
        ///     <para>
        ///         The level can be a numeric level, one of <c> "verbose" </c>, <c> "debug" </c>, <c> "info" </c>, <c> "warn" </c>,
        ///         <c> "error" </c>, <c> "critical" </c>, or <c> "quiet" </c> to disable that category.
        ///     </para>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: The application is brought to the foreground when launched. (default) </item>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Ctrl+Click does not generate a right mouse button click event. (default) </item>
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether dispatching OpenGL context updates should block the dispatching thread until the
        ///         main thread finishes processing on macOS.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: Dispatching OpenGL context updates will block the dispatching thread until the main thread
        ///             finishes processing. (default)
        ///         </item>
        ///         <item> <c> "1" </c>: Dispatching OpenGL context updates will allow the dispatching thread to continue execution. </item>
        ///     </list>
        ///     <para>
        ...
        /// <summary>
        ///     <para> AA variable controlling whether the Option key on macOS should be remapped to act as the Alt key. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     </list>
        ///     <para>
        ///         This will prevent the triggering of key compositions that rely on the Option key, but will still send the Alt
        ///         modifier for keyboard events. In the case that both Alt and Option are pressed, the Option key will be ignored. This
        ///         is particularly useful for applications like terminal emulators and graphical user interfaces (GUIs) that rely on
        ///         Alt key functionality for shortcuts or navigation. This does not apply to <see cref="GetKeyFromScancode"/> and only
        ///         has an effect if IME is enabled.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        ...
        /// <summary>
        ///     <para> A variable controlling whether SDL_EVENT_MOUSE_WHEEL event values will have momentum on macOS. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         If this is set to a number, it represents Hz, so "60" means try to iterate 60 times per second. "0" means to
        ///         iterate as fast as possible. Negative values are illegal, but reserved, in case they are useful in a future revision
        ///         of SDL.
        ///     </para>
        ///     <para>
        ///         There are other strings that have special meaning. If set to "waitevent", <see cref="AppIterate"/> will not be
        ///         called until new event(s) have arrived (and been processed by <see cref="AppEvent"/>). This can be useful for apps
        ///         that are completely idle except in response to input.
        ///     </para>
        ///     <para>
        ///         On some platforms, or if you are using SDL_main instead of <see cref="AppIterate"/>, this hint is ignored. When
        ///         the hint can be used, it is allowed to be changed at any time.
        ///     </para>
        ///     <para> This defaults to 0, and specifying <c> null </c> for the hint's value will restore the default. </para>
        ///     <para>
        ///         This doesn't have to be an integer value. For example, "59.94" won't be rounded to an integer rate; the digits
        ///         after the decimal are actually respected.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     </list>
        ///     <para>
        ///         By default the mouse is captured while mouse buttons are pressed so if the mouse is dragged outside the window,
        ///         the application continues to receive mouse events until the button is released.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         This should be an integer corresponding to the SDL_SystemCursor enum. The default value is zero (
        ///         <see cref="SystemCursor.Default"/>).
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         When this hint is set, the mouse cursor is hidden, and multiple warps to the window center occur within a short
        ///         time period, SDL will emulate mouse warps using relative mouse mode. This can provide smoother and more reliable
        ///         mouse motion for some older games, which continuously calculate the distance travelled by the mouse pointer and warp
        ///         it back to the center of the window, rather than using relative mouse motion.
        ///     </para>
        ///     <para> Note that relative mouse mode may have different mouse acceleration behavior than pointer warps. </para>
        ///     <para>
        ///         If your application needs to repeatedly warp the hidden mouse cursor at a high-frequency for other purposes, it
        ///         should disable this hint.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Attempts to warp the mouse will always be made. </item>
        ///         <item> <c> "1" </c>: Some mouse warps will be emulated by forcing relative mouse mode. (default) </item>
        ///     </list>
        ...
        ///     <para>
        ///         Constraining to the center of the window works better for FPS games and when the application is running over RDP.
        ///         Constraining to the whole window works better for 2D games and increases the chance that the mouse will be in the
        ///         correct position when using high DPI mice.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Relative mouse mode constrains the mouse to the window. </item>
        ///         <item> <c> "1" </c>: Relative mouse mode constrains the mouse to the center of the window. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///         <item> <c> "1" </c>: Relative mouse motion will be scaled using the system mouse acceleration curve. </item>
        ///     </list>
        ///     <para> If <see cref="MouseRelativeSpeedScale"/> is set, that will be applied after system speed scale. </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     </list>
        ///     <para>
        ///         By default warping the mouse will not generate motion events in relative mode. This avoids the application having
        ///         to filter out large relative motion due to warping.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     </list>
        ///     <para>
        ///         Note that for systems without raw hardware inputs, relative mode is implemented using warping, so the hardware
        ///         cursor will visibly warp between frames if this is enabled on those systems.
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Mouse events will not generate touch events. (default for desktop platforms) </item>
        ///         <item>
        ///             <c> "1" </c>: Mouse events will generate touch events. (default for mobile platforms, such as Android and
        ///             iOS)
        ///         </item>
        ///     </list>
        /// </summary>
        ...
        ///     <para>
        ///         Normally the keyboard is muted while SDL applications are running so that keyboard input doesn't show up as key
        ///         strokes on the console. This hint allows you to turn that off for debugging purposes.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: SDL will install a SIGINT and SIGTERM handler, and when it catches a signal, convert it into an
        ///             <see cref="EventType.Quit"/> event. (default)
        ///         </item>
        ...
        /// </summary>
        /// <remarks>
        ///     This hint should be set before creating an OpenGL window or creating an OpenGL context. If this hint isn't set,
        ///     SDL will choose a reasonable default.
        /// </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         This hint should be set before creating an OpenGL window or creating an OpenGL context. This hint is only
        ///         considered if SDL is using EGL to manage OpenGL contexts. If this hint isn't set, SDL will choose a reasonable
        ///         default.
        ///     </para>
        /// </summary>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         On some platforms, currently Windows and X11, OpenGL drivers may support creating contexts with an OpenGL ES
        ///         profile. By default SDL uses these profiles, when available, otherwise it attempts to load an OpenGL ES library,
        ///         e.g. that provided by the ANGLE project. This variable controls whether SDL follows this default behaviour or will
        ///         always load an OpenGL ES library.
        ///     </para>
        ///     <para>
        ///         Circumstances where this is useful include - Testing an app with a particular OpenGL ES implementation, e.g
        ///         ANGLE, or emulator, e.g. those from ARM, Imagination or Qualcomm. - Resolving OpenGL ES function addresses at link
        ///         time by linking with the OpenGL ES library instead of querying them at run time with <see cref="GLGetProcAddress"/>.
        ///     </para>
        ///     <para>
        ///         Caution: for an application to work with the default behaviour across different OpenGL drivers it must query the
        ///         OpenGL ES function addresses at run time using <see cref="GLGetProcAddress"/>.
        ///     </para>
        ...
        ///     <para>
        ///         By default, when using the OpenVR driver, it will search for the API library in the current folder. But, if you
        ///         wish to use a system API you can specify that by using this hint. This should be the full or relative path to a .dll
        ///         on Windows or .so on Linux.
        ///     </para>
        /// </summary>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <list type="bullet">
        ///         <item> <c> "LandscapeLeft" </c>; </item> <item> <c> "LandscapeRight" </c>; </item>
        ///         <item> <c> "Portrait" </c>; </item> <item> <c> "PortraitUpsideDown" </c>; </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         When polling for events, <see cref="SDL.PumpEvents"/> is used to gather new events from devices. If a device
        ///         keeps producing new events between calls to <see cref="SDL.PumpEvents"/>, a poll loop will become stuck until the
        ///         new events stop. This is most noticeable when moving a high frequency mouse.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable poll sentinels. </item> <item> <c> "1" </c>: Enable poll sentinels. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         If set, this will be favored over anything the OS might report for the user's preferred locales. Changing this
        ///         hint at runtime will not generate a <see cref="EventType.LocaleChanged"/> event (but if you can change the hint, you
        ///         can push your own event, if you want).
        ///     </para>
        ///     <para>
        ///         The format of this hint is a comma-separated list of language and locale, combined with an underscore, as is a
        ///         common format: <c> "en_GB" </c>. Locale is optional: <c> "en" </c>. So you might have a list like this:
        ///         <c> "en_GB,jp,es_PT" </c>;
        ///     </para>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        ...
        /// <summary>
        ///     <para> A variable that decides whether to send <see cref="EventType.Quit"/> when closing the last window. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: SDL will not send an <see cref="EventType.Quit"/> event when the last window is requesting to
        ///             close. Note that in this case, there are still other legitimate reasons one might get an
        ///             <see cref="EventType.Quit"/> event: choosing <c> "Quit" </c>; from the macOS menu bar, sending a SIGINT (ctrl-c)
        ///             on Unix, etc.
        ///         </item>
        ///         <item> <c> "1" </c>: SDL will send a quit event when the last window is requesting to close. (default) </item>
        ///     </list>
        ///     <para>
        ///         If there is at least one active system tray icon, <see cref="EventType.Quit"/> will instead be sent when both the
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable Debug Layer use. (default) </item> <item> <c> "1" </c>: Enable Debug Layer use. </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a renderer. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> This variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable Validation Layer use </item> <item> <c> "1" </c>: Enable Validation Layer use </item>
        ///     </list>
        ...
        ///     <para> This variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable debug mode use (default) </item> <item> <c> "1" </c>: Enable debug mode use </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a renderer. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> This variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Prefer high-performance GPU (default) </item> <item> <c> "1" </c>: Prefer low-power GPU </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a renderer. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         If the application doesn't pick a specific renderer to use, this variable specifies the name of the preferred
        ///         renderer. If the preferred renderer can't be initialized, creating a renderer will fail.
        ///     </para>
        ///     <para> This variable is case insensitive and can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "direct3d" </c>; </item> <item> <c> "direct3d11" </c>; </item> <item> <c> "direct3d12" </c>; </item>
        ///         <item> <c> "opengl" </c>; </item> <item> <c> "opengles2" </c>; </item> <item> <c> "opengles" </c>; </item>
        ///         <item> <c> "metal" </c>; </item> <item> <c> "vulkan" </c>; </item> <item> <c> "software" </c>; </item>
        ///     </list>
        ///     <para>
        ///         This hint accepts a comma-separated list of driver names, and each will be tried in the order listed when
        ///         creating a renderer until one succeeds or all of them fail.
        ///     </para>
        ...
        ///         <item> <c> "1" </c>: Use the driver point API using Bresenham's line algorithm (correct, draws many points) </item>
        ///         <item> <c> "2" </c>: Use the driver line API (occasionally misses line endpoints based on hardware driver quirks </item>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable vsync. (default) </item> <item> <c> "1" </c>: Enable vsync. </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a renderer. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A variable to control whether the return key on the soft keyboard should hide the soft keyboard on Android and
        ///         iOS.
        ///     </para>
        ...
        ///     <para>
        ///         Some platforms, notably Linux desktops, list the applications which are inhibiting the screensaver or other
        ///         power-saving features.
        ///     </para>
        ///     <para>
        ///         This hint lets you specify the <c> "activity name" </c> sent to the OS when <see cref="DisableScreenSaver"/> is
        ///         used (or the screensaver is automatically disabled). The contents of this hint are used when the screensaver is
        ///         disabled. You should use a string that describes what your program is doing (and, therefore, why the screensaver is
        ///         disabled). For example, <c> "Playing a game" </c> or <c> "Watching a video" </c>.
        ///     </para>
        ///     <para>
        ///         Setting this toor leaving it unset will have SDL use a reasonable default: <c> "Playing a game" </c> or something
        ///         similar.
        ///     </para>
        /// </summary>
        ...
        ///     <para>
        ///         This is useful as a debug tool to validate memory leaks, but shouldn't ever be set in production applications, as
        ///         other libraries used by the application might use dbus under the hood and this can cause crashes if they continue
        ///         after <see cref="Quit"/>.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         By default, SDL will try all available storage backends in a reasonable order until it finds one that can work,
        ///         but this hint allows the app or user to force a specific target, such as <c> "pc" </c> if, say, you are on Steam but
        ...
        ///     <para>
        ///         By default, SDL will try all available storage backends in a reasonable order until it finds one that can work,
        ///         but this hint allows the app or user to force a specific target, such as pc if, say, you are on Steam but want to
        ///         avoid SteamRemoteStorage for user data.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para> Specifies whether SDL_ThreadPriority should be treated as realtime. </para>
        ///     <para>
        ///         On some platforms, like Linux, a realtime priority thread may be subject to restrictions that require special
        ///         handling by the application. This hint exists to let SDL know that the app is prepared to handle said restrictions.
        ///     </para>
        ...
        ///         <item>
        ///             Exceeding this limit will result in the kernel sending SIGKILL to the app, refer to the man pages for more
        ///             information.
        ///         </item>
        ///     </list>
        ///     <para> The variable can be set to the following values: </para>
        ...
        ///         <item> <c> "1" </c>: Force SDL_ThreadPriority to a realtime scheduling policy </item>
        ///     </list>
        /// </summary>
        ...
        /// <summary>
        ///     <para> A string specifying additional information to use with SDL_SetCurrentThreadPriority. </para>
        ///     <para>
        ///         By default SDL_SetCurrentThreadPriority will make appropriate system changes in order to apply a thread priority.
        ...
        ///     </para>
        ///     <para>
        ///         pthread hint values are <c> "current" </c>, <c> "other" </c>, <c> "fifo" </c> and <c> "rr" </c>. Currently no
        ///         other platform hint values are defined but may be in the future.
        ///     </para>
        ///     <para>
        ///         On Linux, the kernel may send SIGKILL to realtime tasks which exceed the distro configured execution budget for
        ///         rtkit. This budget can be queried through RLIMIT_RTTIME after calling SDL_SetCurrentThreadPriority.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before calling SDL_SetCurrentThreadPriority </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         The higher resolution the timer, the more frequently the CPU services timer interrupts, and the more precise
        ///         delays are, but this takes up power and CPU time. This hint is only used on Windows.
        ///     </para>
        ///     <para>
        ...
        ///     <para>
        ///         On macOS (and possibly other platforms in the future), SDL will report touches on a trackpad as mouse input,
        ///         which is generally what users expect from this device; however, these are often actually full multitouch-capable
        ///         touch devices, so it might be preferable to some apps to treat them as such.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable screensaver. (default) </item> <item> <c> "1" </c>: Enable screensaver. </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para>
        ///         A comma separated list containing the names of the displays that SDL should sort to the front of the display
        ///         list.
        ///     </para>
        ///     <para>
        ///         When this hint is set, displays with matching name strings will be prioritized in the list of displays, as
        ///         exposed by calling <see cref="GetDisplays"/>, with the first listed becoming the primary display. The naming
        ///         convention can vary depending on the environment, but it is usually a connector name (e.g. <c> 'DP-1' </c>,
        ///         <c> 'DP-2' </c>, <c> 'HDMI-A-1' </c>,etc...).
        ///     </para>
        ///     <para>
        ///         On Wayland and X11 desktops, the connector names associated with displays can typically be found by using the
        ///         <c> `xrandr` </c> utility.
        ///     </para>
        ///     <para> This hint is currently supported on the following drivers: </para>
        ///     <list type="bullet">
        ///         <item> KMSDRM (kmsdrm) </item> <item> Wayland (wayland) </item> <item> X11 (x11) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         By default, most lowlevel 2D APIs will use a triple buffer scheme that wastes no CPU time on waiting for vsync
        ///         after issuing a flip, but introduces a frame of latency. On the other hand, using a double buffer scheme instead is
        ///         recommended for cases where low latency is an important factor because we save a whole frame of latency.
        ///     </para>
        ///     <para>
        ///         We do so by waiting for vsync immediately after issuing a flip, usually just after eglSwapBuffers call in the
        ///         backend's *_SwapWindow function.
        ///     </para>
        ///     <para> This hint is currently supported on the following drivers: </para>
        ///     <list type="bullet">
        ///         <item> Raspberry Pi (raspberrypi) </item> <item> Wayland (wayland) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         By default, SDL will try all available video backends in a reasonable order until it finds one that can work, but
        ///         this hint allows the app or user to force a specific target, such as <c> "x11" </c> if, say, you are on Wayland but
        ///         want to try talking to the X server instead.
        ///     </para>
        ///     <para>
        ///         This hint accepts a comma-separated list of driver names, and each will be tried in the order listed during init,
        ...
        ///         <item>
        ///             <c> "1" </c>: Video frames are saved to files in the format SDL_windowX-Y.bmp, where X is the window ID, and
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: Disable Spaces support (FULLSCREEN_DESKTOP won't use them and
        ///             <see cref="WindowFlags.Resizable"/> windows won't offer the fullscreen button on their titlebars).
        ///         </item>
        ///         <item>
        ///             <c> "1" </c>: Enable Spaces support (FULLSCREEN_DESKTOP will use them and <see cref="WindowFlags.Resizable"/>
        ///             windows will offer the fullscreen button on their titlebars). (default)
        ///         </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a window. </remarks>
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: The menu will be hidden when the window is in a fullscreen space, and not accessible by moving
        ///             the mouse to the top of the screen.
        ///         </item>
        ///         <item> <c> "1" </c>: The menu will be accessible when the window is in a fullscreen space. </item>
        ///         <item>
        ///             auto": The menu will be hidden if fullscreen mode was toggled on programmatically via
        ///             <see cref="SetWindowFullscreen"/>, and accessible if fullscreen was entered via the "fullscreen" button on the
        ...
        /// <summary>
        ///     <para>
        ///         A variable controlling whether SDL will attempt to automatically set the destination display to a mode most
        ///         closely matching that of the previous display if an exclusive fullscreen window is moved onto it.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: SDL will not attempt to automatically set a matching mode on the destination display. If an
        ///             exclusive fullscreen window is moved to a new display, the window will become fullscreen desktop.
        ///         </item>
        ///         <item>
        ///             <c> "1" </c>: SDL will attempt to automatically set a mode on the destination display that most closely
        ...
        ///     <para>
        ///         Window systems that run asynchronously may not have the results of window operations that resize or move the
        ///         window applied immediately upon the return of the requesting function. Setting this hint will cause such operations
        ///         to block after every call until the pending operation has completed. Setting this to <c> '1' </c> is the equivalent
        ///         of calling <see cref="SDL.SyncWindow(nint)"/> after every function call.
        ///     </para>
        ///     <para>
        ///         Be aware that amount of time spent blocking while waiting for window operations to complete can be quite lengthy,
        ///         as animations may have to complete, which can take upwards of multiple seconds in some cases.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///     <para>
        ///         When this hint is set, a standard set of emulated CVT video modes will be exposed for use by the application. If
        ///         it is disabled, the only modes exposed will be the logical desktop size and, in the case of a scaled desktop, the
        ...
        ///     <para>
        ///         When this hint is set, the requested scaling will be used when displaying fullscreen video modes that don't match
        ///         the display's native aspect ratio. This is contingent on compositor viewport support.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "aspect" </c> - Video modes will be displayed scaled, in their proper aspect ratio, with black bars. </item>
        ///         <item> <c> "stretch" </c> - Video modes will be scaled to fill the entire display. (default) </item>
        ...
        ///     <para>
        ///         When this hint is set, libdecor will be used to provide window decorations, even if xdg-decoration is available.
        ///         (Note that, by default, libdecor will use xdg-decoration itself if available).
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: libdecor is enabled only if server-side decorations are unavailable. (default) </item>
        ...
        ///     <para>
        ///         When this hint is set, Wayland windows that are not flagged as being DPI-aware will be output with scaling
        ///         designed to force 1:1 pixel mapping.
        ///     </para>
        ///     <para>
        ///         This is intended to allow legacy applications to be displayed without desktop scaling being applied, and has
        ///         issues with certain display configurations, as this forces the window to behave in a way that Wayland desktops were
        ///         not designed to accommodate:
        ///     </para>
        ///     <list type="bullet">
        ///         <item>
        ///             Rounding errors can result with odd window sizes and/or desktop scales, which can cause the window contents
        ///             to appear slightly blurry.
        ///         </item>
        ///         <item> Positioning the window may be imprecise due to unit conversions and rounding. </item>
        ...
        ///     <para>
        ///         SDL has EGL and OpenGL ES2 support on Windows via the ANGLE project. It can use two different sets of binaries,
        ///         those compiled by the user from source or those provided by the Chrome browser. In the later case, these binaries
        ...
        ///         <item>
        ///             <c> "none" </c> - do not load any library, useful if you compiled ANGLE from source and included the compiler
        ///             in your binaries.
        ///         </item>
        ///     </list>
        /// </summary>
        ...
        ///     windows. <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Don't call XSelectInput(), assuming the native window code has done it already. </item>
        ...
        ///     <para>
        ///         By default SDL will use _NET_WM_PING, but for applications that know they will not always be able to respond to
        ///         ping requests in a timely manner they can turn it off to avoid the window manager thinking the app is hung.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable _NET_WM_PING. </item> <item> <c> "1" </c>: Enable _NET_WM_PING. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before creating a window. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Disable XRandR. </item> <item> <c> "1" </c>: Enable XRandR. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "544" </c>: 544p (default) </item> <item> <c> "720" </c>: 725p for PSTV </item>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: Use OpenGL ES. (default) </item> <item> <c> "1" </c>: Use OpenGL. </item>
        ///     </list>
        ///     >
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        ...
        /// </summary>
        /// <remarks> This hint should be set before creating a Vulkan window or calling <see cref="SDL.VulkanLoadLibrary(string)"/>. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         The fact chunk stores information about the number of samples of a WAVE file. The Standards Update from Microsoft
        ///         notes that this value can be used to 'determine the length of the data in seconds'. This is especially useful for
        ///         compressed formats (for which this is a mandatory chunk) if they produce multiple sample frames per block and
        ///         truncating the block is not allowed. The fact chunk can exactly specify how many sample frames there should be in
        ///         this case.
        ///     </para>
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "truncate" </c> - Use the number of samples to truncate the wave data if the fact chunk is present and
        ///             valid.
        ///         </item>
        ///         <item>
        ///             <c> "strict" </c> - Like <c> "truncate" </c>, but raise an error if the fact chunk is invalid, not present
        ///             for non-PCM formats, or if the data chunk doesn't have that many samples.
        ///         </item>
        ///         <item> <c> "ignorezero" </c> - Like <c> "truncate" </c>, but ignore fact chunk if the number of samples is zero. </item>
        ...
        ///     <para>
        ///         This sets an upper bound on the number of chunks in a WAVE file to avoid wasting time on malformed or corrupt
        ///         WAVE files. This defaults to <c> "10000" </c>.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before calling <see cref="LoadWAV"/> or <see cref="LoadWAVIO"/> </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         The size of the RIFF chunk (which includes all the sub-chunks of the WAVE file) is not always reliable. In case
        ///         the size is wrong, it's possible to just ignore it and step through the chunks until a fixed limit is reached.
        ///     </para>
        ///     <para>
        ///         Note that files that have trailing data unrelated to the WAVE file or corrupt files may slow down the loading
        ///         process without a reliable boundary. By default, SDL stops after 10000 chunks to prevent wasting time. Use
        ///         <see cref="WaveChunkLimit"/> to adjust this value.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "force" </c> - Always use the RIFF chunk size as a boundary for the chunk search. </item>
        ///         <item> <c> "ignorezero" </c> - Like force, but a zero size searches up to 4 GiB. (default) </item>
        ...
        ///     <para>
        ///         A WAVE file is considered truncated if any of the chunks are incomplete or the data chunk size is not a multiple
        ///         of the block size. By default, SDL decodes until the first incomplete block, as most applications seem to do.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        /// <summary>
        ///     <para> A variable controlling whether the window is activated when the <see cref="RaiseWindow"/> function is called. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: The window is not activated when the <see cref="RaiseWindow"/> function is called. </item>
        ///         <item> <c> "1" </c>: The window is activated when the <see cref="RaiseWindow"/> function is called. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para> A variable controlling whether the window is activated when the <see cref="ShowWindow"/> function is called. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: The window is not activated when the <see cref="ShowWindow"/> function is called. </item>
        ///         <item> <c> "1" </c>: The window is activated when the <see cref="ShowWindow"/> function is called. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        /// <summary>
        ///     <para> If set to <c> "0" </c> then never set the top-most flag on an SDL Window even if the application requests it. </para>
        ///     <para> This is a debugging aid for developers and not expected to be used by end users. </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: don't allow topmost </item> <item> <c> "1" </c>: allow topmost (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint can be set anytime. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: The window frame is not interactive when the cursor is hidden (no move, resize, etc). </item>
        ...
        ///     <para>
        ///         If the mnemonics are enabled, then menus can be opened by pressing the Alt key and the corresponding mnemonic
        ///         (for example, Alt+F opens the File menu). However, in case an invalid mnemonic is pressed, Windows makes an audible
        ///         beep to convey that nothing happened. This is true even if the window has no menu at all!
        ///     </para>
        ///     <para>
        ///         Because most SDL applications don't have menus, and some want to use the Alt key for other purposes, SDL disables
        ///         mnemonics (and the beeping) by default.
        ///     </para>
        ///     <para>
        ///         Note: This also affects keyboard events: with mnemonics enabled, when a menu is opened from the keyboard, you
        ///         will not receive a KEYUP event for the mnemonic key, and <b> might </b> not receive one for Alt.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ...
        ///         <item> <c> "1" </c>: GameInput is used for raw keyboard and mouse events, if available. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     <para>
        ///         Kernel Semaphores are inter-process and require a context switch on every interaction. On Windows 8 and newer,
        ///         the WaitOnAddress API is available. Using that and atomics to implement semaphores increases performance. SDL will
        ///         fall back to Kernel Objects on older OS versions or if forced to by this hint.
        ///     </para>
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item>
        ///             <c> "0" </c>: Use Atomics and WaitOnAddress API when available, otherwise fall back to Kernel Objects.
        ///             (default)
        ///         </item>
        ...
        ///     <para>
        ///         Direct3D 9Ex contains changes to state management that can eliminate device loss errors during scenarios like
        ///         Alt+Tab or UAC prompts. D3D9Ex may require some changes to your application to cope with the new behavior, so this
        ...
        ///         <item> <c> "1" </c>: Use the Direct3D 9Ex API on Vista and later (and fall back if D3D9Ex is unavailable) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///         <item> <c> "1" </c>/<c> "initial" </c>: Clear the window when the first WM_ERASEBKGND event fires. (default) </item>
        ...
        ///     <para>
        ///         If set, this _might_ increase framerate at the expense of the desktop not working as expected. Override-redirect
        ///         windows aren't noticed by the window manager at all.
        ///     </para>
        ///     <para>
        ///         You should probably only use this for fullscreen windows, and you probably shouldn't even use it for that. But
        ...
        ///     <para>
        ///         During <see cref="SDL.CreateWindow"/>, SDL uses the _NET_WM_WINDOW_TYPE X11 property to report to the window
        ///         manager the type of window it wants to create. This might be set to various things if
        ///         <see cref="WindowFlags.Tooltip"/> or <see cref="WindowFlags.PopupMenu"/>, etc, were specified. For <c> "normal" </c>
        ///         windows that haven't set a specific type, this hint can be used to specify a custom type. For example, a dock window
        ...
        ///     <para> The variable can be set to the following values: </para>
        ///     <list type="bullet">
        ///         <item> <c> "0" </c>: XInput is not enabled. </item> <item> <c> "1" </c>: XInput is enabled. (default) </item>
        ///     </list>
        /// </summary>
        /// <remarks> This hint should be set before SDL is initialized. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///         <item> <c> "ignore" </c>: Program continues on, ignoring this assertion failure this time. </item>
        ///         <item> <c> "always_ignore" </c>: Program continues on, ignoring this assertion failure for the rest of the run. </item>
        ///     </list>
        ///     <para>
        ///         Note that SDL_SetAssertionHandler offers a programmatic means to deal with assertion failures through a callback,
        ///         and this hint is largely intended to be used via environment variables by end users and automated tools.
        ///     </para>
        /// </summary>
        /// <remarks> This hint should be set before an assertion failure is triggered and can be changed at any time. </remarks>
        /// <since> This hint is available since SDL 3.2.0 </since>
        ...
        ///     </list>
        ///     <para>
        ///         This is generally meant to be used as an environment variable to let end-users report what subsystems were chosen
        ///         on their system, perhaps what sort of hardware they are running on, etc, to aid in debugging. Logged information is
        ///         sent through <see cref="Log"/>, which means by default they appear on stdout on most platforms, or maybe
        ///         <c> OutputDebugString() </c> on Windows, and can be funneled by the app with <see cref="SetLogOutputFunction"/>,
        ///         etc.
        ///     </para>
        ///     <para> The specific output might change between SDL versions; more information might be deemed useful in the future. </para>
        /// </summary>
        /// <remarks> This hint can be set anytime, but the specific logs are generated during subsystem init. </remarks>
        /// <since> This hint is available since SDL 3.4.0. </since>
