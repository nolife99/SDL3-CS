...
public static partial class SDL
{
    ...
    ///         <see cref="SetAssertionHandler"/>), which will return one of these values, possibly after asking the user.
    ///     </para>
    ///     <para>
    ///         Then SDL will respond based on this outcome (loop around to retry the condition, try to break in a debugger, kill
    ///         the program, or ignore the problem).
    ///     </para>
    /// </summary>
