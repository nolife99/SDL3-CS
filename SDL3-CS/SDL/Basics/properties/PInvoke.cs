...
public static partial class SDL
{
 ...
 ///     <para>
 ///         Copy all the properties from one group of properties to another, with the exception of properties requiring
 ///         cleanup (set using <see cref="SetPointerPropertyWithCleanup"/>), which will not be copied. Any property that already
 ///         exists on `dst` will be overwritten.
 ///     </para>
 /// </summary>
 ...
 ///     </para>
 ///     <para>
 ///         The lock is automatically taken when setting individual properties, this function is only needed when you want to
 ///         set several properties atomically or want to guarantee that properties being queried aren't freed in another thread.
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_UnlockProperties"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///         <see cref="SetBooleanProperty"/>, or <see cref="SetStringProperty"/> instead, as those functions will handle cleanup
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetPointerProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetPointerProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        nint value);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetStringProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetStringProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetNumberProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetNumberProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        long value);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetFloatProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetFloatProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        float value);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetBooleanProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetBooleanProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
    ...
    ///     <para>
    ///         By convention, the names of properties that SDL exposes on objects will start with <c> "SDL." </c>, and
    ///         properties that SDL uses internally will start with <c> "SDL.internal." </c>. These should be considered read-only
    ...
    ///     potentially be freed if you call <see cref="SetPointerProperty"/> or <see cref="ClearProperty"/> on these properties
    ///     from another thread. If you need to avoid this, use <see cref="LockProperties"/> and <see cref="UnlockProperties"/>.
    /// </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetBooleanProperty"/>
    /// <seealso cref="GetFloatProperty"/>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetPointerProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetPointerProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        nint defaultValue);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetStringProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetStringProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumberProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial long GetNumberProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        long defaultValue);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetFloatProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial float GetFloatProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
        float defaultValue);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetBooleanProperty"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetBooleanProperty(uint props,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string name,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_EnumerateProperties"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool EnumerateProperties(uint props, EnumeratePropertiesCallback callback, nint userdata);
