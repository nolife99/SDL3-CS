...
public static partial class SDL
{
    ...
    ///     <para>
    ///         This callback will be called _during_ <see cref="SetPointerPropertyWithCleanup"/> if the function fails for any
    ///         reason.
    ///     </para>
    /// </summary>
    ...
    ///     <para> This callback is called from <see cref="EnumerateProperties"/>, and is called once per property in the set. </para>
    /// </summary>
    /// <param name="userdata"> an app-defined pointer passed to the callback. </param>
    ...
    /// <threadsafety> <see cref="EnumerateProperties"/> holds a lock on <c> props </c> during this callback. </threadsafety>
    /// <since> This datatype is available since SDL 3.2.0 </since>
    /// <seealso cref="EnumerateProperties"/>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void EnumeratePropertiesCallback(nint userdata,
        uint props,
