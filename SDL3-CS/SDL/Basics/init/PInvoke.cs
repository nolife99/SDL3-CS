...
public static partial class SDL
{
 ...
 ///         default. Message boxes (<see cref="ShowSimpleMessageBox"/>) also attempt to work without initializing the video
 ///         subsystem, in hopes of being useful in showing an error dialog when <see cref="Init"/> fails. You must specifically
 ...
 ///         <item>
 ///             <see cref="InitFlags.Video"/>: video subsystem; automatically initializes the events subsystem, should be
 ...
 ///         <see cref="InitSubSystem"/> to correctly shutdown a subsystem manually (or call <see cref="Quit"/> to force
 ///         shutdown). If a subsystem is already loaded then this call will increase the ref-count and return.
 ///     </para>
 ///     <para>
 ...
 ///         platforms, the main thread is the one that calls Init(WindowFlags.Video), which should usually be the one that runs
 ///         your program's main() entry point. If you are using the main callbacks, SDL_AppInit(), SDL_AppIterate(), and
 ///         SDL_AppQuit() are all called on the main thread.
 ///     </para>
 /// </summary>
 ...
 ///     <para>
 ///         If this is called on the main thread, the callback is executed immediately. If this is called on another thread,
 ///         this callback is queued for execution on the main thread during event processing.
 ///     </para>
 ///     <para>
 ...
 ///     <para>
 ///         There are several locations where SDL can make use of metadata (an "About" box in the macOS menu bar, the name of
 ///         the app can be shown on some audio mixers, etc). Any piece of metadata can be left as <c> null </c>, if a specific
 ///         detail doesn't make sense for the app.
 ///     </para>
 ///     <para>
 ///         This function should be called as early as possible, before <see cref="Init"/>. Multiple calls to this function
 ///         are allowed, but various state might not change once it has been set up with a previous call to this function.
 ///     </para>
 ...
 ///     <para> You can optionally provide metadata about your app to SDL. This is not required, but strongly encouraged. </para>
 ///     <para>
 ///         There are several locations where SDL can make use of metadata (an <c> "About" </c> box in the macOS menu bar,
 ///         the name of the app can be shown on some audio mixers, etc). Any piece of metadata can be left out, if a specific
 ///         detail doesn't make sense for the app.
 ///     </para>
 ///     <para>
 ///         This function should be called as early as possible, before <see cref="Init"/>. Multiple calls to this function
 ...
 ///             <c> "My Game 2: Bad Guy's Revenge!" </c>. This will show up anywhere the OS shows the name of the application
 ///             separately from window titles, such as volume control applets, etc. This defaults to <c> "SDL Application" </c>.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.AppMetadataVersionString"/>: The version of the app that is running; there are no rules on
 ///             format, so <c> "1.0.3beta2" </c> and <c> "April 22nd, 2024" </c> and a git hash are all valid options. This has
 ///             no default.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.AppMetadataIdentifierString"/>: A unique string that identifies this app. This must be in
 ///             reverse-domain format, like <c> "com.example.mygame2" </c>. This string is used by desktop compositors to
 ///             identify and group windows together, as well as match applications with associated desktop settings and icons.
 ///             If you plan to package your application in a container such as Flatpak, the app ID should match the name of your
 ///             Flatpak container as well. This has no default.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.AppMetadataCreatorString"/>: The human-readable name of the creator/developer/maker of this
 ///             app, like <c> "MojoWorkshop, LLC" </c>
 ///         </item>
 ///         <item>
 ///             <see cref="Props.AppMetadataCopyrightString"/>: The human-readable copyright notice, like
 ///             <c> "Copyright (c) 2024 MojoWorkshop, LLC" </c> or whatnot. Keep this to one line, don't paste a copy of a whole
 ///             software license in here. This has no default.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.AppMetadataURLString"/>: A URL to the app on the web. Maybe a product page, or a storefront,
 ...
 ///             <c> "game" </c> for a video game, <c> "mediaplayer" </c> for a media player, or generically
 ///             <c> "application" </c> if nothing else applies. Future versions of SDL might add new types. This defaults to
 ///             <c> "application" </c>.
 ///         </item>
 ///     </list>
 /// </summary>
 ...
 ///         See <see cref="SetAppMetadataProperty"/> for the list of available properties and their meanings.
 ///     </para>
 /// </summary>
