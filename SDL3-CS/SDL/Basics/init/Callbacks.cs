...
public partial class SDL
{
    ...
    ///     <para>
    ///         These are used by <see cref="EnterAppMainCallbacks"/>. This mechanism operates behind the scenes for apps using
    ///         the optional main callbacks. Apps that want to use this should just implement <see cref="AppEvent"/> directly.
    ///     </para>
    /// </summary>
    ...
    ///     <para>
    ///         These are used by <see cref="EnterAppMainCallbacks"/>. This mechanism operates behind the scenes for apps using
    ///         the optional main callbacks. Apps that want to use this should just implement <see cref="AppInit"/> directly.
    ///     </para>
    /// </summary>
    ...
    ///     <para>
    ///         TThese are used by <see cref="EnterAppMainCallbacks"/>. This mechanism operates behind the scenes for apps using
    ///         the optional main callbacks. Apps that want to use this should just implement <see cref="AppIterate"/> directly.
    ///     </para>
    /// </summary>
    ...
    /// <summary> Callback run on the main thread. </summary>
