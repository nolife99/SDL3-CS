...
public static partial class SDL
{
    ...
    ///     <para>
    ///         The blend factors are multiplied with the pixels from a drawing operation (src) and the pixels from the render
    ///         target (dst) before the blend operation. The comma-separated factors listed above are always applied in the
    ///         component order red, green, blue, and alpha.
    ///     </para>
    /// </summary>
