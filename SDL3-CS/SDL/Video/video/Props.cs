...
public static partial class SDL
{
    public static partial class Props
    {
	    ...
	    ///         prior to initialization, or <c> null </c>. See docs/README-wayland.md for more information.
	    ///     </para>
	    /// </summary>
        ...
        public const string WindowCreateWaylandSurfaceRoleCustomBoolean =
        ...
        public const string WindowCreateEmscriptenKeyboardElementString =
        ...
        public const string
            WindowWaylandXDGToplevelExportHandleString = "SDL.window.wayland.xdg_toplevel_export_handle";
