...
{
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetPixelFormatName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetPixelFormatName(PixelFormat format);
    ...
    /// <returns>
    ///     the human readable name of the specified pixel format or <see cref="PixelFormat.Unknown"/> if the format isn't
    ///     recognized.
    /// </returns>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetMasksForPixelFormat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetMasksForPixelFormat(PixelFormat format,
        ref int bpp,
        ref uint rmask,
        ref uint gmask,
        ref uint bmask,
    ...
    ///     <para> This will return <see cref="PixelFormat.Unknown"/> if the conversion wasn't possible. </para>
    /// </summary>
    /// <param name="bpp"> a bits per pixel value; usually 15, 16, or 32. </param>
    ...
    /// <returns>
    ///     the <see cref="PixelFormat"/> value corresponding to the format masks, or <see cref="PixelFormat.Unknown"/> if
    ///     there isn't a match.
    /// </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetMasksForPixelFormat"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetPixelFormatForMasks"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         Returned structure may come from a shared global cache (i.e. not newly allocated), and hence should not be
    ///         modified, especially the palette. Weird errors such as `Blit combination not supported` may occur.
    ///     </para>
    /// </summary>
    /// <param name="format"> one of the <see cref="PixelFormat"/> values. </param>
    /// <returns>
    ///     a pointer to a <see cref="PixelFormatDetails"/> structure or <c> null </c> on failure; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetPixelFormatDetails"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetPixelFormatDetails(PixelFormat format);
    ...
    /// <returns>
    ///     a new <see cref="Palette"/> structure on success or <c> null </c> on failure (e.g. if there wasn't enough memory);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreatePalette"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetPaletteColors"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetPaletteColors(nint palette,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyPalette"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     </para>
    /// </summary>
    /// <param name="format"> a pointer to <see cref="PixelFormatDetails"/> describing the pixel format. </param>
    ...
    ///     </para>
    ///     <para>
    ///         If the specified pixel format has no alpha component the alpha value will be ignored (as it will be in formats
    ///         with a palette).
    ///     </para>
    ///     <para> If the format has a palette (8-bit) the index of the closest matching color in the palette will be returned. </para>
    ///     <para>
    ...
    ///     <para>
    ///         This function uses the entire 8-bit [0..255] range when converting color components from pixel formats with less
    ///         than 8-bits per RGB component (e.g., a completely white pixel in 16-bit RGB565 format would return [0xff, 0xff,
    ...
    public static partial void GetRGB(uint pixelvalue,
        in PixelFormatDetails format,
        nint palette,
        out byte r,
        out byte g,
        out byte b);
    ...
    public static extern void GetRGB(uint pixelvalue,
        in PixelFormatDetails format,
        in Palette palette,
        out byte r,
        out byte g,
    ...
    public static partial void GetRGBA(uint pixelvalue,
        in PixelFormatDetails format,
        nint palette,
        out byte r,
        out byte g,
    ...
    public static extern void GetRGBA(uint pixelvalue,
        in PixelFormatDetails format,
        in Palette palette,
        out byte r,
        out byte g,
