...
public static partial class SDL
{
    ...
    ///     <para>
    ///         Since similar colorspaces may vary in their details (matrix, transfer function, etc.), this is not an exhaustive
    ///         list, but rather a representative sample of the kinds of colorspaces supported in SDL.
    ///     </para>
    /// </summary>
