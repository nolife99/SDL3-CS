...
public static partial class SDL
{
    ...
    public enum ChromaLocation
    {
        ...
        /// <summary>
        ///     In HEVC for BT.2020 and BT.2100 content (in particular on Blu-rays), Cb and Cr are sampled at the same location as
        ///     the group's top-left Y pixel ("co-sited", "co-located").
        /// </summary>
        TopLeft = 3
    }
}