...
public static partial class SDL
{
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumRenderDrivers"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial int GetNumRenderDrivers();

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderDriver"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetRenderDriver(int index);
    ...
    ///     <para>
    ///         The list of rendering drivers is given in the order that they are normally initialized by default; the drivers
    ///         that seem more reasonable to choose first (as far as the SDL developers believe) are earlier in the list.
    ///     </para>
    ///     <para>
    ///         The names of drivers are all simple, low-ASCII identifiers, like "opengl", "direct3d12" or "metal". These never
    ...
    /// <returns> the name of the rendering driver at the requested index, or <c> null </c> if an invalid index was specified. </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateWindowAndRenderer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool CreateWindowAndRenderer([MarshalAs(UnmanagedType.LPUTF8Str)] string title,
        int width,
        int height,
    ...
    ///     <para>
    ///         If you want a specific renderer, you can specify its name here. A list of available renderers can be obtained by
    ///         calling <see cref="GetRenderDriver"/> multiple times, with indices from 0 to <see cref="GetNumRenderDrivers"/>-1. If
    ///         you don't need a specific renderer, specify <c> null </c> and SDL will attempt to choose the best option for you,
    ///         based on what is available on the user's system.
    ///     </para>
    ///     <para>
    ///         If <c> name </c> is a comma-separated list, SDL will try each name, in the order listed, until one succeeds or
    ///         all of them fail.
    ///     </para>
    ///     <para>
    ...
    /// <param name="name"> the name of the rendering driver to initialize, or <c> null </c> to let SDL choose one. </param>
    /// <returns>
    ///     a valid rendering context or <c> null </c> if there was an error; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateRenderer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateRenderer(nint window, [MarshalAs(UnmanagedType.LPUTF8Str)] string? name);
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.RendererCreateNameString"/>: the name of the rendering driver to use, if a specific one is
    ///             desired
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateWindowPointer"/>: the window where rendering is displayed, required if this
    ///             isn't a software renderer using a surface
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateSurfacePointer"/>: the surface where rendering is displayed, if you want a
    ///             software renderer without a window
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateOutputColorspaceNumber"/>: an SDL_Colorspace value describing the colorspace
    ///             for output to the display, defaults to <see cref="Colorspace.SRGB"/>. The direct3d11, direct3d12, and metal
    ///             renderers support <see cref="Colorspace.SRGBLinear"/>, which is a linear color space and supports HDR output. If
    ///             you select <see cref="Colorspace.SRGBLinear"/>, drawing still uses the sRGB colorspace, but values can go beyond
    ///             1.0 and float (linear) format textures can be used for HDR content.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreatePresentVSyncNumber"/>: non-zero if you want present synchronized with the
    ///             refresh rate. This property can take any value that is supported by <see cref="SetRenderVSync"/> for the
    ///             renderer.
    ///         </item>
    ///     </list>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.RendererCreateGPUShadersSPIRVBoolean"/>: the app is able to provide SPIR-V shaders to
    ///             SDL_GPURenderState, optional.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateGPUShadersDXILBoolean"/>: the app is able to provide DXIL shaders to
    ///             SDL_GPURenderState, optional.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateGPUShadersMSLBoolean"/>: the app is able to provide MSL shaders to
    ///             SDL_GPURenderState, optional.
    ///         </item>
    ///     </list>
    ///     <para> With the vulkan renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.RendererCreateVulkanInstancePointer"/>: the VkInstance to use with the renderer, optional. </item>
    ///         <item> <see cref="Props.RendererCreateVulkanSurfaceNumber"/>: the VkSurfaceKHR to use with the renderer, optional. </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateVulkanPhysicalDevicePointer"/>: the VkPhysicalDevice to use with the renderer,
    ///             optional.
    ///         </item>
    ///         <item> <see cref="Props.RendererCreateVulkanDevicePointer"/>: the VkDevice to use with the renderer, optional. </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateVulkanGraphicsQueueFamilyIndexNumber"/>: the queue family index used for
    ///             rendering.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererCreateVulkanPresentQueueFamilyIndexNumber"/>: the queue family index used for
    ///             presentation.
    ///         </item>
    ///     </list>
    /// </summary>
    ...
    /// <summary>
    ///     <para> Create a 2D GPU rendering context for a window, with support for the specified shader format. </para>
    ///     <para>
    ...
    ///     </para>
    ///     <para> If no available GPU driver supports any of the specified shader formats, this function will fail. </para>
    /// </summary>
    /// <param name="window"> the window where rendering is displayed. </param>
    /// <param name="formatFlags"> a bitflag indicating which shader formats the app is able to provide. </param>
    /// <param name="device"> a pointer filled with the associated GPU device, or NULL on error. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPURenderer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPURenderer(nint window, GPUShaderFormat formatFlags, out nint device);
    ...
    ///     <para>
    ///         Two other API which can be used to create SDL_Renderer: <see cref="CreateRenderer"/> and
    ///         <see cref="CreateWindowAndRenderer"/>. These can _also_ create a software renderer, but they are intended to be used
    ///         with an SDL_Window as the final destination and not an <see cref="Surface"/>.
    ///     </para>
    /// </summary>
    ...
    /// <returns> the rendering context on success or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <returns> the window on success or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderWindow"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetRenderWindow(nint renderer);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRendererName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetRendererName(nint renderer);
    ...
    /// <returns> the name of the selected renderer, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateRenderer"/>
    /// <seealso cref="CreateRendererWithProperties"/>
    ...
    ///         <item> <see cref="Props.RendererWindowPointer"/>: the window where rendering is displayed, if any </item>
    ///         <item>
    ///             <see cref="Props.RendererSurfacePointer"/>: the surface where rendering is displayed, if this is a software
    ///             renderer without a window
    ///         </item>
    ///         <item> <see cref="Props.RendererVSyncNumber"/>: the current vsync setting </item>
    ///         <item> <see cref="Props.RendererMaxTextureSizeNumber"/>: the maximum texture width and height </item>
    ///         <item>
    ///             <see cref="Props.RendererTextureFormatsPointer"/>: a (const SDL_PixelFormat *) array of pixel formats,
    ///             terminated with <see cref="PixelFormat.Unknown"/>, representing the available texture formats for this renderer.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererOutputColorspaceNumber"/>: an SDL_Colorspace value describing the colorspace for
    ///             output to the display, defaults to <see cref="Colorspace.SRGB"/>.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererHDREnabledBoolean"/>: true if the output colorspace is
    ///             <see cref="Colorspace.SRGBLinear"/> and the renderer is showing on a display with HDR enabled. This property can
    ///             change dynamically when <see cref="EventType.WindowHDRStateChanged"/> is sent.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererSDRWhitePointFloat"/>: the value of SDR white in the
    ///             <see cref="Colorspace.SRGBLinear"/> colorspace. When HDR is enabled, this value is automatically multiplied into
    ///             the color scale. This property can change dynamically when <see cref="EventType.WindowHDRStateChanged"/> is
    ///             sent.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.RendererHDRHeadroomFloat"/>: the additional high dynamic range that can be displayed, in
    ///             terms of the SDR white point. When HDR is not enabled, this will be 1.0. This property can change dynamically
    ///             when <see cref="EventType.WindowHDRStateChanged"/> is sent.
    ///         </item>
    ///     </list>
    ///     <para> With the direct3d renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.RendererD3D9DevicePointer"/>: the IDirect3DDevice9 associated with the renderer </item>
    ///     </list>
    ///     <para> With the direct3d11 renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.RendererD3D11DevicePointer"/>: the ID3D11Device associated with the renderer </item>
    ///         <item>
    ///             <see cref="Props.RendererD3D11SwapchainPointer"/>: the IDXGISwapChain1 associated with the renderer. This may
    ///             change when the window is resized.
    ///         </item>
    ///     </list>
    ///     <para> With the direct3d12 renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.RendererD3D12DevicePointer"/>: the ID3D12Device associated with the renderer </item>
    ///         <item> <see cref="Props.RendererD3D12SwapchainPointer"/>: the IDXGISwapChain4 associated with the renderer. </item>
    ///         <item> <see cref="Props.RendererD3D12CommandQueuePointer"/>: the ID3D12CommandQueue associated with the renderer </item>
    ///     </list>
    ///     <para> With the vulkan renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.RendererVulkanInstancePointer"/>: the VkInstance associated with the renderer </item>
    ///         <item> <see cref="Props.RendererVulkanSurfaceNumber"/>: the VkSurfaceKHR associated with the renderer </item>
    ///         <item> <see cref="Props.RendererVulkanPhysicalDevicePointer"/>: the VkPhysicalDevice associated with the renderer </item>
    ///         <item> <see cref="Props.RendererVulkanDevicePointer"/>: the VkDevice associated with the renderer </item>
    ///         <item> <see cref="Props.RendererVulkanGraphicsQueueFamilyIndexNumber"/>: the queue family index used for rendering </item>
    ///         <item> <see cref="Props.RendererVulkanPresentQueueFamilyIndexNumber"/>: the queue family index used for presentation </item>
    ///         <item>
    ///             <see cref="Props.RendererVulkanSwapchainImageCountNumber"/>: the number of swapchain images, or potential
    ///             frames in flight, used by the Vulkan renderer
    ///         </item>
    ///         <para> With the gpu renderer: </para>
    ///         <list type="bullet">
    ///             <item> <see cref="Props.RendererGPUDevicePointer"/>: the SDL_GPUDevice associated with the renderer </item>
    ///         </list>
    ///     </list>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    ///     <para>
    ///         For the output size of the current rendering target, with logical size adjustments, use
    ///         <see cref="GetCurrentRenderOutputSize"/> instead.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderOutputSize"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetRenderOutputSize(nint renderer, out int w, out int h);
    ...
    ///     <para>
    ///         If a rendering target is active, this will return the size of the rendering target in pixels, otherwise return
    ///         the value of <see cref="GetRenderOutputSize"/>.
    ///     </para>
    ///     <para>
    ///         Rendering target or not, the output will be adjusted by the current logical presentation state, dictated by
    ///         <see cref="SetRenderLogicalPresentation"/>.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetCurrentRenderOutputSize"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetCurrentRenderOutputSize(nint renderer, out int w, out int h);
    ...
    /// <returns> the created texture or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para> The <see cref="TextureAccess"/> hint for the created texture is <see cref="TextureAccess.Static"/>. </para>
    ///     <para>
    ///         The pixel format of the created texture may be different from the pixel format of the surface, and can be queried
    ///         using the <see cref="Props.TextureFormatNumber"/> property.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    /// <seealso cref="CreateTextureWithProperties"/>
    /// <seealso cref="DestroyTexture"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateTextureFromSurface"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateColorspaceNumber"/>: an <see cref="Colorspace"/> value describing the texture
    ///             colorspace, defaults to <see cref="Colorspace.SRGBLinear"/> for floating point textures,
    ///             <see cref="Colorspace.HDR10"/> for 10-bit textures, <see cref="Colorspace.SRGB"/> for other RGB textures and
    ///             <see cref="Colorspace.JPEG"/> for YUV textures.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateFormatNumber"/>: one of the enumerated values in <see cref="PixelFormat"/>,
    ///             defaults to the best RGBA format for the renderer
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateAccessNumber"/>: one of the enumerated values in <see cref="TextureAccess"/>,
    ///             defaults to <see cref="TextureAccess.Static"/>
    ///         </item>
    ///         <item> <see cref="Props.TextureCreateWidthNumber"/>: the width of the texture in pixels, required </item>
    ///         <item> <see cref="Props.TextureCreateHeightNumber"/>: the height of the texture in pixels, required </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateSDRWhitePointFloat"/>: for HDR10 and floating point textures, this defines the
    ///             value of 100% diffuse white, with higher values being displayed in the High Dynamic Range headroom. This
    ///             defaults to 100 for HDR10 textures and 1.0 for floating point textures.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateHDRHeadroomFloat"/>: for HDR10 and floating point textures, this defines the
    ///             maximum dynamic range used by the content, in terms of the SDR white point. This would be equivalent to maxCLL /
    ///             <see cref="Props.TextureCreateSDRWhitePointFloat"/> for HDR10 content. If this is defined, any values outside
    ///             the range supported by the display will be scaled into the available HDR headroom, otherwise they are clipped.
    ///         </item>
    ///     </list>
    ///     <para> With the direct3d11 renderer: </para>
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateD3D11TexturePointer"/>: the ID3D11Texture2D associated with the texture, if you
    ///             want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateD3D11TextureUPointer"/>: the ID3D11Texture2D associated with the U plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateD3D11TextureVPointer"/>: the ID3D11Texture2D associated with the V plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///     </list>
    ///     <para> With the direct3d12 renderer: </para>
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateD3D12TexturePointer"/>: the ID3D12Resource associated with the texture, if you
    ///             want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateD3D12TextureUPointer"/>: the ID3D12Resource associated with the U plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateD3D12TextureVPointer"/>: the ID3D12Resource associated with the V plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///     </list>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateMetalPixelbufferPointer"/>: the CVPixelBufferRef associated with the texture,
    ///             if you want to create a texture from an existing pixel buffer.
    ///         </item>
    ///     </list>
    ///     <para> With the opengl renderer: </para>
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLTextureNumber"/> the GLuint texture associated with the texture, if you
    ///             want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLTextureUVNumber"/>: the GLuint texture associated with the UV plane of an
    ///             NV12 texture, if you want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGlTextureUNumber"/>: the GLuint texture associated with the U plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLTextureVNumber"/>: the GLuint texture associated with the V plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///     </list>
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLES2TextureNumber"/>: the GLuint texture associated with the texture, if
    ...
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLES2TextureUVNumber"/>: the GLuint texture associated with the UV plane of
    ///             an NV12 texture, if you want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLES2TextureUNumber"/>: the GLuint texture associated with the U plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureCreateOpenGLES2TextureVNumber"/>: the GLuint texture associated with the V plane of a
    ///             YUV texture, if you want to wrap an existing texture.
    ///         </item>
    ///     </list>
    ///     <para> With the vulkan renderer: </para>
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextureCreateVulkanTextureNumber"/>: the VkImage with layout
    ///             VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL associated with the texture, if you want to wrap an existing texture.
    ///         </item>
    ///     </list>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    ///     <para> The following read-only properties are provided by SDL: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.TextureColorspaceNumber"/>: an SDL_Colorspace value describing the texture colorspace. </item>
    ///         <item> <see cref="Props.TextureFormatNumber"/>: one of the enumerated values in <see cref="PixelFormat"/>. </item>
    ///         <item> <see cref="Props.TextureAccessNumber"/>: one of the enumerated values in <see cref="TextureAccess"/>. </item>
    ...
    ///         <item>
    ///             <see cref="Props.TextureSDRWhitePointFloat"/>: for HDR10 and floating point textures, this defines the value
    ///             of 100% diffuse white, with higher values being displayed in the High Dynamic Range headroom. This defaults to
    ///             100 for HDR10 textures and 1.0 for other textures.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureHDRHeadroomFloat"/>: for HDR10 and floating point textures, this defines the maximum
    ///             dynamic range used by the content, in terms of the SDR white point. If this is defined, any values outside the
    ///             range supported by the display will be scaled into the available HDR headroom, otherwise they are clipped. This
    ///             defaults to 1.0 for SDR textures, 4.0 for HDR10 textures, and no default for floating point textures.
    ///         </item>
    ///     </list>
    ///     <para> With the direct3d11 renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.TextureD3D11TexturePointer"/>: the ID3D11Texture2D associated with the texture </item>
    ///         <item>
    ///             <see cref="Props.TextureD3D11TextureUPointer"/>: the ID3D11Texture2D associated with the U plane of a YUV
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureD3D11TextureVPointer"/>: the ID3D11Texture2D associated with the V plane of a YUV
    ///             texture
    ///         </item>
    ///     </list>
    ///     <para> With the direct3d12 renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.TextureD3D12TexturePointer"/>: the ID3D12Resource associated with the texture </item>
    ///         <item>
    ///             <see cref="Props.TextureD3D12TextureUPointer"/>: the ID3D12Resource associated with the U plane of a YUV
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureD3D12TextureVPointer"/>: the ID3D12Resource associated with the V plane of a YUV
    ///             texture
    ///         </item>
    ///     </list>
    ///     <para> With the vulkan renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.TextureVulkanTextureNumber"/>: the VkImage associated with the texture </item>
    ///     </list>
    ///     <para> With the opengl renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.TextureOpenGLTextureNumber"/>: the GLuint texture associated with the texture </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLTextureUVNumber"/>: the GLuint texture associated with the UV plane of an NV12
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLTextureUNumber"/>: the GLuint texture associated with the U plane of a YUV
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLTextureVNumber"/>: the GLuint texture associated with the V plane of a YUV
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLTextureTargetNumber"/>: the GLenum for the texture target (`GL_TEXTURE_2D`,
    ///             `GL_TEXTURE_RECTANGLE_ARB`, etc)
    ///         </item>
    ///         <item> <see cref="Props.TextureOpenGLTexWFloat"/>: the texture coordinate width of the texture (0.0 - 1.0) </item>
    ///         <item> <see cref="Props.TextureOpenGLTexHFloat"/>: the texture coordinate height of the texture (0.0 - 1.0) </item>
    ///     </list>
    ///     <para> With the opengles2 renderer: </para>
    ///     <list type="bullet">
    ///         <item> <see cref="Props.TextureOpenGLES2TextureNumber"/>: the GLuint texture associated with the texture </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLES2TextureUVNumber"/>: the GLuint texture associated with the UV plane of an
    ///             NV12 texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLES2TextureUNumber"/>: the GLuint texture associated with the U plane of a YUV
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLES2TextureVNumber"/>: the GLuint texture associated with the V plane of a YUV
    ///             texture
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextureOpenGLES2TextureTargetNumber"/>: the GLenum for the texture target (`GL_TEXTURE_2D`,
    ...
    /// <param name="texture"> the texture to query. </param>
    /// <returns>
    ///     a pointer to the SDL_Renderer that created the texture, or <c> null </c> on failure; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRendererFromTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="texture"> the texture to query. </param>
    /// <param name="w">
    ///     a pointer filled in with the width of the texture in pixels. This argument can be <c> null </c> if you
    ///     don't need this information.
    /// </param>
    /// <param name="h">
    ///     a pointer filled in with the height of the texture in pixels. This argument can be <c> null </c> if you
    ///     don't need this information.
    /// </param>
    /// <returns> true on success or false on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureSize"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextureColorMod"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextureColorModFloat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextureColorModFloat(nint texture, float r, float g, float b);
    ...
    /// <seealso cref="GetTextureColorModFloat"/>
    /// <seealso cref="SetTextureColorMod"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureColorMod"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <seealso cref="GetTextureColorMod"/>
    /// <seealso cref="SetTextureColorModFloat"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureColorModFloat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTextureColorModFloat(nint texture, out float r, out float g, out float b);
    ...
    ///     <para>
    ///         When this texture is rendered, during the copy operation the source alpha value is modulated by this alpha value
    ...
    /// <seealso cref="SetTextureAlphaModFloat"/>
    /// <seealso cref="SetTextureColorMod"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextureAlphaMod"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextureAlphaMod(nint texture, byte alpha);
    ...
    /// <seealso cref="SetTextureAlphaMod"/>
    /// <seealso cref="SetTextureColorModFloat"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextureAlphaModFloat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextureAlphaModFloat(nint texture, float alpha);
    ...
    /// <seealso cref="GetTextureColorMod"/>
    /// <seealso cref="SetTextureAlphaMod"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureAlphaMod"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTextureAlphaMod(nint texture, out byte alpha);
    ...
    /// <seealso cref="GetTextureColorModFloat"/>
    /// <seealso cref="SetTextureAlphaModFloat"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureAlphaModFloat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTextureAlphaModFloat(nint texture, out float alpha);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextureBlendMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextureBlendMode(nint texture, BlendMode blendMode);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureBlendMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTextureBlendMode(nint texture, out BlendMode blendMode);
    ...
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <seealso cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetTextureScaleMode"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextureScaleMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextureScaleMode(nint texture, ScaleMode scaleMode);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextureScaleMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTextureScaleMode(nint texture, out ScaleMode scaleMode);
    ...
    ///     <para>
    ///         You can use <see cref="UpdateTexture(IntPtr, IntPtr, IntPtr, int)"/> as long as your pixel data is a contiguous
    ///         block of NV12/21 planes in the proper order, but this function is available if your pixel data is not contiguous.
    ///     </para>
    /// </summary>
    /// <param name="texture"> the texture to update. </param>
    /// <param name="rect"> a pointer to the rectangle of pixels to update, or <c> null </c> to update the entire texture. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateNVTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool UpdateNVTexture(nint texture,
        nint rect,
        nint yplane,
        int ypitch,
        nint uvplane,
    ...
    ///     <para>
    ///         As an optimization, the pixels made available for editing don't necessarily contain the old texture data. This is
    ///         a write-only operation, and if you need to keep a copy of the texture data you should do that at the application
    ///         level.
    ///     </para>
    ///     <para> You must use <see cref="UnlockTexture"/> to unlock the pixels and apply any changes. </para>
    /// </summary>
    /// <param name="texture"> the texture to lock for access, which was created with <see cref="TextureAccess.Streaming"/>. </param>
    /// <param name="rect">
    ///     an <see cref="Rect"/> structure representing the area to lock for access; <c> null </c> to lock the
    ///     entire texture.
    /// </param>
    ...
    /// <returns>
    ///     true on success or false if the texture is not valid or was not created with <see cref="TextureAccess.Streaming"/>
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool LockTexture(nint texture, nint rect, out nint pixels, out int pitch);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_LockTexture"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool LockTexture(nint texture, in Rect rect, out nint pixels, out int pitch);
    ...
    /// <summary>
    ///     <para> Lock a portion of the texture for <b> write-only </b> pixel access, and expose it as a SDL surface. </para>
    ///     <para>
    ///         Besides providing an <see cref="Surface"/> instead of raw pixel data, this function operates like
    ///         <see cref="LockTexture(nint, nint, out nint, out int)"/>.
    ///     </para>
    ///     <para>
    ///         As an optimization, the pixels made available for editing don't necessarily contain the old texture data. This is
    ///         a write-only operation, and if you need to keep a copy of the texture data you should do that at the application
    ...
    ///     <para> You must use <see cref="UnlockTexture"/> to unlock the pixels and apply any changes. </para>
    ///     <para>
    ///         The returned surface is freed internally after calling <see cref="UnlockTexture"/> or
    ///         <see cref="DestroyTexture"/>. The caller should not free it.
    ///     </para>
    /// </summary>
    /// <param name="texture"> the texture to lock for access, which must be created with <see cref="TextureAccess.Streaming"/>. </param>
    /// <param name="rect">
    ///     a pointer to the rectangle to lock for access. If the rect is <c> null </c>, the entire texture will be
    ///     locked.
    /// </param>
    /// <param name="surface"> a pointer to an SDL surface of size <b> rect </b>. Don't assume any specific pixel content. </param>
    /// <returns> true on success or false on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    ///     <para>
    ///         <b> Warning </b>: Please note that <see cref="LockTexture(nint, nint, out nint, out int)"/> is intended to be
    ///         write-only; it will not guarantee the previous contents of the texture will be provided. You must fully initialize
    ///         any area of a texture that you lock before unlocking it, as the pixels might otherwise be uninitialized memory.
    ///     </para>
    ///     <para>
    ///         Which is to say: locking and immediately unlocking a texture can result in corrupted textures, depending on the
    ///         renderer in use.
    ///     </para>
    /// </summary>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="LockTexture(nint, nint, out nint, out int)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UnlockTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         The default render target is the window for which the renderer was created. To stop rendering to a texture and
    ///         render to the window again, call this function with a <c> null </c> <c> texture </c>.
    ///     </para>
    ///     <para>
    ///         Viewport, cliprect, scale, and logical presentation are unique to each render target. Get and set functions for
    ///         these states apply to the current render target set by this function, and those states persist on each target when
    ///         the current render target changes.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="texture">
    ///     the targeted texture, which must be created with the <see cref="TextureAccess.Target"/> flag, or
    ///     <c> null </c> to render to the window instead of a texture.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetRenderTarget"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderTarget"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para> The default render target is the window for which the renderer was created, and is reported a <c> null </c> here. </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderTarget"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         This function sets the width and height of the logical rendering output. The renderer will act as if the current
    ///         render target is always the requested dimensions, scaling to the actual resolution as necessary.
    ///     </para>
    ///     <para>
    ...
    ///     </para>
    ///     <para>
    ///         Logical presentation can be used with both render target textures and the renderer's window; the state is unique
    ///         to each render target, and this function sets the state for the current render target. It might be useful to draw to
    ///         a texture that matches the window dimensions with logical presentation enabled, and then draw that texture across
    ///         the entire window with logical presentation disabled. Be careful not to render both with logical presentation
    ///         enabled, however, as this could produce double-letterboxing, etc.
    ///     </para>
    ///     <para>
    ///         You can disable logical coordinates by setting the mode to <see cref="RendererLogicalPresentation.Disabled"/>,
    ///         and in that case you get the full pixel resolution of the render target; it is safe to toggle logical presentation
    ///         during the rendering of a frame: perhaps most of the rendering is done to specific dimensions but to make fonts look
    ///         sharp, the app turns off logical presentation while drawing text, for example.
    ///     </para>
    ///     <para>
    ///         For the renderer's window, letterboxing is drawn into the framebuffer if logical presentation is enabled during
    ///         SDL_RenderPresent; be sure to reenable it before presenting if you were toggling it, otherwise the letterbox areas
    ///         might have artifacts from previous frames (or artifacts from external overlays, etc). Letterboxing is never drawn
    ///         into texture render targets; be sure to call <see cref="RenderClear"/> before drawing into the texture so the
    ///         letterboxing areas are cleared, if appropriate.
    ///     </para>
    ///     <para>
    ///         You can convert coordinates in an event into rendering coordinates using
    ///         <see cref="ConvertEventToRenderCoordinates"/>.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderLogicalPresentation"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderLogicalPresentation(nint renderer,
        int w,
        int h,
    ...
    ///     <para>
    ///         This function gets the width and height of the logical rendering output, or the output size in pixels if a
    ///         logical resolution is not enabled.
    ///     </para>
    ///     <para>
    ///         Each render target has its own logical presentation state. This function gets the state for the current render
    ///         target.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderLogicalPresentation"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetRenderLogicalPresentation(nint renderer,
        out int w,
        out int h,
    ...
    ///     <para>
    ///         This function returns the calculated rectangle used for logical presentation, based on the presentation mode and
    ///         output size. If logical presentation is disabled, it will fill the rectangle with the output size, in pixels.
    ///     </para>
    ///     <para>
    ///         Each render target has its own logical presentation state. This function gets the rectangle for the current
    ///         render target.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="rect"> a pointer filled in with the final presentation rectangle, may be <c> null </c>. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SetRenderLogicalPresentation"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderLogicalPresentationRect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderCoordinatesFromWindow"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderCoordinatesFromWindow(nint renderer,
        float windowx,
        float windowy,
        out float x,
        out float y);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderCoordinatesToWindow"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderCoordinatesToWindow(nint renderer,
        float x,
        float y,
        out float windowx,
        out float windowy);
    ...
    ///         fields converted should use <see cref="RenderCoordinatesFromWindow"/> on the specific event fields instead of
    ...
    [DllImport(SDLLibrary, EntryPoint = "SDL_ConvertEventToRenderCoordinates"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool ConvertEventToRenderCoordinates(nint renderer, ref Event @event);
    ...
    ///         <see cref="SetRenderClipRect(nint, in Rect)"/>), and the top left of the area will become coordinate (0, 0) for
    ///         future drawing commands.
    ///     </para>
    ...
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="rect">
    ///     the <see cref="Rect"/> structure representing the drawing area, or <c> null </c> to set the viewport to
    ///     the entire target.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderViewport"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderViewport"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderViewport(nint renderer, Rect rect);
    ...
    /// <seealso cref="RenderViewportSet"/>
    /// <seealso cref="SetRenderViewport(nint, nint)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderViewport"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para>
    ///         This is useful if you're saving and restoring the viewport and want to know whether you should restore a specific
    ///         rectangle or NULL.
    ///     </para>
    ///     <para> Each render target has its own viewport. This function checks the viewport for the current render target. </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <returns> true if the viewport was set to a specific rectangle, or false if it was set to <c> null </c> (the entire target). </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetRenderViewport"/>
    /// <seealso cref="SetRenderViewport(nint, nint)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderViewportSet"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para>
    ///         Some devices have portions of the screen which are partially obscured or not interactive, possibly due to
    ///         on-screen controls, curved edges, camera notches, TV overscan, etc. This function provides the area of the current
    ///         viewport which is safe to have interactible content. You should continue rendering into the rest of the render
    ///         target, but it should not contain visually important or interactible content.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderSafeArea"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="rect">
    ///     an <see cref="Rect"/> structure representing the clip area, relative to the viewport, or <c> null </c>
    ///     to disable clipping.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderClipRect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderClipRect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderClipRect(nint renderer, in Rect rect);
    ...
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="rect">
    ///     an <see cref="Rect"/> structure filled in with the current clipping area or an empty rectangle if
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderClipRect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <returns> <c> true </c> if clipping is enabled or <c> false </c> if not; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetRenderClipRect"/>
    /// <seealso cref="SetRenderClipRect(nint, in Rect)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderClipEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderScale"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SetRenderScale"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderScale"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para> Set the color for drawing or filling rectangles, lines, and points, and for <see cref="RenderClear"/>. </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    /// <param name="a">
    ///     the alpha value used to draw on the rendering target; usually <see cref="AlphaOpaque"/> (255). Use
    ///     <see cref="SetRenderDrawBlendMode"/> to specify how the alpha channel is used.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderDrawColor"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <param name="b"> the blue value used to draw on the rendering target. </param>
    /// <param name="a">
    ///     the alpha value used to draw on the rendering target. Use <see cref="SetRenderDrawBlendMode"/> to specify
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderDrawColorFloat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderDrawColorFloat(nint renderer, float r, float g, float b, float a);
    ...
    /// <seealso cref="GetRenderDrawColorFloat"/>
    /// <seealso cref="SetRenderDrawColor"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderDrawColor"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <seealso cref="SetRenderDrawColorFloat"/>
    /// <seealso cref="GetRenderDrawColor"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderDrawColorFloat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetRenderDrawColorFloat(nint renderer,
        out float r,
        out float g,
        out float b,
        out float a);
    ...
    ///     <para>
    ///         The color scale is an additional scale multiplied into the pixel color value while rendering. This can be used to
    ///         adjust the brightness of colors during HDR rendering, or changing HDR video brightness when playing on an SDR
    ///         display.
    ///     </para>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderColorScale"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderColorScale(nint renderer, float scale);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderColorScale"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetRenderColorScale(nint renderer, out float scale);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderDrawBlendMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderDrawBlendMode(nint renderer, BlendMode blendMode);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderDrawBlendMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetRenderDrawBlendMode(nint renderer, out BlendMode blendMode);
    ...
    ///     <para>
    ///         This function clears the entire rendering target, ignoring the viewport and the clip rectangle. Note, that
    ///         clearing will also set/fill all pixels of the rendering target to current renderer draw color, so make sure to
    ///         invoke <see cref="SetRenderDrawColor"/> when needed.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderPoints(nint renderer, FPoint[] points, int count);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderLines(nint renderer, FPoint[] points, int count);
    ...
    /// <param name="rect"> a pointer to the destination rectangle, or <c> null </c> to outline the entire rendering target. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderRect(nint renderer, nint rect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderRect"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderRect(nint renderer, in FRect rect);
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderRects(nint renderer, FRect[] rects, int count);
    ...
    /// <param name="rect"> a pointer to the destination rectangle, or <c> null </c> for the entire rendering target. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="RenderFillRects"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderFillRect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderFillRect(nint renderer, nint rect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderFillRect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderFillRect(nint renderer, in FRect rect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderFillRects"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderFillRects(nint renderer, FRect[] rect, int count);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderReadPixels"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_RenderReadPixels(nint renderer, nint rect);
    ...
    ///         with <see cref="DestroySurface"/>.
    ///     </para>
    ///     <para>
    ///         Note that this returns the actual pixels on the screen, so if you are using logical presentation you should use
    ///         <see cref="GetRenderLogicalPresentationRect"/> to get the area containing your content.
    ///     </para>
    ///     <para>
    ///         <b> WARNING </b>: This is a very slow operation, and should not be used frequently. If you're using this on the
    ///         main rendering target, it should be called after rendering and before <see cref="RenderPresent"/>.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="rect">
    ///     an <see cref="Rect"/> structure representing the area to read, which will be clipped to the current
    ///     viewport, or <c> null </c> for the entire viewport.
    /// </param>
    /// <returns>
    ///     a new <see cref="Surface"/> on success or <c> null </c> on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    public static nint RenderReadPixels(nint renderer, Rect? rect)
    {
        var rectPtr = nint.Zero;
        ...
        {
            if (rectPtr != nint.Zero) Marshal.FreeHGlobal(rectPtr);
        }
    }
    ...
    ///         <see cref="RenderLine"/> does not directly put a line on the screen, but rather updates the backbuffer. As such, you
    ///         compose your entire scene and <b> present </b> the composed backbuffer to the screen as a complete picture.
    ///     </para>
    ///     <para>
    ...
    ///     </para>
    ///     <para>
    ///         The backbuffer should be considered invalidated after each present; do not assume that previous contents will
    ///         exist between frames. You are strongly encouraged to call <see cref="RenderClear"/> to initialize the backbuffer
    ///         before starting each new frame's drawing, even if you plan to overwrite every pixel.
    ///     </para>
    ///     <para>
    ///         Please note, that in case of rendering to a texture - there is **no need** to call <see cref="RenderPresent"/>
    ///         after drawing needed objects to a texture, and should not be done; you are only required to change back the
    ///         rendering target to default via <c> SetRenderTarget(renderer, null) </c> afterwards, as textures by themselves do
    ///         not have a concept of backbuffers. Calling <see cref="RenderPresent"/> while rendering to a texture will still
    ///         update the screen with any current drawing that has been done _to the window itself_.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderPresent"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para> Passing <c> null </c> or an otherwise invalid texture will set the SDL error message to "Invalid texture". </para>
    /// </summary>
    ...
    /// <seealso cref="CreateTexture"/>
    /// <seealso cref="CreateTextureFromSurface"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateRenderer"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyRenderer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     </para>
    ///     <para>
    ///         This is for a very-specific case: if you are using SDL's render API, and you plan to make OpenGL/D3D/whatever
    ///         calls in addition to SDL render API calls. If this applies, you should call this function between calls to SDL's
    ///         render API and the low-level API you're using in cooperation.
    ///     </para>
    ///     <para> In all other cases, you can ignore this function. </para>
    ///     <para>
    ///         This call makes SDL flush any pending rendering work it was queueing up to do later in a single batch, and marks
    ///         any internal cached state as invalid, so it'll prepare all its state again later, from scratch.
    ///     </para>
    ///     <para>
    ///         This means you do not need to save state in your rendering code to protect the SDL renderer. However, there lots
    ///         of arbitrary pieces of Direct3D and OpenGL state that can confuse things; you should use your best judgment and be
    ///         prepared to make changes if specific state needs to be protected.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_FlushRenderer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para>
    ///         This function returns <c> void * </c>, so SDL doesn't have to include Metal's headers, but it can be safely cast
    ///         to a <c> CAMetalLayer * </c>.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the renderer to query. </param>
    /// <returns> a <c> CAMetalLayer * </c> on success, or <c> null </c> if the renderer isn't a Metal renderer. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetRenderMetalCommandEncoder"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderMetalLayer"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         This function returns <c> void * </c>, so SDL doesn't have to include Metal's headers, but it can be safely cast
    ///         to an <c> id&lt;MTLRenderCommandEncoder&gt; </c>.
    ///     </para>
    ///     <para>
    ///         This will return <c> null </c> if Metal refuses to give SDL a drawable to render to, which might happen if the
    ///         window is hidden/minimized/offscreen. This doesn't apply to command encoders for render targets, just the window's
    ///         backbuffer. Check your return values!
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the renderer to query. </param>
    /// <returns>
    ///     an <c> id&lt;MTLRenderCommandEncoder&gt; </c> on success, or <c> null </c> if the renderer isn't a Metal renderer
    ///     or there was an error.
    /// </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetRenderMetalLayer"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderMetalCommandEncoder"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         The Vulkan renderer will wait for <c> waitSemaphore </c> before submitting rendering commands and signal
    ///         <c> signalSemaphore </c> after rendering commands are complete for this frame.
    ///     </para>
    ///     <para>
    ///         This should be called each frame that you want semaphore synchronization. The Vulkan renderer may have multiple
    ///         frames in flight on the GPU, so you should have multiple semaphores that are used for synchronization. Querying
    ///         <see cref="Props.RendererVulkanSwapchainImageCountNumber"/> will give you the maximum number of semaphores you'll
    ///         need.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    ///     a VkSempahore that SDL will signal when rendering for the current frame is complete, or 0 if
    ///     not needed.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> It is <b> NOT </b> safe to call this function from two threads at once. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_AddVulkanRenderSemaphores"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool AddVulkanRenderSemaphores(nint renderer,
        uint waitStageMasl,
        long waitSemaphore,
    ...
    ///     <para>
    ///         The `vsync` parameter can be 1 to synchronize present with every vertical refresh, 2 to synchronize present with
    ///         every second vertical refresh, etc., <see cref="RendererVSyncAdaptive"/> for late swap tearing (adaptive vsync), or
    ///         <see cref="RendererVSyncDisabled"/> to disable. Not every value is supported by every driver, so you should check
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderVSync"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <param name="renderer"> the renderer to toggle. </param>
    /// <param name="vsync">
    ///     an int filled with the current vertical refresh sync interval. See <see cref="SetRenderVSync"/> for the
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderVSync"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para>
    ///         This function will render a string of text to an SDL_Renderer. Note that this is a convenience function for
    ...
    ///         <item>
    ///             It has a single, tiny size (8x8 pixels). One can use logical presentation or scaling to adjust it, but it
    ///             will be blurry.
    ///         </item>
    ///         <item>
    ///             It uses a simple, hardcoded bitmap font. It does not allow different font selections and it does not support
    ///             truetype, for proper scaling.
    ///         </item>
    ///         <item>
    ///             It does no word-wrapping and does not treat newline characters as a line break. If the text goes out of the
    ///             window, it's gone.
    ///         </item>
    ///     </list>
    ///     <para>
    ///         For serious text rendering, there are several good options, such as SDL_ttf, stb_truetype, or other external
    ///         libraries.
    ///     </para>
    ///     <para>
    ///         On first use, this will create an internal texture for rendering glyphs. This texture will live until the
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderDebugText"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderDebugText(nint renderer,
        float x,
        float y,
    ...
    ///     <para> Draw debug text to an SDL_Renderer. </para>
    ///     <para>
    ///         This function will render a printf()-style format string to a renderer. Note that this is a convinence function
    ///         for debugging, with severe limitations, and is not intended to be used for production apps and games.
    ///     </para>
    ///     <para> For the full list of limitations and other useful information, see <see cref="RenderDebugText"/>. </para>
    /// </summary>
    ...
    /// <seealso cref="DebugTextFontCharacterSize"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderDebugTextFormat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderDebugTextFormat(nint renderer,
        float x,
        float y,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetDefaultTextureScaleMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetDefaultTextureScaleMode(nint renderer, ScaleMode scaleMode);

    /// <code>extern SDL_DECLSPEC bool SDLCALL SDL_GetDefaultTextureScaleMode(SDL_Renderer *renderer, SDL_ScaleMode *scale_mode);</code>
    /// <summary> Get default texture scale mode of the given renderer. </summary>
    /// <param name="renderer"> the renderer to get data from. </param>
    /// <param name="scaleMode">
    ///     a <see cref="ScaleMode"/> filled with current default scale mode. See
    ///     <see cref="SetDefaultTextureScaleMode"/> for the meaning of the value.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.4.0. </since>
    /// <seealso cref="SetDefaultTextureScaleMode"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetDefaultTextureScaleMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetDefaultTextureScaleMode(nint renderer, out ScaleMode scaleMode);
    ...
    /// <param name="desc"> GPU render state description, initialized using SDL_INIT_INTERFACE(). </param>
    /// <returns> a custom GPU render state or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateGPURenderState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPURenderState(nint renderer, nint desc);
    ...
    ///     <para>
    ///         The data is copied and will be pushed using <see cref="PushGPUFragmentUniformData(nint, uint, byte[], uint)"/>
    ...
    /// <threadsafety> This function should be called on the thread that created the renderer. </threadsafety>
    /// <since> This function is available since SDL 3.4.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGPURenderStateFragmentUniforms"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetGPURenderStateFragmentUniforms(nint state, uint slotIndex, nint data, uint length);
    ...
    ///     <para>
    ///         This function sets custom GPU render state for subsequent draw calls. This allows using custom shaders with the
    ///         GPU renderer.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the renderer to use. </param>
    ...
    /// <threadsafety> This function should be called on the thread that created the renderer. </threadsafety>
    /// <since> This function is available since SDL 3.4.0. </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderGPUState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderGPUState(nint renderer, nint state);
    ...
    /// <threadsafety> This function should be called on the thread that created the renderer. </threadsafety>
    /// <since> This function is available since SDL 3.4.0. </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyGPURenderState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///         <see cref="Props.TextureFormatNumber"/> property.
    ///     </para>
    ///     <para> This is a fairly slow function, intended for use with static textures that do not change often. </para>
    ///     <para>
    ///         If the texture is intended to be updated often, it is preferred to create the texture as streaming and use the
    ///         locking functions referenced below. While this function will work with streaming textures, for optimization reasons
    ///         you may not get the pixels back if you lock the texture afterward.
    ///     </para>
    /// </summary>
    /// <param name="texture"> the texture to update. </param>
    /// <param name="rect">
    ///     an <see cref="Rect"/> structure representing the area to update, or <c> null </c> to update the entire
    ///     texture.
    /// </param>
    ...
    /// <seealso cref="UpdateYUVTexture(IntPtr, IntPtr, IntPtr, int, IntPtr, int, IntPtr, int)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool UpdateTexture(nint texture, nint rect, nint pixels, int pitch);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool UpdateTexture(nint texture,
        nint rect,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] pixels,
        int pitch);
    ...
    /// <seealso cref="UpdateNVTexture(IntPtr, IntPtr, IntPtr, int, IntPtr, int)"/>
    /// <seealso cref="UpdateYUVTexture(IntPtr, IntPtr, IntPtr, int, IntPtr, int, IntPtr, int)"/>
    public static unsafe bool UpdateTexture(nint texture, nint rect, Span<byte> pixels, int pitch)
    {
        fixed (byte* p = pixels) return UpdateTexture(texture, rect, (nint)p, pitch);
    }
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool UpdateTexture(nint texture, in Rect rect, nint pixels, int pitch);
    ...
    /// <seealso cref="UpdateNVTexture(IntPtr, IntPtr, IntPtr, int, IntPtr, int)"/>
    /// <seealso cref="UpdateYUVTexture(IntPtr, IntPtr, IntPtr, int, IntPtr, int, IntPtr, int)"/>
    public static unsafe bool UpdateTexture(nint texture, in Rect rect, Span<byte> pixels, int pitch)
    {
        fixed (byte* p = pixels) return UpdateTexture(texture, rect, (nint)p, pitch);
    }
    ...
    ///     <para>
    ///         You can use <see cref="UpdateTexture(IntPtr, IntPtr, IntPtr, int)"/> as long as your pixel data is a contiguous
    ///         block of Y and U/V planes in the proper order, but this function is available if your pixel data is not contiguous.
    ///     </para>
    /// </summary>
    /// <param name="texture"> the texture to update. </param>
    /// <param name="rect"> a pointer to the rectangle of pixels to update, or <c> null </c> to update the entire texture. </param>
    ...
    /// <seealso cref="UpdateNVTexture(IntPtr, IntPtr, IntPtr, int, IntPtr, int)"/>
    /// <seealso cref="UpdateTexture(IntPtr, IntPtr, IntPtr, int)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateYUVTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool UpdateYUVTexture(nint texture,
        nint rect,
        nint yplane,
        int ypitch,
        nint uplane,
    ...
    /// <param name="srcrect"> a pointer to the source rectangle, or <c> null </c> for the entire texture. </param>
    /// <param name="dstrect"> a pointer to the destination rectangle, or <c> null </c> for the entire rendering target. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTexture(nint renderer, nint texture, nint srcrect, nint dstrect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTexture(nint renderer, nint texture, in FRect srcrect, nint dstrect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTexture(nint renderer, nint texture, nint srcrect, in FRect dstrect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTexture"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTexture(nint renderer, nint texture, in FRect srcrect, in FRect dstrect);
    ...
    /// <summary>
    ///     Copy a portion of the source texture to the current rendering target, with rotation and flipping, at subpixel
    ///     precision.
    /// </summary>
    /// <param name="renderer"> the renderer which should copy parts of a texture. </param>
    /// <param name="texture"> the source texture. </param>
    ...
    /// <param name="dstrect"> a pointer to the destination rectangle, or <c> null </c> for the entire rendering target. </param>
    /// <param name="angle">
    ///     an angle in degrees that indicates the rotation that will be applied to dstrect, rotating it in a
    ///     clockwise direction.
    /// </param>
    /// <param name="center">
    ///     a pointer to a point indicating the point around which dstrect will be rotated (if <c> null </c>,
    ///     rotation will be done around dstrect.w/2, dstrect.h/2).
    /// </param>
    /// <param name="flip"> an <see cref="FlipMode"/> value stating which flipping actions should be performed on the texture. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="RenderTexture(nint, nint, nint, nint)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTextureRotated"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTextureRotated(nint renderer,
        nint texture,
        nint srcrect,
        nint dstrect,
        double angle,
    ...
    /// <summary>
    ///     <para>
    ///         Copy a portion of the source texture to the current rendering target, with affine transform, at subpixel
    ///         precision.
    ///     </para>
    /// </summary>
    /// <param name="renderer"> the renderer which should copy parts of a texture. </param>
    ...
    /// <param name="srcrect"> a pointer to the source rectangle, or <c> null </c> for the entire texture. </param>
    /// <param name="origin">
    ///     a pointer to a point indicating where the top-left corner of srcrect should be mapped to, or
    ///     <c> null </c> for the rendering target's origin.
    /// </param>
    /// <param name="right">
    ///     a pointer to a point indicating where the top-right corner of srcrect should be mapped to, or
    ///     <c> null </c> for the rendering target's top-right corner.
    /// </param>
    /// <param name="down">
    ///     a pointer to a point indicating where the bottom-left corner of srcrect should be mapped to, or
    ///     <c> null </c> for the rendering target's bottom-left corner.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    ...
    /// <seealso cref="RenderTexture(nint, nint, nint, nint)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTextureAffine"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTextureAffine(nint renderer,
        nint texture,
        nint srcrect,
        nint origin,
        nint right,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="RenderTexture(nint, nint, nint, nint)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTextureTiled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTextureTiled(nint renderer, nint texture, nint srcrect, float scale, nint dstrect);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTextureTiled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTextureTiled(nint renderer,
        nint texture,
        in FRect srcrect,
        float scale,
        nint dstrect);
    ...
    /// <summary>
    ///     <para> erform a scaled copy using the 9-grid algorithm to the current rendering target at subpixel precision. </para>
    ///     <para>
    ///         The pixels in the texture are split into a 3x3 grid, using the different corner sizes for each corner, and the
    ///         sides and center making up the remaining pixels. The corners are then scaled using `scale` and fit into the corners
    ...
    ///     <c> null </c> to use the entire texture.
    /// </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="RenderTexture(nint, nint, nint, nint)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTexture9Grid"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTexture9Grid(nint renderer,
        nint texture,
        in FRect srcrect,
        float leftWidth,
        float rightWidth,
    ...
    ///     <para>
    ///         The pixels in the texture are split into a 3x3 grid, using the different corner sizes for each corner, and the
    ///         sides and center making up the remaining pixels. The corners are then scaled using <c> scale </c> and fit into the
    ///         corners of the destination rectangle. The sides and center are then tiled into place to cover the remaining
    ...
    /// <param name="texture"> the source texture. </param>
    /// <param name="srcrect">
    ///     the SDL_Rect structure representing the rectangle to be used for the 9-grid, or <c> null </c> to use
    ///     the entire texture.
    /// </param>
    /// <param name="leftWidth"> the width, in pixels, of the left corners in <c> srcrect </c>. </param>
    /// <param name="rightWidth"> the width, in pixels, of the right corners in <c> srcrect </c>. </param>
    ...
    /// <param name="bottomHeight"> the height, in pixels, of the bottom corners in <c> srcrect </c>. </param>
    /// <param name="scale">
    ///     the scale used to transform the corner of <c> srcrect </c> into the corner of <c> dstrect </c>, or
    ///     <c> 0.0f </c> for an unscaled copy.
    /// </param>
    /// <param name="dstrect"> a pointer to the destination rectangle, or <c> null </c> for the entire rendering target. </param>
    /// <param name="tileScale">
    ///     the scale used to transform the borders and center of <c> srcrect </c> into the borders and middle
    ///     of <c> dstrect </c>, or <c> 1.0f </c> for an unscaled copy.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <seealso cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.4.0. </since>
    /// <seealso cref="RenderTexture(IntPtr, IntPtr, IntPtr, IntPtr)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderTexture9GridTiled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderTexture9GridTiled(nint renderer,
        nint texture,
        nint srcrect,
        float leftWidth,
        float rightWidth,
    ...
    ///     modulation is done per vertex (<see cref="SetTextureColorMod"/> and <see cref="SetTextureAlphaMod"/> are ignored).
    /// </summary>
    /// <param name="renderer"> the rendering context. </param>
    ...
    /// <param name="indices">
    ///     (optional) An array of integer indices into the <c> vertices </c> array, if <c> null </c> all
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderGeometry"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderGeometry(nint renderer,
        nint texture,
        Vertex[] vertices,
        int numVertices,
        nint indices,
    ...
    /// <param name="numVertices"> number of vertices. </param>
    /// <param name="indices">
    ///     (optional) An array of indices into the <c> vertices </c> arrays, if <c> null </c> all vertices will
    ...
    /// <seealso cref="SetRenderTextureAddressMode"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RenderGeometryRaw"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RenderGeometryRaw(nint renderer,
        nint texture,
        nint xy,
        int xyStride,
        nint color,
    ...
    /// <seealso cref="RenderGeometry(IntPtr, IntPtr, Vertex[], int, IntPtr, int)"/>
    /// <seealso cref="SetRenderTextureAddressMode"/>
    public static unsafe bool RenderGeometryRaw<TIndex>(nint renderer,
        nint texture,
        Span<float> xy,
        int xyStride,
        Span<FColor> color,
        ...
        Span<TIndex> indices,
        int numIndices,
        int sizeIndices) where TIndex : unmanaged
    {
        fixed (float* pXy = xy)
        ...
        {
            if (indices.Length == 0)
                return RenderGeometryRaw(renderer,
                    texture,
                    (nint)pXy,
                    xyStride,
                    (nint)pColor,
    ...
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="umode">
    ///     the <see cref="TextureAddressMode"/> to use for horizontal texture coordinates in
    ///     <see cref="RenderGeometry(IntPtr, IntPtr, Vertex[], int, IntPtr, int)"/>.
    /// </param>
    /// <param name="vmode">
    ///     the <see cref="TextureAddressMode"/> to use for vertical texture coordinates in
    ///     <see cref="RenderGeometry(IntPtr, IntPtr, Vertex[], int, IntPtr, int)"/>
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.4.0. </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetRenderTextureAddressMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetRenderTextureAddressMode(nint renderer,
        TextureAddressMode umode,
        TextureAddressMode vmode);
    ...
    /// <summary> Get the texture addressing mode used in <see cref="RenderGeometry(IntPtr, IntPtr, Vertex[], int, IntPtr, int)"/>. </summary>
    /// <param name="renderer"> the rendering context. </param>
    /// <param name="umode">
    ///     a pointer filled in with the <see cref="TextureAddressMode"/> to use for horizontal texture coordinates
    ///     in <see cref="RenderGeometry(IntPtr, IntPtr, Vertex[], int, IntPtr, int)"/>, may be <c> null </c>.
    /// </param>
    /// <param name="vmode">
    ///     a pointer filled in with the <see cref="TextureAddressMode"/> to use for vertical texture coordinates
    ///     in <see cref="RenderGeometry(IntPtr, IntPtr, Vertex[], int, IntPtr, int)"/>, may be <c> null </c>.
    /// </param>
    /// <returns> true on success or false on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.4.0. </since>
    /// <seealso cref="SetRenderTextureAddressMode"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRenderTextureAddressMode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetRenderTextureAddressMode(nint renderer,
        out TextureAddressMode umode,
        out TextureAddressMode vmode);
