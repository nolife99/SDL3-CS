...
public static partial class SDL
{
    public static partial class Props
    {
        ...
        public const string RendererCreateVulkanGraphicsQueueFamilyIndexNumber =
            "SDL.renderer.create.vulkan.graphics_queue_family_index";

        public const string RendererCreateVulkanPresentQueueFamilyIndexNumber =
        ...
        public const string RendererVulkanGraphicsQueueFamilyIndexNumber =
            "SDL.renderer.vulkan.graphics_queue_family_index";

        public const string RendererVulkanPresentQueueFamilyIndexNumber =
