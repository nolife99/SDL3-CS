...
public static partial class SDL
{
 ...
 ///     <para>
 ///         On macOS, this does <b> not </b> associate a MTLDevice with the CAMetalLayer on its own. It is up to user code to
 ///         do that.
 ///     </para>
 ///     <para>
 ///         The returned handle can be casted directly to a NSView or UIView. To access the backing CAMetalLayer, call
 ///         <see cref="MetalGetLayer"/>.
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_Metal_CreateView"),
 ...
 ///     <para>
 ///         This should be called before <see cref="DestroyWindow"/>, if <see cref="MetalCreateView"/> was called after
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_Metal_DestroyView"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 /// <since> This function is available since SDL 3.2.0 </since>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_Metal_GetLayer"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
