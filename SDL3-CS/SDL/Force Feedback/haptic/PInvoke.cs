...
public static partial class SDL
{
    ...
    /// <param name="count"> a pointer filled in with the number of haptic devices returned, may be <c> null </c>. </param>
    /// <returns>
    ///     a 0 terminated array of haptic device instance IDs or <c> null </c> on failure; call <see cref="GetError"/> for
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetHapticNameForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetHapticNameForID(int instanceId);
    ...
    /// <returns>
    ///     the name of the selected haptic device. If no name can be found, this function returns <c> null </c>; call
    ...
    ///         values use <see cref="SetHapticGain"/> and <see cref="SetHapticAutocenter"/>.
    ///     </para>
    /// </summary>
    /// <param name="instanceId"> the haptic device instance ID. </param>
    /// <returns> the device identifier or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    public static partial nint OpenHaptic(int instanceId);
    ...
    /// <returns>
    ///     an SDL_Haptic on success or <c> null </c> on failure or if it hasn't been opened yet; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetHapticFromID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetHapticFromID(int instanceId);
    ...
    /// <returns>
    ///     the instance ID of the specified haptic device on success or 0 on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetHapticID"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial int GetHapticID(nint haptic);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetHapticName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetHapticName(nint haptic);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="OpenHapticFromMouse"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_IsMouseHaptic"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <returns> the haptic device identifier or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CloseHaptic"/>
    /// <seealso cref="IsMouseHaptic"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_OpenHapticFromMouse"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="OpenHapticFromJoystick"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_IsJoystickHaptic"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool IsJoystickHaptic(nint joystick);
    ...
    ///     <para>
    ///         When opened from a joystick you should first close the haptic device before closing the joystick device. If not,
    ///         on some implementations the haptic device will also get unallocated and you'll be unable to use force feedback on
    ///         that device.
    ///     </para>
    /// </summary>
    /// <param name="joystick"> the SDL_Joystick to create a haptic device from. </param>
    /// <returns>
    ///     a valid haptic device identifier on success or <c> null </c> on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CloseHaptic"/>
    /// <seealso cref="IsJoystickHaptic"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_OpenHapticFromJoystick"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <summary> Close a haptic device previously opened with <see cref="OpenHaptic"/>. </summary>
    ...
    ///     <para>
    ///         On some platforms this isn't fully supported, and therefore is an approximation. Always check to see if your
    ///         created effect was actually created and do not rely solely on <see cref="GetMaxHapticEffects"/>.
    ///     </para>
    /// </summary>
    /// <param name="haptic"> the SDL_Haptic device to query. </param>
    /// <returns>
    ///     the number of effects the haptic device can store or a negative error code on failure; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetMaxHapticEffectsPlaying"/>
    /// <seealso cref="GetHapticFeatures"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetMaxHapticEffects"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <returns>
    ///     the number of effects the haptic device can play at the same time or -1 on failure; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetMaxHapticEffects"/>
    /// <seealso cref="GetHapticFeatures"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetMaxHapticEffectsPlaying"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="haptic"> the SDL_Haptic device to query. </param>
    /// <returns>
    ///     a list of supported haptic features in bitwise manner (OR'd), or 0 on failure; call <see cref="GetError"/> for
    ///     more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="HapticEffectSupported"/>
    /// <seealso cref="GetMaxHapticEffects"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetHapticFeatures"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para> The number of haptic axes might be useful if working with the <see cref="HapticDirection"/> effect. </para>
    /// </summary>
    /// <param name="haptic"> the SDL_Haptic device to query. </param>
    /// <returns> the number of axes on success or -1 on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumHapticAxes"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetHapticFeatures"/>
    [DllImport(SDLLibrary, EntryPoint = "SDL_HapticEffectSupported"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool HapticEffectSupported(nint haptic, in HapticEffect effect);
    ...
    /// <param name="effect"> an <see cref="HapticEffect"/> structure containing the properties of the effect to create. </param>
    /// <returns> the ID of the effect on success or -1 on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="DestroyHapticEffect"/>
    /// <seealso cref="RunHapticEffect"/>
    /// <seealso cref="UpdateHapticEffect"/>
    [DllImport(SDLLibrary, EntryPoint = "SDL_CreateHapticEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static extern int CreateHapticEffect(nint haptic, in HapticEffect effect);
    ...
    ///     <para>
    ///         Can be used dynamically, although behavior when dynamically changing direction may be strange. Specifically the
    ///         effect may re-upload itself and start playing from the start. You also cannot change the type either when running
    ///         <see cref="UpdateHapticEffect"/>.
    ///     </para>
    /// </summary>
    ...
    /// <returns> an <see cref="HapticEffect"/> structure containing the new effect properties to use. </returns>
    /// <since> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </since>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateHapticEffect"/>
    /// <seealso cref="RunHapticEffect"/>
    [DllImport(SDLLibrary, EntryPoint = "SDL_UpdateHapticEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool UpdateHapticEffect(nint haptic, int effect, in HapticEffect data);
    ...
    ///     <para>
    ///         To repeat the effect over and over indefinitely, set <c> iterations </c> to <c> HAPTIC_INFINITY </c>. (Repeats
    ///         the envelope - attack and fade.) To make one instance of the effect last indefinitely (so the effect does not fade),
    ///         set the effect's <c> length </c> in its structure/union to <c> HAPTIC_INFINITY </c> instead.
    ///     </para>
    /// </summary>
    ...
    /// <param name="iterations"> the number of iterations to run the effect; use <c> HAPTIC_INFINITY </c> to repeat forever. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RunHapticEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RunHapticEffect(nint haptic, int effect, uint iterations);
    ...
    /// <seealso cref="RunHapticEffect"/>
    /// <seealso cref="StopHapticEffects"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_StopHapticEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool StopHapticEffect(nint haptic, int effect);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="CreateHapticEffect"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyHapticEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <returns> <c> true </c> if it is playing, <c> false </c> if it isn't playing or haptic status isn't supported. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetHapticFeatures"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetHapticEffectStatus"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetHapticEffectStatus(nint haptic, int effect);
    ...
    ///     <para>
    ///         The user may specify the maximum gain by setting the environment variable <c> HAPTIC_GAIN_MAX </c> which should
    ///         be between 0 and 100. All calls to <see cref="SetHapticGain"/> will scale linearly using
    ///         <c> SDL_HAPTIC_GAIN_MAX </c> as the maximum.
    ///     </para>
    /// </summary>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetHapticFeatures"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetHapticGain"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetHapticGain(nint haptic, int gain);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetHapticFeatures"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetHapticAutocenter"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetHapticAutocenter(nint haptic, int autocenter);

    /// <code>extern SDL_DECLSPEC bool SDLCALL SDL_PauseHaptic(SDL_Haptic *haptic);</code>
    /// <summary>
    ///     <para> Pause a haptic device. </para>
    ///     <para> Device must support the <c> HAPTIC_PAUSE </c> feature. Call <see cref="ResumeHaptic"/> to resume playback. </para>
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool PauseHaptic(nint haptic);

    /// <code>extern SDL_DECLSPEC bool SDLCALL SDL_ResumeHaptic(SDL_Haptic *haptic);</code>
    /// <summary>
    ///     <para> Resume a haptic device. </para> <para> Call to unpause after <see cref="PauseHaptic"/>. </para>
    /// </summary>
    ...
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool ResumeHaptic(nint haptic);
    ...
    /// <seealso cref="RunHapticEffect"/>
    /// <seealso cref="StopHapticEffects"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_StopHapticEffects"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool StopHapticEffects(nint haptic);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_HapticRumbleSupported"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool HapticRumbleSupported(nint haptic);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_InitHapticRumble"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool InitHapticRumble(nint haptic);
    ...
    /// <seealso cref="InitHapticRumble"/>
    /// <seealso cref="StopHapticRumble"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_PlayHapticRumble"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool PlayHapticRumble(nint haptic, float strength, uint length);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="PlayHapticRumble"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_StopHapticRumble"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool StopHapticRumble(nint haptic);
}