...
public static partial class SDL
{
    ...
    ///         axis. The right terms refer to the positive side of the axis and the left terms refer to the negative side of the
    ///         axis. Please refer to the <see cref="HapticDirection"/> diagram for which side is positive and which is negative.
    ///     </para>
    /// </summary>
    ...
    {
        /// <summary>
        ///     <see cref="HAPTIC_SPRING"/>, <see cref="HAPTIC_DAMPER"/>, <see cref="HAPTIC_INERTIA"/> or
        ///     <see cref="HAPTIC_FRICTION"/>
        /// </summary>
        public UInt16 Type;
