...
public static partial class SDL
{
    ...
    ///     </para>
    ///     <para>
    ///         You can also pass <see cref="HAPTIC_INFINITY"/> to length instead of a 0-32767 value. Neither delay, interval,
    ///         attack_length nor fade_length support <see cref="HAPTIC_INFINITY"/>. Fade will also not be used since effect never
    ///         ends.
    ///     </para>
    ///     <para> Additionally, the <see cref="HAPTIC_RAMP"/> effect does not support a duration of <see cref="HAPTIC_INFINITY"/>. </para>
    ///     <para>
    ///         Button triggers may not be supported on all devices, it is advised to not use them if possible. Buttons start at
    ///         index 1 instead of index 0 like the joystick.
    ///     </para>
