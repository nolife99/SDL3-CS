...
public static partial class SDL
{
 ...
 ///         <see cref="GUIDToString"/>, name is the human readable string for the device and mappings are gamepad mappings to
 ///         joystick ones. Under Windows there is a reserved GUID of "xinput" that covers all XInput devices. The mapping format
 ///         for joystick is:
 ///     </para>
 ///     <list type="bullet">
 ///         <item> <c> bX </c>: a joystick button, index X </item> <item> <c> hX.Y </c>: hat X with value Y </item>
 ///         <item> <c> aX </c>: axis X of the joystick </item>
 ///     </list>
 ///     <para> Buttons can be used as a gamepad axes and vice versa. </para>
 ///     <para>
 ///         If a device with this GUID is already plugged in, SDL will generate an <see cref="EventType.GamepadAdded"/>
 ///         event.
 ///     </para>
 ...
 /// <returns>
 ///     1 if a new mapping is added, 0 if an existing mapping is updated, -1 on failure; call <see cref="GetError"/> for
 ///     more information.
 /// </returns>
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_AddGamepadMapping"),
 ...
 ///     <para>
 ///         If a new mapping is loaded for an already known gamepad GUID, the later version will overwrite the one currently
 ///         loaded.
 ///     </para>
 ///     <para> Any new mappings for already plugged in controllers will generate <see cref="EventType.GamepadAdded"/> events. </para>
 ///     <para>
 ///         Mappings not belonging to the current platform or with no platform field specified will be ignored (i.e. mappings
 ///         for Linux will be ignored in Windows, etc).
 ///     </para>
 ///     <para>
 ...
 /// <seealso cref="Hints.GameControllerConfigFile"/>
 /// <seealso cref="EventType.GamepadAdded"/>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_AddGamepadMappingsFromIO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial int AddGamepadMappingsFromIO(nint src, [MarshalAs(UnmanagedType.I1)] bool closeio);
 ...
 /// <seealso cref="Hints.GameControllerConfigFile"/>
 /// <seealso cref="EventType.GamepadAdded"/>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_AddGamepadMappingsFromFile"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 /// <since> This function is available since SDL 3.2.0 </since>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_ReloadGamepadMappings"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool ReloadGamepadMappings();

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadMappings"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static unsafe partial nint SDL_GetGamepadMappings(out int count);
    ...
    /// <param name="count"> a pointer filled in with the number of mappings returned, can be <c> null </c>. </param>
    /// <returns>
    ///     an array of the mapping strings, NULL-terminated, or <c> null </c> on failure; call <see cref="GetError"/> for
    ///     more information. This is a single allocation that should be freed with <see cref="Free"/> when it is no longer needed.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadMappingForGUID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadMappingForGUID(GUID guid);
    ...
    /// <returns>
    ///     a mapping string or <c> null </c> on failure; call <see cref="GetError"/> for more information. This should be
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadMapping"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadMapping(nint gamepad);
    ...
    /// <returns>
    ///     a string that has the gamepad's mapping or <c> null </c> if no mapping is available; call <see cref="GetError"/>
    ///     for more information. This should be freed with <see cref="Free"/> when it is no longer needed.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="AddGamepadMapping"/>
    ...
    /// <param name="mapping"> the mapping to use for this device, or <c> null </c> to clear the mapping. </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="AddGamepadMapping"/>
    /// <seealso cref="GetGamepadMapping"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGamepadMapping"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <summary> Return whether a gamepad is currently connected. </summary>
    ...
    /// <param name="count"> a pointer filled in with the number of gamepads returned, may be <c> null </c>. </param>
    /// <returns>
    ///     a 0 terminated array of joystick instance IDs or <c> null </c> on failure; call <see cref="GetError"/> for more
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     <c> true </c> if the given joystick is supported by the gamepad interface, <c> false </c> if it isn't or it's an
    ///     invalid index.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadNameForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadNameForID(uint instanceId);
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the name of the selected gamepad. If no name can be found, this function returns <c> null </c>; call
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadPathForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadPathForID(uint instanceId);
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the path of the selected gamepad. If no path can be found, this function returns <c> null </c>; call
    ///     <see cref="GetError"/> for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <summary>
    ///     <para> Get the player index of a gamepad. </para> <para> This can be called before any gamepads are opened. </para>
    /// </summary>
    /// <param name="instanceID"> the joystick instance ID. </param>
    ...
    /// <seealso cref="GetGamepads"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadPlayerIndexForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetGamepads"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadGUIDForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetGamepads"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadVendorForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetGamepads"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadProductForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         This can be called before any gamepads are opened. If the product version isn't available this function returns
    ///         0.
    ///     </para>
    /// </summary>
    /// <param name="instanceID"> the joystick instance ID. </param>
    ...
    /// <seealso cref="GetGamepads"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadProductVersionForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <summary>
    ///     <para> Get the type of a gamepad. </para> <para> This can be called before any gamepads are opened. </para>
    /// </summary>
    /// <param name="instanceID"> the joystick instance ID. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadTypeForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRealGamepadTypeForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadType GetRealGamepadTypeForID(uint instanceID);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadMappingForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadMappingForID(uint instanceId);

    /// <code>extern SDL_DECLSPEC char * SDLCALL SDL_GetGamepadMappingForID(SDL_JoystickID instance_id);</code>
    /// <summary>
    ///     <para> Get the mapping of a gamepad. </para> <para> This can be called before any gamepads are opened. </para>
    /// </summary>
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the mapping string. Returns <c> null </c> if no mapping is available. This should be freed with <see cref="Free"/>
    ...
    /// <param name="instanceID"> the joystick instance ID. </param>
    /// <returns> a gamepad identifier or <c> null </c> if an error occurred; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    public static partial nint OpenGamepad(uint instanceID);
    ...
    /// <returns>
    ///     an SDL_Gamepad on success or <c> null </c> on failure or if it hasn't been opened yet; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadFromID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetGamepadFromID(uint instanceID);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadFromPlayerIndex"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetGamepadFromPlayerIndex(int playerIndex);
    ...
    /// <param name="gamepad"> a gamepad identifier previously returned by <see cref="OpenGamepad"/>. </param>
    /// <returns>
    ///     the instance ID of the specified gamepad on success or 0 on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadName(nint gamepad);
    ...
    /// <param name="gamepad"> a gamepad identifier previously returned by <see cref="OpenGamepad"/>. </param>
    /// <returns>
    ///     the implementation dependent name for the gamepad, or <c> null </c> if there is no name or the identifier passed
    ///     is invalid.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadPath"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadPath(nint gamepad);
    ...
    /// <param name="gamepad"> a gamepad identifier previously returned by <see cref="OpenGamepad"/>. </param>
    /// <returns>
    ///     the implementation dependent path for the gamepad, or <c> null </c> if there is no path or the identifier passed
    ///     is invalid.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <returns> the gamepad type, or <see cref="GamepadType.Unknown"/> if it's not available. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetGamepadTypeForID"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadType"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadType GetGamepadType(nint gamepad);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetRealGamepadTypeForID"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetRealGamepadType"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadType GetRealGamepadType(nint gamepad);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SetGamepadPlayerIndex"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadPlayerIndex"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <seealso cref="GetGamepadPlayerIndex"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGamepadPlayerIndex"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetGamepadPlayerIndex(nint gamepad, int playerIndex);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadVendor"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadProduct"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadProductVersion"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadFirmwareVersion"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial ushort GetGamepadFirmwareVersion(nint gamepad);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadSerial"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadSerial(nint gamepad);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadSteamHandle"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="gamepad"> the gamepad object to query. </param>
    /// <returns>
    ///     the connection state on success or <see cref="JoystickConnectionState.Invalid"/> on failure; call
    ///     <see cref="GetError"/> for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadConnectionState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial JoystickConnectionState GetGamepadConnectionState(nint gamepad);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadPowerInfo"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial PowerState GetGamepadPowerInfo(nint gamepad, out int percent);
    ...
    /// <param name="gamepad"> a gamepad identifier previously returned by <see cref="OpenGamepad"/>. </param>
    /// <returns> <c> true </c> if the gamepad has been opened and is currently connected, or <c> false </c> if not. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GamepadConnected"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GamepadConnected(nint gamepad);
    ...
    ///     <para>
    ///         This function will give you a SDL_Joystick object, which allows you to use the SDL_Joystick functions with a
    ///         SDL_Gamepad object. This would be useful for getting a joystick's position at any given time, even if it hasn't
    ///         moved (moving it would produce an event, which would have the axis' value).
    ///     </para>
    ///     <para>
    ///         The pointer returned is owned by the SDL_Gamepad. You should not call <see cref="CloseJoystick"/> on it, for
    ///         example, since doing so will likely cause SDL to crash.
    ///     </para>
    /// </summary>
    /// <param name="gamepad"> the gamepad object that you want to get a joystick from. </param>
    /// <returns> an SDL_Joystick object, or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadJoystick"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         If gamepad events are disabled, you must call <see cref="UpdateGamepads"/> yourself and check the state of the
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGamepadEventsEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GamepadEventsEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GamepadEventsEnabled();

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadBindings"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <returns>
    ///     a <c> null </c> terminated array of pointers to bindings or <c> null </c>on failure; call <see cref="GetError"/>
    ///     for more information. This is a single allocation that should be freed with <see cref="Free"/> when it is no longer
    ///     needed.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    public static GamepadBinding[]? GetGamepadBindings(nint gamepad, out int count)
    {
    ...
    ///     <para>
    ///         This function is called automatically by the event loop if events are enabled. Under such circumstances, it will
    ///         not be necessary to call this function.
    ///     </para>
    /// </summary>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateGamepads"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         This function is called internally to translate SDL_Gamepad mapping strings for the underlying joystick device
    ///         into the consistent SDL_Gamepad mapping. You do not normally need to call this function unless you are parsing
    ///         SDL_Gamepad mappings in your own code.
    ///     </para>
    /// </summary>
    /// <param name="str"> string representing a <see cref="GamepadType"/> type. </param>
    /// <returns>
    ///     the <see cref="GamepadType"/> enum corresponding to the input string, or <see cref="GamepadType.Unknown"/> if no
    ///     match was found.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetGamepadStringForType"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadTypeFromString"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadType GetGamepadTypeFromString([MarshalAs(UnmanagedType.LPUTF8Str)] string str);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadStringForType"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadStringForType(GamepadType type);

    /// <code>extern SDL_DECLSPEC const char * SDLCALL SDL_GetGamepadStringForType(SDL_GamepadType type);</code>
    /// <summary> Convert from an <see cref="GamepadType"/> enum to a string. </summary>
    /// <param name="type"> an enum value for a given <see cref="GamepadType"/>. </param>
    /// <returns>
    ///     a string for the given type, or <c> null </c> if an invalid type is specified. The string returned is of the
    ///     format used by SDL_Gamepad mapping strings.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    ///     </para>
    ///     <para>
    ///         Note specially that "righttrigger" and "lefttrigger" map to <see cref="GamepadAxis.RightTrigger"/> and
    ///         <see cref="GamepadAxis.LeftTrigger"/>, respectively.
    ///     </para>
    /// </summary>
    /// <param name="str"> string representing a SDL_Gamepad axis. </param>
    /// <returns>
    ///     the <see cref="GamepadAxis"/> enum corresponding to the input string, or <see cref="GamepadAxis.Invalid"/> if no
    ///     match was found.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetGamepadStringForAxis"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadAxisFromString"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadAxis GetGamepadAxisFromString([MarshalAs(UnmanagedType.LPUTF8Str)] string str);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadStringForAxis"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadStringForAxis(GamepadAxis axis);
    ...
    /// <returns>
    ///     a string for the given axis, or <c> null </c> if an invalid axis is specified. The string returned is of the
    ///     format used by SDL_Gamepad mapping strings.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    ///     <para>
    ///         This merely reports whether the gamepad's mapping defined this axis, as that is all the information SDL has about
    ///         the physical device.
    ///     </para>
    /// </summary>
    /// <param name="gamepad"> a gamepad. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GamepadHasAxis"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GamepadHasAxis(nint gamepad, GamepadAxis axis);

    /// <code>extern SDL_DECLSPEC Sint16 SDLCALL SDL_GetGamepadAxis(SDL_Gamepad *gamepad, SDL_GamepadAxis axis);</code>
    /// <summary>
    ///     <para> Get the current state of an axis control on a gamepad. </para> <para> The axis indices start at index 0. </para>
    ...
    ///         this differs from the value reported by the lower-level <see cref="GetJoystickAxis"/>, which normally uses the full
    ///         range.
    ///     </para>
    ///     <para>
    ///         Note that for invalid gamepads or axes, this will return 0. Zero is also a valid value in normal operation;
    ///         usually it means a centered axis.
    ///     </para>
    /// </summary>
    /// <param name="gamepad"> a gamepad. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadAxis"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial short GetGamepadAxis(nint gamepad, GamepadAxis axis);
    ...
    /// <param name="str"> string representing a SDL_Gamepad axis. </param>
    /// <returns>
    ///     the <see cref="GamepadButton"/> enum corresponding to the input string, or <see cref="GamepadButton.Invalid"/> if
    ///     no match was found.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetGamepadStringForButton"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadButtonFromString"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadButton GetGamepadButtonFromString([MarshalAs(UnmanagedType.LPUTF8Str)] string str);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadStringForButton"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadStringForButton(GamepadButton button);

    /// <code>extern SDL_DECLSPEC const char * SDLCALL SDL_GetGamepadStringForButton(SDL_GamepadButton button);</code>
    /// <summary> Convert from an <see cref="GamepadButton"/> enum to a string. </summary>
    /// <param name="button"> an enum value for a given <see cref="GamepadButton"/>. </param>
    /// <returns>
    ///     a string for the given button, or <c> null </c> if an invalid button is specified. The string returned is of the
    ///     format used by SDL_Gamepad mapping strings.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    ///     <para>
    ///         This merely reports whether the gamepad's mapping defined this button, as that is all the information SDL has
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GamepadHasAxis"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GamepadHasButton"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GamepadHasButton(nint gamepad, GamepadButton button);
    ...
    /// <seealso cref="GamepadHasButton"/>
    /// <seealso cref="GetGamepadAxis"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadButton"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetGamepadButton(nint gamepad, GamepadButton button);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadButtonLabelForType"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadButtonLabel"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GamepadButtonLabel GetGamepadButtonLabel(nint gamepad, GamepadButton button);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumGamepadTouchpads"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumGamepadTouchpadFingers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="down"> a pointer filled with true if the finger is down, false otherwise, may be <c> null </c>. </param>
    /// <param name="x">
    ///     a pointer filled with the x position, normalized 0 to 1, with the origin in the upper left, may be
    ///     <c> null </c>.
    /// </param>
    /// <param name="y">
    ///     a pointer filled with the y position, normalized 0 to 1, with the origin in the upper left, may be
    ///     <c> null </c>.
    /// </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetNumGamepadTouchpadFingers"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadTouchpadFinger"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetGamepadTouchpadFinger(nint gamepad,
        int touchpad,
        int finger,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GamepadHasSensor"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GamepadHasSensor(nint gamepad, SensorType type);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGamepadSensorEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetGamepadSensorEnabled(nint gamepad,
        SensorType type,
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SetGamepadSensorEnabled"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GamepadSensorEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GamepadSensorEnabled(nint gamepd, SensorType type);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadSensorDataRate"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial float GetGamepadSensorDataRate(nint gamepad, SensorType type);
    ...
    ///     <para>
    ///         The number of values and interpretation of the data is sensor dependent. See SDL_sensor.h for the details for
    ///         each type of sensor.
    ///     </para>
    /// </summary>
    /// <param name="gamepad"> the gamepad to query. </param>
    ...
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadSensorData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetGamepadSensorData(nint gamepad,
        SensorType type,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] out float[] data,
        int numValues);
    ...
    ///         rumbling.
    ///     </para>
    ///     <para> This function requires you to process SDL events or call <see cref="UpdateJoysticks"/> to update rumble state. </para>
    /// </summary>
    ...
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RumbleGamepad"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RumbleGamepad(nint gamepad,
    ...
    ///     <para>
    ///         Each call to this function cancels any previous trigger rumble effect, and calling it with 0 intensity stops any
    ///         rumbling.
    ///     </para>
    ///     <para>
    ///         Note that this is rumbling of the _triggers_ and not the gamepad as a whole. This is currently only supported on
    ///         Xbox One gamepads. If you want the (more common) whole-gamepad rumble, use <see cref="RumbleGamepad"/> instead.
    ///     </para>
    ///     <para> This function requires you to process SDL events or call <see cref="UpdateJoysticks"/> to update rumble state. </para>
    /// </summary>
    /// <param name="gamepad"> the gamepad to vibrate. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RumbleGamepadTriggers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RumbleGamepadTriggers(nint gamepad,
        ushort leftRumble,
        ushort rightRumble,
        uint durationMs);
    ...
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetGamepadLED"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SendGamepadEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SendGamepadEffect(nint gamepad,
    ...
    /// <summary> Close a gamepad previously opened with <see cref="OpenGamepad"/>. </summary>
    /// <param name="gamepad"> a gamepad identifier previously returned by <see cref="OpenGamepad"/>. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="OpenGamepad"/>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadAppleSFSymbolsNameForButton"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadAppleSFSymbolsNameForButton(nint gamepad, GamepadButton button);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetGamepadAppleSFSymbolsNameForAxis"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetGamepadAppleSFSymbolsNameForAxis(nint gamepad, GamepadAxis axis);
