...
public static partial class SDL
{
    ...
    ///         correspond to the locations in the diamond pattern. For Xbox controllers, this would be A/B/X/Y, for Nintendo Switch
    ///         controllers, this would be B/A/Y/X, for GameCube controllers this would be A/X/B/Y, for PlayStation controllers this
    ///         would be Cross/Circle/Square/Triangle.
    ///     </para>
    ///     <para>
    ///         For controllers that don't use a diamond pattern for the face buttons, the south/east/west/north buttons indicate
    ///         the buttons labeled A, B, C, D, or 1, 2, 3, 4, or for controllers that aren't labeled, they are the primary,
    ...
    ///     </para>
    ///     <para> You can query the labels for the face buttons using <see cref="GetGamepadButtonLabel"/> </para>
    /// </summary>
