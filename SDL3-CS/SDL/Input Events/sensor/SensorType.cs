...
public static partial class SDL
{
    ...
    ///         force of gravity, so a device at rest will have an value of <see cref="SDL.StandardGravity"/> away from the center
    ///         of the earth, which is a positive Y value.
    ///     </para>
    ///     <list type="bullet">
    ...
    ///     </list>
    ///     <para>
    ///         For phones and tablets held in natural orientation and game controllers held in front of you, the axes are
    ///         defined as follows:
    ///     </para>
    ///     <list type="bullet">
    ///         <item> -X ... +X : left ... right </item> <item> -Y ... +Y : bottom ... top </item>
    ...
    ///     <para>
    ///         The gyroscope returns the current rate of rotation in radians per second. The rotation is positive in the
    ///         counter-clockwise direction. That is, an observer looking from a positive location on one of the axes would see
    ///         positive rotation on that axis when it appeared to be rotating counter-clockwise.
    ///     </para>
    ///     <list type="bullet">
