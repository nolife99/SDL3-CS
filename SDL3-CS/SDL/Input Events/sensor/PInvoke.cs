...
public static partial class SDL
{
    ...
    /// <param name="count"> a pointer filled in with the number of sensors returned, may be <c> null </c>. </param>
    /// <returns>
    ///     a 0 terminated array of sensor instance IDs or <c> null </c> on failure; call <see cref="GetError"/> for more
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorNameForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetSensorNameForID(int instanceId);
    ...
    /// <summary>
    ///     <para> Get the type of a sensor. </para> <para> This can be called before any sensors are opened. </para>
    /// </summary>
    /// <param name="instanceID"> the sensor instance ID. </param>
    /// <returns> the <c> SensorType </c>, or <see cref="SensorType.Invalid"/> if <c> instanceID </c> is not valid. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorTypeForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// </summary>
    /// <param name="instanceID"> the sensor instance ID. </param>
    /// <returns> the sensor platform dependent type, or -1 if <c> instanceID </c> is not valid. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorNonPortableTypeForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="instanceID"> the sensor instance ID. </param>
    /// <returns> an SDL_Sensor object or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_OpenSensor"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint OpenSensor(int instanceID);
    ...
    /// <returns> an SDL_Sensor object or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorFromID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetSensorFromID(int instanceID);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetSensorName(nint sensor);
    ...
    /// <param name="sensor"> the SDL_Sensor object. </param>
    /// <returns> the sensor name or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <returns> the <see cref="SensorType"/> type, or <see cref="SensorType.Invalid"/> if <c> sensor </c> is <c> null </c>. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "GetSensorType"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial SensorType GetSensorType(nint sensor);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorNonPortableType"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="sensor"> the SDL_Sensor object to inspect. </param>
    /// <returns> the sensor instance ID, or 0 on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetSensorData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetSensorData(nint sensor, out float data, int numValues);

    /// <code>extern SDL_DECLSPEC void SDLCALL SDL_CloseSensor(SDL_Sensor *sensor);</code>
    /// <summary> Close a sensor previously opened with <see cref="OpenSensor"/>. </summary>
    ...
    /// </summary>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateSensors"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
