...
public static partial class SDL
{
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_HasKeyboard"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         Note that this will include any device or virtual driver that includes keyboard functionality, including some
    ///         mice, KVM switches, motherboard power buttons, etc. You should wait for input from a device before you consider it
    ///         actively in use.
    ///     </para>
    /// </summary>
    /// <param name="count"> a pointer filled in with the number of keyboards returned, may be <c> null </c>. </param>
    /// <returns>
    ///     a 0 terminated array of keyboards instance IDs or <c> null </c> on failure; call <see cref="GetError"/> for more
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetKeyboardNameForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetKeyboardNameForID(uint instanceId);

    /// <code>extern SDL_DECLSPEC const char * SDLCALL SDL_GetKeyboardNameForID(SDL_KeyboardID instance_id);</code>
    /// <summary>
    ///     <para> Get the name of a keyboard. </para> <para> This function returns "" if the keyboard doesn't have a name. </para>
    /// </summary>
    /// <param name="instanceId"> the keyboard instance ID. </param>
    /// <returns> the name of the selected keyboard or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetKeyboards"/>
    ...
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetKeyboardFocus"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetKeyboardFocus();

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetKeyboardState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         The pointer returned is a pointer to an internal SDL array. It will be valid for the whole lifetime of the
    ...
    ///         Indexes into this array are obtained by using <see cref="Scancode"/> values.
    ///     </para>
    ///     <para> Use <see cref="PumpEvents"/> to update the state array. </para>
    ///     <para>
    ///         This function gives you the current state after all events have been processed, so if a key or button has been
    ///         pressed and released before you process events, then the pressed state will never show up in the
    ///         <see cref="GetKeyboardState"/> calls.
    ///     </para>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ResetKeyboard"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         The inverse of <see cref="GetModState"/>, <see cref="SetModState"/> allows you to impose modifier key states on
    ///         your application. Simply pass your desired modifier states into <c> modstate </c>. This value may be a bitwise, OR'd
    ///         combination of <see cref="Keymod"/> values.
    ///     </para>
    ...
    ///         <see cref="Hints.KeycodeOptions"/>, then you should pass <c> keyEvent </c> as true. Otherwise this function simply
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetKeyFromScancode"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial Keycode GetKeyFromScancode(Scancode scancode,
        Keymod modstate,
        [MarshalAs(UnmanagedType.I1)] bool keyEvent);
    ...
    ///     <para>
    ///         Note that there may be multiple scancode+modifier states that can generate this keycode, this will just return
    ///         the first one found.
    ///     </para>
    /// </summary>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetScancodeFromKey"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="name">
    ///     the name to use for the scancode, encoded as UTF-8. The string is not copied, so the pointer given to
    ///     this function must stay valid while SDL is being used.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function is not thread safe. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetScancodeName"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetScancodeName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetScancodeName(Scancode scancode, [MarshalAs(UnmanagedType.LPUTF8Str)] string name);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetScancodeName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetScancodeName(Scancode scancode);
    ...
    ///     <para>
    ///         <b> Warning </b>: The returned name is by design not stable across platforms, e.g. the name for
    ///         <see cref="Scancode.LGUI"/> is "Left GUI" under Linux but "Left Windows" under Microsoft Windows, and some scancodes
    ///         like <see cref="Scancode.NonUsbackslash"/> don't have any name at all. There are even scancodes that share names,
    ///         e.g. <see cref="Scancode.Return"/> and <see cref="Scancode.Return2"/> (both called "Return"). This function is
    ///         therefore unsuitable for creating a stable cross-platform two-way mapping between strings and scancodes.
    ///     </para>
    /// </summary>
    ...
    /// <returns>
    ///     the <see cref="Scancode"/>, or <see cref="Scancode.Unknown"/> if the name wasn't recognized; call
    ...
    /// <seealso cref="GetScancodeFromKey"/>
    /// <seealso cref="GetScancodeName"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetScancodeFromName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    private static partial nint SDL_GetKeyName(Keycode key);
    ...
    /// <returns>
    ///     key code, or <see cref="Keycode.Unknown"/> if the name wasn't recognized; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <threadsafety> This function is not thread safe. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <seealso cref="GetKeyName"/>
    /// <seealso cref="GetScancodeFromName"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetKeyFromName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         This function will enable text input (<see cref="EventType.TextInput"/> and <see cref="EventType.TextEditing"/>
    ///         events) in the specified window. Please use this function paired with <see cref="StopTextInput"/>.
    ///     </para>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_StartTextInput"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextInputTypeNumber"/> - an <see cref="TextInputType"/> value that describes text being
    ///             input, defaults to <see cref="TextInputType.Text"/>.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextInputCapitalizationNumber"/> - an <see cref="Capitalization"/> value that describes how
    ///             text should be capitalized, defaults to <see cref="Capitalization.Sentences"/> for normal text entry,
    ///             <see cref="Capitalization.Words"/> for <see cref="TextInputType.TextName"/>, and
    ///             <see cref="Capitalization.None"/> for e-mail addresses, usernames, and passwords.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextInputAutoCorrectBoolean"/> - true to enable auto completion and auto correction,
    ///             defaults to true.
    ///         </item>
    ///         <item>
    ///             <see cref="Props.TextInputMultilineBoolean"/> - true if multiple lines of text are allowed. This defaults to
    ///             true if <see cref="Hints.ReturnKeyHidesIME"/> is "0" or is not set, and defaults to false if
    ///             <see cref="Hints.ReturnKeyHidesIME"/> is "1".
    ///         </item>
    ///     </list>
    ///     <para> On Android you can directly specify the input type: </para>
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.TextInputAndroidInputTypeNumber"/> - the text input type to use, overriding other
    ///             properties. This is documented at https://developer.android.com/reference/android/text/InputType
    ///         </item>
    ///     </list>
    /// </summary>
    /// <param name="window"> the window to enable text input. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="StartTextInput"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_TextInputActive"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para> If <see cref="StartTextInput"/> showed the screen keyboard, this function will hide it. </para>
    /// </summary>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="StartTextInput"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_StopTextInput"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <seealso cref="StartTextInput"/>
    /// <seealso cref="StopTextInput"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ClearComposition"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <param name="rect">
    ///     the <see cref="Rect"/> representing the text input area, in window coordinates, or <c> null </c> to
    ///     clear it.
    /// </param>
    ...
    /// <seealso cref="StartTextInput"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextInputArea"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextInputArea(nint window, nint rect, int cursor);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTextInputArea"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetTextInputArea(nint window, in Rect rect, int cursor);
    ...
    /// <param name="rect"> a pointer to an <see cref="Rect"/> filled in with the text input area, may be <c> null </c>. </param>
    /// <param name="cursor">
    ///     a pointer to the offset of the current cursor location relative to <c> rect->x </c>, may be
    ///     <c> null </c>.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SetTextInputArea(nint, nint, int)"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTextInputArea"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// </summary>
    /// <returns> <c> true </c> if the platform has some screen keyboard support or <c> false </c> if not. </returns>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="StartTextInput"/>
    /// <seealso cref="ScreenKeyboardShown"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_HasScreenKeyboardSupport"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "ScreenKeyboardShown"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
