...
public static partial class SDL
{
    ...
    ///     <para> This structure should be initialized using SDL_INIT_INTERFACE(). All elements of this structure are optional. </para>
    /// </summary>
    ...
    public struct VirtualJoystickDesc
    {
        ...
        /// <summary> the number of touchpads on this joystick, requires <c> touchpads </c> to point at valid descriptions </summary>
        public UInt16 NTouchpads;

        /// <summary> the number of sensors on this joystick, requires <c> sensors </c> to point at valid descriptions </summary>
        public UInt16 NSensors;

        /// <summary> unused </summary>
        unsafe fixed UInt16 _padding2[2];

        /// <summary> A mask of which buttons are valid for this controller e.g. (1 &lt;&lt; <see cref="GamepadButton.South"/>) </summary>
        public uint ButtonMask;

        /// <summary> A mask of which axes are valid for this controller e.g. (1 &lt;&lt; <see cref="GamepadAxis.LeftX"/>) </summary>
        public uint AxisMask;

        /// <summary> the name of the joystick </summary>
        public IntPtr Name;

        /// <summary> A pointer to an array of touchpad descriptions, required if <see cref="NTouchpads"/> is > 0 </summary>
        public IntPtr TouchPads;

        /// <summary> A pointer to an array of sensor descriptions, required if <see cref="NSensors"/> is > 0 </summary>
        ...
        /// <summary> Implements <see cref="RumbleJoystick"/> </summary>
        public VirtualJoystickRumbleCallback Ramble;

        /// <summary> Implements <see cref="RumbleJoystickTriggers"/> </summary>
        public VirtualJoystickRumbleTriggersCallback RumbleTriggers;

        /// <summary> Implements <see cref="SetJoystickLED"/> </summary>
        public VirtualJoystickSetLEDCallback SetLED;

        /// <summary> Implements <see cref="SendJoystickEffect(nint, byte[], int)"/> </summary>
        public VirtualJoystickSendEffectCallback SendEffect;

        /// <summary> Implements <see cref="SetGamepadSensorEnabled"/> </summary>
