...
public static partial class SDL
{
 ...
 ///     <para>
 ///         The SDL joystick functions are thread-safe, however you can lock the joysticks while processing to guarantee that
 ///         the joystick list won't change and joystick and gamepad events will not be delivered.
 ///     </para>
 /// </summary>
 /// <since> This function is available since SDL 3.2.0 </since>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_LockJoysticks"),
 ...
 /// <since> This function is available since SDL 3.2.0 </since>
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_UnlockJoysticks"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
 ...
 [LibraryImport(SDLLibrary, EntryPoint = "SDL_HasJoystick"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="count"> a pointer filled in with the number of joysticks returned, may be <c> null </c>. </param>
    /// <returns>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickNameForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetJoystickNameForID(uint instanceId);
    ...
    /// <returns>
    ///     the name of the selected joystick. If no name can be found, this function returns <c> null </c>; call
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickPathForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetJoystickPathForID(uint instanceId);
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the path of the selected joystick. If no path can be found, this function returns <c> null </c>; call
    ///     <see cref="GetError"/> for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    /// <summary>
    ///     <para> Get the player index of a joystick. </para> <para> This can be called before any joysticks are opened. </para>
    /// </summary>
    /// <param name="instanceId"> the joystick instance ID. </param>
    ...
    /// <seealso cref="GetJoysticks"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickPlayerIndexForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the GUID of the selected joystick. If called with an invalid <c> instanceId </c>, this function returns a zero
    ///     GUID.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickGUID"/>
    /// <seealso cref="GUIDToString"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickGUIDForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetJoysticks"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickVendorForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the USB product ID of the selected joystick. If called with an invalid <c> instanceId </c>, this function returns
    ///     0.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickProduct"/>
    /// <seealso cref="GetJoysticks"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickProductForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         This can be called before any joysticks are opened. If the product version isn't available this function returns
    ///         0.
    ///     </para>
    /// </summary>
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the product version of the selected joystick. If called with an invalid <c> instanceId </c>, this function returns
    ///     0.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickProductVersion"/>
    /// <seealso cref="GetJoysticks"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickProductVersionForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns>
    ///     the <see cref="JoystickType"/> of the selected joystick. If called with an invalid <c> instanceId </c>, this
    ///     function returns <see cref="JoystickType.Unknown"/>.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickType"/>
    /// <seealso cref="GetJoysticks"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickTypeForID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// </summary>
    /// <param name="instanceId"> the joystick instance ID. </param>
    /// <returns> a joystick identifier or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    public static partial nint OpenJoystick(uint instanceId);
    ...
    /// <returns>
    ///     an SDL_Joystick on success or <c> null </c> on failure or if it hasn't been opened yet; call
    ///     <see cref="GetError"/> for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickFromID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetJoystickFromID(uint instanceId);
    ...
    /// <returns> an SDL_Joystick on success or <c> null </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickPlayerIndex"/>
    /// <seealso cref="SetJoystickPlayerIndex"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickFromPlayerIndex"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint GetJoystickFromPlayerIndex(int playerIndex);

    /// <code>extern SDL_DECLSPEC SDL_JoystickID SDLCALL SDL_AttachVirtualJoystick(const SDL_VirtualJoystickDesc *desc);</code>
    /// <summary>
    ///     Attach a new virtual joystick.
    ///     <para>
    ///         Apps can create virtual joysticks, that exist without hardware directly backing them, and have program-supplied
    ///         inputs. Once attached, a virtual joystick looks like any other joystick that SDL can access. These can be used to
    ///         make other things look like joysticks, or provide pre-recorded input, etc.
    ///     </para>
    ///     <para>
    ///         Once attached, the app can send joystick inputs to the new virtual joystick using
    ///         <see cref="SetJoystickVirtualAxis"/>, etc.
    ///     </para>
    ///     <para> When no longer needed, the virtual joystick can be removed by calling <see cref="DetachVirtualJoystick"/>. </para>
    /// </summary>
    /// <param name="desc"> joystick description, initialized using <see cref="InitInterface(ref VirtualJoystickDesc)"/>. </param>
    /// <returns> the joystick instance ID, or 0 on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [DllImport(SDLLibrary, EntryPoint = "SDL_AttachVirtualJoystick"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="instanceId"> the joystick instance ID, previously returned from <see cref="AttachVirtualJoystick"/>. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DetachVirtualJoystick"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_IsJoystickVirtual"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    ///     <para>
    ///         Please note that values set here will not be applied until the next call to <see cref="UpdateJoysticks"/>, which
    ///         can either be called directly, or can be called indirectly through various other SDL APIs, including, but not
    ///         limited to the following: <see cref="PollEvent"/>, <see cref="PumpEvents"/>, <see cref="WaitEventTimeout"/>,
    ///         <see cref="WaitEvent"/>.
    ///     </para>
    ///     <para>
    ///         Note that when sending trigger axes, you should scale the value to the full range of Sint16. For example, a
    ///         trigger at rest would have the value of <see cref="JoystickAxisMin"/>.
    ///     </para>
    /// </summary>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickVirtualAxis"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetJoystickVirtualAxis(nint joystick, int axis, short value);
    ...
    /// <seealso cref="SetJoystickVirtualTouchpad"/>
    /// <seealso cref="SetJoystickVirtualSensorData"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickVirtualBall"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetJoystickVirtualBall(nint joystick, int ball, short xrel, short yrel);
    ...
    /// <seealso cref="SetJoystickVirtualTouchpad"/>
    /// <seealso cref="SetJoystickVirtualSensorData"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickVirtualButton"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetJoystickVirtualButton(nint joystick,
        int button,
    ...
    /// <seealso cref="SetJoystickVirtualTouchpad"/>
    /// <seealso cref="SetJoystickVirtualSensorData"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickVirtualHat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetJoystickVirtualHat(nint joystick, int hat, JoystickHat value);
    ...
    /// <sealso cref="SetJoystickVirtualHat"/>
    /// <sealso cref="SetJoystickVirtualSensorData"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickVirtualTouchpad"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetJoystickVirtualTouchpad(nint joystick,
        int touchpad,
        int finger,
        [MarshalAs(UnmanagedType.I1)] bool down,
        float x,
    ...
    /// <sealso cref="SetJoystickVirtualHat"/>
    /// <sealso cref="SetJoystickVirtualTouchpad"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SendJoystickVirtualSensorData"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SendJoystickVirtualSensorData(nint joystick,
        SensorType type,
        ulong sensorTimestamp,
        [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] float[] data,
        int numValues);
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.JoystickCapMonoLedBoolean"/>: true if this joystick has an LED that has adjustable
    ///             brightness
    ///         </item>
    ///         <item> <see cref="Props.JoystickCapRGBLedBoolean"/>: true if this joystick has an LED that has adjustable color </item>
    ///         <item> <see cref="Props.JoystickCapPlayerLedBoolean"/>: true if this joystick has a player LED </item>
    ///         <item> <see cref="Props.JoystickCapRumbleBoolean"/>: true if this joystick has left/right rumble </item>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickName"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetJoystickName(nint joystick);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickPath"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetJoystickPath(nint joystick);
    ...
    ///     <para>
    ///         For XInput controllers this returns the XInput user index. Many joysticks will not be able to supply this
    ///         information.
    ///     </para>
    /// </summary>
    /// <param name="joystick"> the SDL_Joystick obtained from <see cref="OpenJoystick"/>. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="SetJoystickPlayerIndex"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickPlayerIndex"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     player index to assign to this joystick, or -1 to clear the player index and turn off player
    ///     LEDs.
    /// </param>
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickPlayerIndex"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickPlayerIndex"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SetJoystickPlayerIndex(nint joystick, int playerIndex);
    ...
    /// <param name="joystick"> the SDL_Joystick obtained from <see cref="OpenJoystick"/>. </param>
    /// <returns>
    ///     the <see cref="GUID"/> of the given joystick. If called on an invalid index, this function returns a zero
    ///     <see cref="GUID"/>; call <see cref="GetError"/> for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickGUIDForID"/>
    /// <seealso cref="GUIDToString"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickGUID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial GUID GetJoystickGUID(nint joystick);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickVendor"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickProduct"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickProductVersion"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickFirmwareVersion"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial ushort GetJoystickFirmwareVersion(nint joystick);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickSerial"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    private static partial nint SDL_GetJoystickSerial(nint joystick);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickType"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial JoystickType GetJoystickType(nint joystick);
    ...
    /// <summary> Get the device information encoded in a <see cref="GUID"/> structure. </summary>
    ...
    /// <param name="crc16">
    ///     a pointer filled in with a CRC used to distinguish different products with the same VID/PID, or 0 if
    ///     not available.
    /// </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetJoystickGUIDForID"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickGUIDInfo"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void GetJoystickGUIDInfo(GUID guid,
        out short vendor,
        out short product,
        out short version,
        out short crc16);
    ...
    /// <returns>
    ///     <c> true </c> if the joystick has been opened, <c> false </c> if it has not; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_JoystickConnected"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool JoystickConnected(nint joystick);
    ...
    /// <returns>
    ///     the instance ID of the specified joystick on success or 0 on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickID"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         Often, the directional pad on a game controller will either look like 4 separate buttons or a POV hat, and not
    ///         axes, but all of this is up to the device and platform.
    ///     </para>
    /// </summary>
    /// <param name="joystick"> an SDL_Joystick structure containing joystick information. </param>
    /// <returns>
    ///     the number of axis controls/number of axes on success or -1 on failure; call <see cref="GetError"/> for more
    ///     information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumJoystickAxes"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetNumJoystickButtons"/>
    /// <seealso cref="GetNumJoystickHats"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumJoystickBalls"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetNumJoystickBalls"/>
    /// <seealso cref="GetNumJoystickButtons"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumJoystickHats"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <seealso cref="GetNumJoystickBalls"/>
    /// <seealso cref="GetNumJoystickHats"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetNumJoystickButtons"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         If joystick events are disabled, you must call SDL_UpdateJoysticks() yourself and check the state of the joystick
    ///         when you want joystick information.
    ///     </para>
    /// </summary>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickEventsEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         If joystick events are disabled, you must call <see cref="UpdateJoysticks"/> yourself and check the state of the
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_JoystickEventsEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    /// </summary>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_UpdateJoysticks"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         SDL makes no promises about what part of the joystick any given axis refers to. Your game should have some sort
    ///         of configuration UI to let users specify what each axis should be bound to. Alternately, SDL's higher-level Game
    ///         Controller API makes a great effort to apply order to this lower-level interface, so you know that a specific axis
    ///         is the "left thumb stick," etc.
    ///     </para>
    ///     <para>
    ///         The value returned by <see cref="GetJoystickAxis"/> is a signed integer (-32768 to 32767) representing the
    ///         current position of the axis. It may be necessary to impose certain tolerances on these values to account for
    ///         jitter.
    ///     </para>
    /// </summary>
    /// <param name="joystick"> an SDL_Joystick structure containing joystick information. </param>
    ...
    /// <returns>
    ///     a 16-bit signed integer representing the current position of the axis or 0 on failure; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetNumJoystickAxes"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickAxis"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para> The state is a value ranging from -32768 to 32767. </para> <para> The axis indices start at index 0. </para>
    /// </summary>
    /// <param name="joystick"> an SDL_Joystick structure containing joystick information. </param>
    /// <param name="axis"> the axis to query; the axis indices start at index 0. </param>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickAxisInitialState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetJoystickAxisInitialState(nint joystick, int axis, out short state);
    ...
    ///     <para>
    ///         Trackballs can only return relative motion since the last call to <see cref="GetJoystickBall"/>, these motion
    ///         deltas are placed into <c> dx </c> and <c> dy </c>.
    ///     </para>
    ///     <para> Most joysticks do not have trackballs. </para>
    /// </summary>
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetNumJoystickBalls"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickBall"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetJoystickBall(nint joystick, int ball, out int dx, out int dy);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetNumJoystickHats"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickHat"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial JoystickHat GetJoystickHat(nint joystick, int hat);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="GetNumJoystickButtons"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickButton"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetJoystickButton(nint joystick, int button);
    ...
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RumbleJoystick"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RumbleJoystick(nint joystick,
    ...
    ///     </para>
    ///     <para>
    ///         Note that this is rumbling of the _triggers_ and not the game controller as a whole. This is currently only
    ///         supported on Xbox One controllers. If you want the (more common) whole-controller rumble, use
    ///         <see cref="RumbleJoystick"/> instead.
    ///     </para>
    ///     <para> This function requires you to process SDL events or call <see cref="UpdateJoysticks"/> to update rumble state. </para>
    /// </summary>
    /// <param name="joystick"> the joystick to vibrate. </param>
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RumbleJoystickTriggers"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool RumbleJoystickTriggers(nint joystick,
        short leftRumble,
        short rightRumble,
        int durationMs);
    ...
    /// <returns> <c> true </c> on success or <c> false </c> on failure; call <see cref="GetError"/> for more information. </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetJoystickLED"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SendJoystickEffect"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SendJoystickEffect(nint joystick,
    ...
    /// <summary> Close a joystick previously opened with <see cref="OpenJoystick"/>. </summary>
    /// <param name="joystick"> the joystick device to close. </param>
    /// <since> This function is available since SDL 3.2.0 </since>
    /// <seealso cref="OpenJoystick"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CloseJoystick"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    /// <param name="joystick"> the joystick to query. </param>
    /// <returns>
    ///     the connection state on success or <see cref="JoystickConnectionState"/> on failure; call <see cref="GetError"/>
    ///     for more information.
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickConnectionState"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial JoystickConnectionState GetJoystickConnectionState(nint joystick);
    ...
    /// </returns>
    /// <since> This function is available since SDL 3.2.0 </since>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetJoystickPowerInfo"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial PowerState GetJoystickPowerInfo(nint joystick, out int percent);
}