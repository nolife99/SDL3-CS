...
public static partial class SDL
{
    ...
    ///     <para>
    ///         Generally one should use <see cref="AudioIsBigEndian"/> or <see cref="AudioIsLittleEndian"/> instead of this
    ///         macro directly.
    ///     </para>
    /// </summary>
    /// <since> This macro is available since SDL 3.2.0 </since>
    ...
    ///     <para>
    ///         Several functions that require an SDL_AudioDeviceID will accept this value to signify the app just wants the
    ///         system to choose a default device instead of the app providing a specific one.
    ///     </para>
    /// </summary>
    /// <since> This macro is available since SDL 3.2.0 </since>
