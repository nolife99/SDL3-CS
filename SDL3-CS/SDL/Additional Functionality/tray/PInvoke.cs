 ...
 public static void SetTrayTooltip(nint tray, scoped ReadOnlySpan<char> tooltip)
    {
        ...
        try
        {
            var written = Encoding.UTF8.GetBytes(tooltip, buffer);
            buffer[written] = 0; // null terminator

            fixed (byte* pBuffer = buffer) SetTrayTooltipNative(tray, pBuffer);
        }
        finally
        {
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTrayTooltip"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static partial void SetTrayTooltipNative(nint tray, byte* tooltip);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateTrayMenu"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint CreateTrayMenu(nint tray);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_CreateTraySubmenu"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint CreateTraySubmenu(nint entry);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayMenu"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]),
     MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint GetTrayMenu(nint tray);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTraySubmenu"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint GetTraySubmenu(nint entry);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayEntries"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static partial nint SDL_GetTrayEntries(nint menu, out int count);
    ...
    /// <seealso cref="InsertTrayEntryAt"/>
    public static nint[]? GetTrayEntries(nint menu, out int size)
    {
    ...
    /// <seealso cref="InsertTrayEntryAt"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_RemoveTrayEntry"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial void RemoveTrayEntry(nint entry);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_InsertTrayEntryAt"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint InsertTrayEntryAt(nint menu,
        int pos,
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_InsertTrayEntryAt"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial void SetTrayEntryLabel(nint entry, [MarshalAs(UnmanagedType.LPUTF8Str)] string label);

    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayEntryLabel"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static partial nint SDL_GetTrayEntryLabel(nint entry);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTrayEntryChecked"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial void SetTrayEntryChecked(nint entry, [MarshalAs(UnmanagedType.I1)] bool @checked);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayEntryChecked"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTrayEntryChecked(nint entry);
    ...
    /// <param name="entry"> the entry to be updated. </param>
    /// <param name="enabled"> <c> true </c> if the entry should be enabled; <c> false </c> otherwise. </param>
    /// <threadsafety> This function should be called on the thread that created the tray. </threadsafety>
    /// <since> This function is available since SDL 3.1.8. </since>
    /// <seealso cref="GetTrayEntries"/>
    /// <seealso cref="InsertTrayEntryAt"/>
    /// <seealso cref="GetTrayEntryEnabled"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_SetTrayEntryEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial void SetTrayEntryEnabled(nint entry, [MarshalAs(UnmanagedType.I1)] bool enabled);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayEntryEnabled"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool GetTrayEntryEnabled(nint entry);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_ClickTrayEntry"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial void ClickTrayEntry(nint entry);
    ...
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_DestroyTray"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]),
     MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial void DestroyTray(nint tray);

    /// <code>extern SDL_DECLSPEC SDL_TrayMenu *SDLCALL SDL_GetTrayEntryParent(SDL_TrayEntry *entry);</code>
    /// <summary> Gets the menu contianing a certain tray entry. </summary>
    /// <param name="entry"> the entry for which to get the parent menu. </param>
    /// <returns> the parent menu. </returns>
    /// <threadsafety> This function should be called on the thread that created the tray. </threadsafety>
    /// <since> This function is available since SDL 3.1.8. </since>
    /// <seealso cref="InsertTrayEntryAt"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayEntryParent"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint GetTrayEntryParent(nint entry);
    ...
    /// <seealso cref="CreateTraySubmenu"/>
    /// <seealso cref="GetTrayMenuParentTray"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayMenuParentEntry"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint GetTrayMenuParentEntry(nint menu);
    ...
    /// <seealso cref="CreateTrayMenu"/>
    /// <seealso cref="GetTrayMenuParentEntry"/>
    [LibraryImport(SDLLibrary, EntryPoint = "SDL_GetTrayMenuParentTray"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)]), MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static partial nint GetTrayMenuParentTray(nint menu);

    /// extern SDL_DECLSPEC void SDLCALL SDL_UpdateTrays(void);
    /// <summary>
    ///     <para> Update the trays. </para>
    ///     <para>
    ///         This is called automatically by the event loop and is only needed if you're using trays but aren't handling SDL
    ///         events.
    ///     </para>
    /// </summary>
    /// <threadsafety> This function should only be called on the main thread. </threadsafety>
