...
public static partial class SDL
{
    ...
    public delegate void IOSAnimationCallback(nint userdata);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void RequestAndroidPermissionCallback(nint userdata,
    ...
    ///     <para>
    ///         This callback may modify the message, and should return true if the message should continue to be processed, or
    ...
    public delegate bool WindowsMessageHook(nint userdata, nint msg);
    ...
    ///     <para>
    ///         This callback may modify the event, and should return true if the event should continue to be processed, or false
    ///         to prevent further processing.
    ///     </para>
    ///     <para>
    ///         As this is processing an event directly from the X11 event loop, this callback should do the minimum required
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.I1)]
    public delegate bool X11EventHook(nint userdata, nint xevent);
}