...
public static partial class SDL
{
    ...
    {
        /// <summary>
        ///     The folder which contains all of the current user's data, preferences, and documents. It usually contains most of
        ///     the other folders. If a requested folder does not exist, the home folder can be considered a safe fallback to store a
        ///     user's documents.
        /// </summary>
        Home,

        /// <summary>
        ///     The folder of files that are displayed on the desktop. Note that the existence of a desktop folder does not
        ///     guarantee that the system does show icons on its desktop; certain GNU/Linux distros with a graphical environment may not
        ///     have desktop icons.
        /// </summary>
        Desktop,
        ...
        ///     such as "New Text File.txt".  Any file in the Templates folder can be used as a starting point for a new file.
        /// </summary>
        Templates,
