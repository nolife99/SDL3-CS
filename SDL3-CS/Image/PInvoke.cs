...
public partial class Image
{
 ...
 ///     <para>
 ///         An <see cref="SDL.Surface"/> is a buffer of pixels in memory accessible by the CPU. Use this if you plan to hand
 ///         the data to something else or manipulate it further in code.
 ///     </para>
 ///     <para>
 ///         There are no guarantees about what format the new <see cref="SDL.Surface"/> data will be; in many cases,
 ///         SDL_image will attempt to supply a surface that exactly matches the provided image, but in others it might have to
 ///         convert (either because the image is in a format that SDL doesn't directly support or because it's compressed data
 ///         that could reasonably uncompress to various formats and SDL_image had to pick one). You can inspect an
 ///         <see cref="SDL.Surface"/> for its specifics, and use <see cref="SDL.ConvertSurface"/> to then migrate to any
 ///         supported format.
 ///     </para>
 ///     <para>
 ///         If the image format supports a transparent pixel, SDL will set the colorkey for the surface. You can enable RLE
 ///         acceleration on the surface afterwards by calling: SDL.SetSurfaceColorKey(image, SDL_RLEACCEL,
 ...
 ///         detecting file type from the contents of the image data, but may rely on the caller-provided type string for formats
 ///         that it cannot autodetect. If <c> type </c> is <c> null </c>, SDL_image will rely solely on its ability to guess the
 ///         format.
 ///     </para>
 ///     <para>
 ///         There is a separate function to read files from disk without having to deal with SDL_IOStream:
 ///         <c> Load("filename.jpg") </c> will call this function and manage those details for you, determining the file type
 ...
 ///     </para>
 ///     <para>
 ///         If you are using SDL's 2D rendering API, there is an equivalent call to load images directly into an SDL_Texture
 ///         for use by the GPU without using a software surface: call <see cref="LoadTextureTypedIO"/> instead.
 ///     </para>
 ///     <para>
 ///         When done with the returned surface, the app should dispose of it with a call to <see cref="SDL.DestroySurface"/>
 ///         .
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadTyped_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadTypedIO(nint src,
 ...
 ///     </para>
 ///     <para>
 ///         There is a separate function to read files from an SDL_IOStream, if you need an i/o abstraction to provide data
 ///         from anywhere instead of a simple filesystem read; that function is <see cref="LoadIO"/>.
 ///     </para>
 ///     <para>
 ///         If you are using SDL's 2D rendering API, there is an equivalent call to load images directly into an SDL_Texture
 ///         for use by the GPU without using a software surface: call <see cref="LoadTexture"/> instead.
 ///     </para>
 ///     <para>
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_Load"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint Load([MarshalAs(UnmanagedType.LPUTF8Str)] string file);
 ...
 ///     <para>
 ///         There is a separate function to read files from disk without having to deal with SDL_IOStream:
 ///         <c> Image.Load("filename.jpg") </c> will call this function and manage those details for you, determining the file
 ///         type from the filename's extension.
 ///     </para>
 ///     <para>
 ///         There is also <see cref="LoadTypedIO"/>, which is equivalent to this function except a file extension (like
 ///         "BMP", "JPG", etc) can be specified, in case SDL_image cannot autodetect the file format.
 ///     </para>
 ///     <para>
 ///         If you are using SDL's 2D rendering API, there is an equivalent call to load images directly into an SDL_Texture
 ///         for use by the GPU without using a software surface: call <see cref="LoadTextureIO"/> instead.
 ///     </para>
 ///     <para>
 ///         When done with the returned surface, the app should dispose of it with a call to <see cref="SDL.DestroySurface"/>
 ///         .
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_Load_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadIO(nint src, [MarshalAs(UnmanagedType.I1)] bool closeio);
 ...
 ///         efficient than using a CPU-bound <see cref="SDL.Surface"/>  if you don't need to manipulate the image directly after
 ///         loading it.
 ///     </para>
 ///     <para>
 ///         If the loaded image has transparency or a colorkey, a texture with an alpha channel will be created. Otherwise,
 ///         SDL_image will attempt to create an SDL_Texture in the most format that most reasonably represents the image data
 ///         (but in many cases, this will just end up being 32-bit RGB or 32-bit RGBA).
 ///     </para>
 ///     <para>
 ///         There is a separate function to read files from an SDL_IOStream, if you need an i/o abstraction to provide data
 ///         from anywhere instead of a simple filesystem read; that function is <see cref="LoadTextureIO"/>.
 ///     </para>
 ///     <para>
 ///         If you would rather decode an image to an <see cref="SDL.Surface"/>  (a buffer of pixels in CPU memory), call
 ///         <see cref="Load"/> instead.
 ///     </para>
 ///     <para>
 ///         When done with the returned texture, the app should dispose of it with a call to <see cref="SDL.DestroyTexture"/>
 ///         .
 ///     </para>
 /// </summary>
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadTexture"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadTexture(nint renderer, [MarshalAs(UnmanagedType.LPUTF8Str)] string file);
 ...
 ///     <para>
 ///         There is a separate function to read files from disk without having to deal with SDL_IOStream:
 ///         <c> LoadTexture(renderer, "filename.jpg") </c> will call this function and manage those details for you, determining
 ///         the file type from the filename's extension.
 ///     </para>
 ///     <para>
 ///         There is also <see cref="LoadTextureTypedIO"/>, which is equivalent to this function except a file extension
 ///         (like "BMP", "JPG", etc) can be specified, in case SDL_image cannot autodetect the file format.
 ///     </para>
 ///     <para>
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadTexture_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadTextureIO(nint renderer, nint src, [MarshalAs(UnmanagedType.I1)] bool closeio);
 ...
 ///     <para>
 ///         There is a separate function to read files from disk without having to deal with SDL_IOStream:
 ///         <c> Image.LoadTexture("filename.jpg") </c> will call this function and manage those details for you, determining the
 ///         file type from the filename's extension.
 ///     </para>
 ///     <para>
 ///         There is also <see cref="LoadTextureIO"/>, which is equivalent to this function except that it will rely on
 ///         SDL_image to determine what type of data it is loading, much like passing a <c> null </c> for type.
 ///     </para>
 ///     <para>
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadTextureTyped_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadTextureTypedIO(nint renderer,
        nint src,
        [MarshalAs(UnmanagedType.I1)] bool closeio,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string type);
 ...
 ///     <para>
 ///         This function will always attempt to seek <c> src </c> back to where it started when this function was called,
 ///         but it will not report any errors in doing so, but assuming seeking works, this means you can immediately use this
 ///         with a different IsTYPE function, or load the image without further seeking.
 ///     </para>
 ///     <para>
 ///         You do not need to call this function to load data; SDL_image can work to determine file type in many cases in
 ///         its standard load functions.
 ///     </para>
 /// </summary>
 ...
 ///     <para> There is no distinction made between "not the filetype in question" and basic i/o errors. </para>
 ///     <para>
 ///         This function will always attempt to seek `src` back to where it started when this function was called, but it
 ///         will not report any errors in doing so, but assuming seeking works, this means you can immediately use this with a
 ///         different IsTYPE function, or load the image without further seeking.
 ///     </para>
 ///     <para>
 ///         You do not need to call this function to load data; SDL_image can work to determine file type in many cases in
 ///         its standard load functions.
 ...
 ///         This function will always attempt to seek <c> src </c> back to where it started when this function was called,
 ///         but it will not report any errors in doing so, but assuming seeking works, this means you can immediately use this
 ///         with a different IMG_isTYPE function, or load the image without further seeking.
 ///     </para>
 ///     <para>
 ///         You do not need to call this function to load data; SDL_image can work to determine file type in many cases in
 ///         its standard load functions.
 ...
 ///         detection routines. Generally it's better to use the abstract interfaces; also, there is only an SDL_IOStream
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadAVIF_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadAVIFIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadICO_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadICOIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadCUR_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadCURIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadBMP_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadBMPIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadGIF_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadGIFIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadJPG_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadJPGIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadJXL_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadJXLIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadLBM_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadLBMIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadPCX_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadPCXIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadPNG_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadPNGIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadPNM_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadPNMIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadSVG_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadSVGIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadQOI_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadQOIIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadTGA_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadTGAIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadTIF_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadTIFIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadXCF_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadXCFIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadXPM_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadXPMIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadXV_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadXVIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadWEBP_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadWEBPIO(nint src);
 ...
 ///     <para>
 ///         Since SVG files are resolution-independent, you specify the size you would like the output image to be and it
 ///         will be generated at those dimensions.
 ///     </para>
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadSizedSVG_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadSizedSVGIO(nint src, int width, int height);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_ReadXPMFromArray"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint ReadXPMFromArray(
 ...
 ///     <para> Load an XPM image from a memory array. </para>
 ///     <para>
 ///         The returned surface will always be a 32-bit RGB surface. If you want 8-bit indexed colors (and the XPM data
 ///         allows it), use <see cref="ReadXPMFromArray"/> instead.
 ///     </para>
 ///     <para>
 ///         When done with the returned surface, the app should dispose of it with a call to <see cref="SDL.DestroySurface"/>
 ///         .
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_ReadXPMFromArrayToRGB888"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint ReadXPMFromArrayToRGB888(
        [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPUTF8Str)] string[] xpm);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_SaveAVIF"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SaveAVIF(nint surface, [MarshalAs(UnmanagedType.LPUTF8Str)] string file, int quality);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_SaveAVIF_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SaveAVIFIO(nint surface,
        nint dst,
        [MarshalAs(UnmanagedType.I1)] bool closeio,
        int quality);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_SavePNG"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SavePNG(nint surface, [MarshalAs(UnmanagedType.LPUTF8Str)] string file);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_SavePNG_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SavePNGIO(nint surface, nint dst, [MarshalAs(UnmanagedType.I1)] bool closeio);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_SaveJPG"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SaveJPG(nint surface, [MarshalAs(UnmanagedType.LPUTF8Str)] string file, int quality);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_SaveJPG_IO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool SaveJPGIO(nint surface,
        nint dst,
        [MarshalAs(UnmanagedType.I1)] bool closeio,
        int quality);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadAnimation"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadAnimation([MarshalAs(UnmanagedType.LPUTF8Str)] string file);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadAnimation_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadAnimationIO(nint src, [MarshalAs(UnmanagedType.I1)] bool closeio);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadAnimationTyped_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadAnimationTypedIO(nint src,
        [MarshalAs(UnmanagedType.I1)] bool closeio,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string type);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadGIFAnimation_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadGIFAnimationIO(nint src);
 ...
 [LibraryImport(ImageLibrary, EntryPoint = "IMG_LoadWEBPAnimation_IO"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint LoadWEBPAnimationIO(nint src);
}