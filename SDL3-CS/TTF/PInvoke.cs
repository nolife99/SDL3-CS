...
public static partial class TTF
{
 ...
 ///     <para>
 ///         It is safe to call this more than once, and each successful <see cref="Init"/> call should be paired with a
 ///         matching <see cref="Quit"/> call.
 ///     </para>
 /// </summary>
 ...
 ///     <para>
 ///         Some .fon fonts will have several sizes embedded in the file, so the point size becomes the index of choosing
 ///         which size. If the value is too high, the last indexed size will be the default.
 ///     </para>
 ...
 ///     </para>
 ///     <para>
 ///         If <c> closeio </c> is true, <c> src </c> will be automatically closed once the font is closed. Otherwise you
 ///         should keep <c> src </c> open until the font is closed.
 ///     </para>
 ///     <para> When done with the returned TTF_Font, use <see cref="CloseFont"/> to dispose of it. </para>
 /// </summary>
 ...
 [LibraryImport(FontLibrary, EntryPoint = "TTF_OpenFontIO"), UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint OpenFontIO(nint src, [MarshalAs(UnmanagedType.I1)] bool closeio, float ptsize);
 ...
 ///     <list type="bullet">
 ///         <item>
 ///             <see cref="Props.FontCreateFilenameString"/>: the font file to open, if an SDL_IOStream isn't being used.
 ///             This is required if <see cref="Props.FontCreateIOStreamPointer"/> and
 ///             <see cref="Props.FontCreateExistingFontPointer"/> aren't set.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.FontCreateIOStreamPointer"/>: an SDL_IOStream containing the font to be opened. This should
 ///             not be closed until the font is closed. This is required if <see cref="Props.FontCreateFilenameString"/> and
 ///             <see cref="Props.FontCreateExistingFontPointer"/> aren't set.
 ///         </item>
 ///         <item>
 ...
 ///         </item>
 ///         <item>
 ///             <see cref="Props.FontCreateIOStreamAutoCloseBoolean"/>: true if closing the font should also close the
 ///             associated SDL_IOStream.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.FontCreateSizeFloat"/>: the point size of the font. Some .fon fonts will have several sizes
 ///             embedded in the file, so the point size becomes the index of choosing which size. If the value is too high, the
 ///             last indexed size will be the default.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.FontCreateFaceNumber"/>: the face index of the font, if the font contains multiple font
 ///             faces.
 ///         </item>
 ///         <item>
 ...
 ///         </item>
 ///         <item>
 ///             <see cref="Props.FontCreateExistingFontPointer"/>: an optional TTF_Font that, if set, if set, will be used as
 ...
 ///     <list type="bullet">
 ///         <item>
 ///             <see cref="Props.FontOutlineLineCapNumber"/>: The FT_Stroker_LineCap value used when setting the font
 ///             outline, defaults to <c> FT_STROKER_LINECAP_ROUND </c>.
 ///         </item>
 ///         <item>
 ///             <see cref="Props.FontOutlineLineJoinNumber"/>: The FT_Stroker_LineJoin value used when setting the font
 ///             outline, defaults to <c> FT_STROKER_LINEJOIN_ROUND </c>.
 ///         </item>
 ///         <item>
 ...
 ///     <para>
 ///         The generation is incremented each time font properties change that require rebuilding glyphs, such as style,
 ///         size, etc.
 ///     </para>
 /// </summary>
 /// <param name="font"> the font to query. </param>
 ...
 ///     <para>
 ///         Add a font that will be used for glyphs that are not in the current font. The fallback font should have the same
 ///         size and style as the current font.
 ///     </para>
 ...
 ///     <para>
 ///         This updates any <see cref="TTFText"/> objects using this font, and clears already-generated glyphs, if any, from
 ///         the cache.
 ///     </para>
 /// </summary>
 ...
 ///         <see cref="Props.FontOutlineLineJoinNumber"/>, and <see cref="Props.FontOutlineMiterLimitNumber"/> when setting the
 ///         font outline.
 ///     </para>
 ///     <para>
 ///         This updates any <see cref="TTFText"/> objects using this font, and clears already-generated glyphs, if any, from
 ...
 ///     <para>
 ///         SDF is a technique that helps fonts look sharp even when scaling and rotating, and requires special shader
 ///         support for display.
 ///     </para>
 ///     <para>
 ...
 ///     <para>
 ///         Newly-opened fonts default to allowing kerning. This is generally a good policy unless you have a strong reason
 ///         to disable it, as it tends to produce better rendering (with kerning disabled, some fonts might render the word
 ...
 ///     <para>
 ///         A "fixed-width" font means all glyphs are the same width across; a lowercase 'i' will be the same size across as
 ///         a capital 'W', for example. This is common for terminals and text editors, and other apps that treat text as a grid.
 ...
 [LibraryImport(FontLibrary, EntryPoint = "TTF_FontIsScalable"),
  UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    ///     <para>
    ///         Note that the returned string is to internal storage, and should not be modified or free'd by the caller. The
    ///         string becomes invalid, with the rest of the font, when `font` is handed to <see cref="CloseFont"/>.
    ///     </para>
    /// </summary>
    /// <param name="font"> the font to query. </param>
    ...
    /// <returns>
    ///     an <see cref="SDL.Surface"/> containing the glyph, or <c> null </c> on failure; call <see cref="SDL.GetError"/>
    ...
    ///     <para>
    ///         This will report the width and height, in pixels, of the space that the specified string will take to fully
    ///         render.
    ///     </para>
    /// </summary>
    /// <param name="font"> the font to query. </param>
    ...
    ///     </para>
    ///     <para>
    ///         Text is wrapped to multiple lines on line endings and on word boundaries if it extends beyond <c> wrapWidth </c>
    ///         in pixels.
    ///     </para>
    ...
    ///     </para>
    ///     <para>
    ///         This will not word-wrap the string; you'll get a surface with a single line of text, as long as the string
    ///         requires. You can use <see cref="RenderTextSolidWrapped"/> instead if you need to wrap the output to multiple lines.
    ///     </para>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_Solid"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextSolid(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg);
    ...
    ///     </para>
    ///     <para>
    ///         Text is wrapped to multiple lines on line endings and on word boundaries if it extends beyond <c> wrapLength </c>
    ///         in pixels.
    ///     </para>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_Solid_Wrapped"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextSolidWrapped(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg,
        int wrapLength);
    ...
    ///     </para>
    ///     <para>
    ///         The glyph is rendered without any padding or centering in the X direction, and aligned normally in the Y
    ///         direction.
    ///     </para>
    ///     <para>
    ///         You can render at other quality levels with <see cref="RenderGlyphShaded"/>, <see cref="RenderGlyphBlended"/>,
    ///         and <see cref="RenderGlyphLCD"/>.
    ///     </para>
    /// </summary>
    /// <param name="font"> the font to render with. </param>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderGlyph_Solid"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderGlyphSolid(nint font, uint ch, SDL.Color fg);
    ...
    ///         background color, while other pixels have varying degrees of the foreground color. This function returns the new
    ///         surface, or <c> null </c> if there was an error.
    ///     </para>
    ///     <para>
    ///         This will not word-wrap the string; you'll get a surface with a single line of text, as long as the string
    ///         requires. You can use <see cref="RenderTextShadedWrapped"/> instead if you need to wrap the output to multiple
    ///         lines.
    ///     </para>
    ///     <para> This will not wrap on newline characters. </para>
    ///     <para>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_Shaded"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextShaded(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg,
        SDL.Color bg);
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_Shaded_Wrapped"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextShadedWrapped(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg,
        SDL.Color bg,
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderGlyph_Shaded"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderGlyphShaded(nint font, uint ch, SDL.Color fg, SDL.Color bg);
    ...
    ///     <para>
    ///         This function will allocate a new 32-bit, ARGB surface, using alpha blending to dither the font with the given
    ///         color. This function returns the new surface, or <c> null </c> if there was an error.
    ///     </para>
    ///     <para>
    ///         This will not word-wrap the string; you'll get a surface with a single line of text, as long as the string
    ///         requires. You can use <see cref="RenderTextBlendedWrapped"/> instead if you need to wrap the output to multiple
    ///         lines.
    ///     </para>
    ///     <para> This will not wrap on newline characters. </para>
    ///     <para>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_Blended"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextBlended(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg);
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_Blended_Wrapped"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextBlendedWrapped(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg,
        int wrapWidth);
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderGlyph_Blended"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderGlyphBlended(nint font, ulong ch, SDL.Color fg);
    ...
    ///     <para>
    ///         This function will allocate a new 32-bit, ARGB surface, and render alpha-blended text using FreeType's LCD
    ///         subpixel rendering. This function returns the new surface, or <c> null </c> if there was an error.
    ///     </para>
    ///     <para>
    ///         This will not word-wrap the string; you'll get a surface with a single line of text, as long as the string
    ///         requires. You can use <see cref="RenderTextLCDWrapped"/> instead if you need to wrap the output to multiple lines.
    ///     </para>
    ///     <para> This will not wrap on newline characters. </para>
    ///     <para>
    ///         You can render at other quality levels with <see cref="RenderTextSolid"/>, <see cref="RenderTextShaded"/>, and
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_LCD"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextLCD(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg,
        SDL.Color bg);
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderText_LCD_Wrapped"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderTextLCDWrapped(nint font,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string text,
        nuint length,
        SDL.Color fg,
        SDL.Color bg,
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_RenderGlyph_LCD"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint RenderGlyphLCD(nint font, uint ch, SDL.Color fg, SDL.Color bg);
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_DrawSurfaceText"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    [return: MarshalAs(UnmanagedType.I1)]
    public static partial bool DrawSurfaceText(nint text, int x, int y, nint surface);
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.RendererTextEngineRendererPointer"/>: the renderer to use for creating textures and drawing
    ///             text
    ///         </item>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_CreateRendererTextEngineWithProperties"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateRendererTextEngineWithProperties(uint props);
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <see cref="Props.GPUTextEngineDevicePointer"/>: the SDL_GPUDevice to use for creating textures and drawing
    ///             text.
    ///         </item>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_CreateGPUTextEngineWithProperties"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial nint CreateGPUTextEngineWithProperties(uint props);
    ...
    ///     <para>
    ///         The positive X-axis is taken towards the right and the positive Y-axis is taken upwards for both the vertex and
    ///         the texture coordinates, i.e, it follows the same convention used by the SDL_GPU API. If you want to use a different
    ///         coordinate system you will need to transform the vertices yourself.
    ///     </para>
    ...
    /// <summary>
    ///     <para>
    ///         Get the winding order of the vertices returned by <see cref="GetGPUTextDrawData"/> for a particular GPU text
    ///         engine
    ///     </para>
    /// </summary>
    /// <param name="engine"> a TTF_TextEngine object created with <see cref="CreateGPUTextEngine"/>. </param>
    ...
    [LibraryImport(FontLibrary, EntryPoint = "TTF_GetTextProperties"),
     UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial uint GetTextProperties(nint text);
    ...
    ///     <para>
    ///         When a text object has a font, any changes to the font will automatically regenerate the text. If you set the
    ///         font to <c> null </c>, the text will continue to render but changes to the font will no longer affect the text.
    ///     </para>
    ///     <para> This function may cause the internal text representation to be rebuilt. </para>
    /// </summary>
    /// <param name="text"> the <see cref="TTFText"/> to modify. </param>
    ...
    ///     <para>
    ///         If the whitespace is visible, it will take up space for purposes of alignment and wrapping. This is good for
    ///         editing, but looks better when centered or aligned if whitespace around line wrapping is hidden. This defaults
    ///         false.
    ///     </para>
    ///     <para> This function may cause the internal text representation to be rebuilt. </para>
    /// </summary>
    ...
    ///         <see cref="SubStringFlags.TextStart"/> flag set. If <c> offset </c> is greater than or equal to the length of the
    ///         text string, this will return a zero length substring at the end of the text with the
    ...
    ///         <see cref="SubStringFlags.TextStart"/> flag set. If `line` is greater than or equal to <c> Text.NumLines </c> this
    ///         will return a zero length substring at the end of the text with the <see cref="SubStringFlags.TextEnd"/> flag set.
    ///     </para>
    /// </summary>
    /// <param name="text"> the <see cref="TTFText"/> to query. </param>
    ...
    ///     <para>
    ///         This is automatically done when the layout is requested or the text is rendered, but you can call this if you
    ///         need more control over the timing of when the layout and text engine representation are updated.
    ///     </para>
    /// </summary>
    ...
    ///     <para>
    ///         Call this when done with a font. This function will free any resources associated with it. It is safe to call
    ///         this function on <c> null </c>, for example on the result of a failed call to <see cref="OpenFont"/>.
    ///     </para>
    ///     <para>
    ///         The font is not valid after being passed to this function. String pointers from functions that return information
    ///         on this font, such as <see cref="GetFontFamilyName"/> and <see cref="GetFontStyleName"/>, are no longer valid after
    ///         this call, as well.
    ///     </para>
    /// </summary>
    ...
    ///     <para>
    ///         You must call this when done with the library, to free internal resources. It is safe to call this when the
    ///         library isn't initialized, as it will just return immediately.
    ///     </para>
    ///     <para>
    ///         Once you have as many quit calls as you have had successful calls to <see cref="Init"/>, the library will
    ...
    ///         and it is possibly not safe to close them afterwards, as parts of the library will no longer be initialized deal
    ///         with it. A well-written program should call <see cref="CloseFont"/> on any open fonts before calling this function!
    ///     </para>
    /// </summary>
    /// <threadsafety> It is safe to call this function from any thread. </threadsafety>
    /// <since> This function is available since SDL_ttf 3.0.0. </since>
